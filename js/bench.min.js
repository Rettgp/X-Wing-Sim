...
b.org.name+"]"}).html("");h.click(function(){addroll(this.f,e,g)}.bind(b));return h},q=function(b,e){var h=b.n(),l="R"+h,m="tokens";b.str&&(m="x"+b.str+"token",l="");l=$("<td>").addClass(m).attr({id:"reroll"+e,title:h+" rerolls["+b.org.name+"]"}).html(l);l.click(function(){reroll(h,f,g,b,e)});return l},t=this.getdicemodifiers(),v=[];for(h=0;h<t.length;h++){var w=t[h];w.from==f&&w.to==g&&(w.type==MOD_M&&w.req.call(this,b,e)&&v.push(l(w,h)),w.type==ADD_M&&w.req.call(this,b,e)&&v.push(m(w,h)),w.type==
REROLL_M&&w.req.call(this,activeunit,activeunit.weapons[activeunit.activeweapon],targetunit)&&v.push(q(w,h)))}return v},addhasfired:function(){this.hasfired++},resolveattack:function(b,e){var f;this.gethitrange(b,e);this.addhasfired();this.hasdamaged=!1;displaycombatdial();var g=e.g.getBBox(),h=transformPoint(this.m,{x:0,y:-(this.islarge?40:20)});s.path("M "+h.x+" "+h.y+" L "+(g.x+g.w/2)+" "+(g.y+g.h/2)).appendTo(VIEWPORT).attr({stroke:this.color,strokeWidth:2,strokeDasharray:100,"class":"animated fireline"});
this.select();for(f in squadron)if(squadron[f]==this)break;this.preattackroll(b,e);this.doselection(function(g){var h=this.getattackstrength(b,e),l=e.getdefensestrength(b,this);this.doattackroll(this.attackroll(h),h,l,f,g)}.bind(this),"in combat")},preattackroll:function(b,e){},doattack:function(b,e){this.activeweapons=b;this.activeenemies=e;this.showattack(b,e)},doattackroll:function(b,e,f,g,h){b=this.weapons[this.activeweapon].modifydamagegiven(b);displayattackroll(b,e);this.ar=b;this.ad=e;displayattacktokens(this,
function(){targetunit.defenseroll(f).done(function(b){targetunit.dodefenseroll(b.roll,b.dice,g,h)})})},dodefenseroll:function(b,e,f,g){this.dr=b;this.dd=e;displaydefenseroll(b,e);displaydefensetokens(this,function(){this.resolvedamage();this.endnoaction(g,"in combat")}.bind(squadron[f]))},drawpathmove:function(b,e,f){if(!FAST){if(this.islarge){var g=b.clone();s.path("M 0 0 l 0 -20").transform(g).appendTo(VIEWPORT).attr({stroke:this.color,display:TRACE?"block":"none",strokeWidth:"20px",opacity:.2,
fill:"rgba(0,0,0,0)"}).addClass("trace");e=s.path(e.getSubpath(0,f-40)).attr("display","none");e.clone().transform(g.translate(0,-20)).appendTo(VIEWPORT).attr({stroke:this.color,display:TRACE?"block":"none",strokeWidth:"20px",opacity:.2,fill:"rgba(0,0,0,0)"}).addClass("trace");s.path("M 0 0 l 0 -20").transform(this.getmatrixwithmove(b,e,f-20)).appendTo(VIEWPORT).attr({stroke:this.color,display:TRACE?"block":"none",strokeWidth:"20px",opacity:.2,fill:"rgba(0,0,0,0)"}).addClass("trace")}else s.path(e.getSubpath(0,
f)).transform(b).attr({stroke:this.color,display:TRACE?"block":"none",strokeWidth:"20px",opacity:.2,fill:"rgba(0,0,0,0)"}).addClass("trace").appendTo(VIEWPORT);this.show()}},getmatrixwithmove:function(b,e,f){var g=e.getTotalLength();b=b.clone();this.islarge?20>=f?b.translate(0,-f):(g=f>g+20?f-g-20:0,e=e.getPointAtLength(f-g-20),b.translate(e.x,-20+e.y).rotate(e.alpha-90,0,0).translate(0,-g)):(e=e.getPointAtLength(f),b.translate(e.x,e.y).rotate(e.alpha-90,0,0));return b},removestresstoken:function(){0<
this.stress&&(this.stress--,this.animateremovetoken("xstresstoken"));this.movelog("st");this.show()},handledifficulty:function(b){"RED"==b?this.addstress():"GREEN"==b&&0<this.stress&&this.removestresstoken()},premove:function(){},reavelmaneuver:function(b){},completemaneuver:function(b,e,f,g){var h=P[b].path,l,m;this.maneuverdifficulty=e;if("F0"==b)this.hasmoved=!0,this.handledifficulty(e),this.lastmaneuver=this.maneuver,this.endmaneuver(),this.touching=[];else{var q=h.getTotalLength();this.collision=
!1;this.showhitsector(!1);this.islarge&&(q+=40);m=this.m;l=this.getmatrixwithmove(this.m,h,q);var t=this.getcollidingunits(l),v=[];if(0<t.length)for(this.log("collides with %0: no action",t[0].name),this.collision=!0;0<q&&0<t.length;)v=t,--q,l=this.getmatrixwithmove(this.m,h,q),t=this.getcollidingunits(l);this.drawpathmove(this.m,h,q);for(i=0;i<this.touching.length;i++)t=this.touching[i],t.touching.splice(t.touching.indexOf(this),1);this.touching=v;this.ocollision=this.getocollisions(m,l,h,q);this.isfireobstructed()&&
this.log("overlaps obstacle: cannot attack");this.hascollidedobstacle()&&this.log("unit or template overlaps obstacle: no action");0<q&&(this.m=l);var w=0;0<q?(this.hasmoved=!0,$("#activationdial").empty(),FAST||SOUNDS[this.ship.flysnd].play(),Snap.animate(0,q,function(b){l=this.getmatrixwithmove(m,h,b);this.g.transform(l);this.geffect.transform(l)}.bind(this),TIMEANIM*q/200,mina.linear,function(){this.collision||(b.match(/K\d|SR\d|SL\d/)||1==f?(this.m.rotate(180,0,0),w=180):b.match(/TRL\d/)?(this.m.rotate(-90,
0,0),w=-90):b.match(/TRR\d/)&&("undefined"!=typeof g?this.m=g:this.m.rotate(90,0,0),w=90));this.movelog("m-"+b+"-"+(360+w)%360+"-"+Math.floor(q));this.handledifficulty(e);this.lastmaneuver=this.maneuver;this.hascollidedobstacle()&&this.resolveocollision(this.ocollision.overlap,this.ocollision.template);if(0<this.ocollision.mine.length)for(i=0;i<this.ocollision.mine.length;i++)this.ocollision.mine[i].detonate(this,!1);this.collision&&this.resolvecollision();this.endmaneuver()}.bind(this))):(this.hasmoved=
!0,this.log("cannot move"),this.handledifficulty(e),this.lastmaneuver=this.maneuver,this.collision&&this.resolvecollision(),this.endmaneuver())}},getmaneuverlist:function(){var b=this.getmaneuver(),e={};e[b.move]=b;return"undefined"!=typeof b?e:{}},resolvemaneuver:function(){$("#activationdial").empty();if(!(0>this.maneuver)){var b=[],e=[],f=this.getmaneuverlist(),g;for(g in f)if(e.push(f[g]),f[g].move.match(/TRR\d|TRL\d/))for(var h=this.gettallonrollmatrix(this.m,f[g].move),l=0;l<h.length;l++)b.push(h[l]),
0<l&&e.push(f[g]);else 1!=f[g].halfturn||f[g].move.match(/K\d|SR\d|SL\d/)?b.push(this.getpathmatrix(this.m,f[g].move)):b.push(this.getpathmatrix(this.m,f[g].move).rotate(180,0,0));this.resolveactionmove(b,function(f,g){-1==g&&(g=0);var h=e[g].move,l=e[g].difficulty;1!=e[g].halfturn&&(e[g].halfturn=!1);this.completemaneuver(h,l,e[g].halfturn,b[g])}.bind(this),!1,!0)}},endmaneuver:function(){var b=this.ionized;if(this.hasionizationeffect())for(var e=0;e<b;e++)this.removeiontoken();this.maneuver=-1;
this.hasmoved=!0;this.show();this.checkdead()?this.shield=this.hull=0:this.doendmaneuveraction();this.cleanupmaneuver()},cleanupmaneuver:function(){this.actionbarrier()},unlock:function(b){this.show();return this.deferred.resolve(b)},newlock:function(){this.deferred=$.Deferred();return this.deferred.promise()},enddecloak:function(){return this.newlock()},candomaneuver:function(){return-1<this.maneuver},addafterattackeffect:function(b,e){this.wrap_after("afterattackeffect",b,e)},addafterdefenseeffect:function(b,
e){this.wrap_after("afterdefenseeffect",b,e)},isattacktwice:function(){return!1},addattack:function(b,e,f,g,h,l,m){var q=this;"undefined"==typeof l&&(l="endattack");"undefined"==typeof m&&(m=!1);(m?Unit.prototype:this).wrap_after(l,e,function(m,v,w){var t=!1;"removeshield"==l||"warndeath"==l||"endmaneuver"==l?w=activeunit:"undefined"==typeof w&&(w=this);for(i in f)if(f[i].isactive){t=!0;break}if(b.call(q,m,v,w)&&q.noattack<round&&t&&!q.iscloaked&&!q.isfireobstructed()){var y=w.deferred,t=function(){var l,
q=[];this.deferred=y;l="function"==typeof h?h.call(this):this.selectnearbyenemy(3);for(var t in f)f[t].isactive&&0<f[t].getenemiesinrange(l).length&&q.push(f[t]);0==q.length?(this.log("no available target for %0",e.name),this.cleanupattack()):b.call(this,m,v,w)?(this.log("+1 attack [%0]",e.name),"function"==typeof g&&this.wrap_before("resolveattack",this,function(){g.call(this)}.bind(this)).unwrapper("cleanupattack"),this.maxfired++,this.doattack(q,l)):this.cleanupattack()}.bind(q);"endcombatphase"!=
l&&"warndeath"!=l&&phase==COMBAT_PHASE?w.newlock().done(t):t()}})},candoendmaneuveraction:function(){return this.candoaction()&&!this.collision&&!this.hascollidedobstacle()},doendmaneuveraction:function(){return this.doaction(this.getactionlist(!0),"",this.candoendmaneuveraction)},doselection:function(b,e){return this.enqueueaction(b,e)},isactiondone:function(b){return-1!=this.actionsdone.indexOf(b)},doaction:function(b,e,f){"undefined"==typeof f&&(f=this.candoaction);return 0==b.length?(this.log("no action available"),
this.enqueueaction(function(b){this.endnoaction(b)}.bind(this),this.name)):this.enqueueaction(function(g){var h;$("#actiondial").empty();if(f.call(this)){this.select();"undefined"!=typeof e&&""!=e&&this.log(e);$("#actiondial").html($("<div>"));for(h=0;h<b.length;h++)this.isactiondone(b[h].name)||function(e,f){var l=$("<div>").addClass("symbols").text(A[e.type].key).click(function(){this.resolveaction(e,g)}.bind(this));"BOMB"==e.type&&l.addClass("bombs");l.attr("title",b[h].name);"/2"==b[h].name.slice(-2)&&
l.css("color","yellow");$("#actiondial > div").append(l)}.call(this,b[h],h);var l=$("<button>").addClass("m-skip").addClass("wbutton").click(function(){this.resolveaction(null,g)}.bind(this));$("#actiondial > div").append(l)}else this.endaction(g,null)}.bind(this),b[0].name)},donoaction:function(b,e,f,g){return 0==b.length?(this.log("no action available"),this.enqueueaction(function(b){this.endnoaction(b)}.bind(this),this.name)):this.enqueueaction(function(h){var l;"undefined"!=typeof e&&""!=e&&this.log(e);
this.select();$("#actiondial").html($("<div>"));for(l=0;l<b.length;l++)(function(b,e){var f=$("<div title='"+b.name+"'>").addClass("symbols").text(A[b.type].key).click(function(){this.resolvenoaction(b,h)}.bind(this));$("#actiondial > div").append(f)}).call(this,b[l],l);1==f&&(l=$("<button>").addClass("m-skip").addClass("wbutton").click(function(){"function"==typeof g&&g();this.resolvenoaction(null,h)}.bind(this)),$("#actiondial > div").append(l))}.bind(this),b[0].name)},hasnostresseffect:function(){return 0==
...
faction:REBEL,pilotid:233,unique:!0,done:!0,ambiguous:!0,edition:"TIE Fighter",unit:"TIE Fighter",skill:3,wave:["10"],upgrades:[],points:13,cancelhit:zeb_fct},{name:"Lieutenant Kestal",faction:EMPIRE,pilotid:234,unique:!0,done:!0,unit:"TIE Aggressor",skill:7,upgrades:[ELITE,TURRET,MISSILE,MISSILE],points:22},{name:"'Double Edge'",faction:EMPIRE,pilotid:235,unique:!0,done:!0,unit:"TIE Aggressor",skill:4,upgrades:[ELITE,TURRET,MISSILE,MISSILE],points:19},{name:"Onyx Squadron Escort",faction:EMPIRE,
pilotid:236,unique:!1,done:!0,unit:"TIE Aggressor",skill:5,upgrades:[TURRET,MISSILE,MISSILE],points:19},{name:"Sienar Specialist",faction:EMPIRE,pilotid:237,unique:!1,done:!0,unit:"TIE Aggressor",skill:2,upgrades:[TURRET,MISSILE,MISSILE],points:17}];var UPGRADE_TYPES={Elite:"ept",Torpedo:TORPEDO,Astromech:"amd",Turret:"turret",Missile:"missile",Crew:"crew",Cannon:"cannon",Bomb:"bomb",Title:"title",Mod:"mod",System:"system",Illicit:"illicit",Salvaged:"salvaged",Tech:"tech"};function AUXILIARY(b,e){return this.getPrimarySectorString(b,e.clone().rotate(this.arcrotation,0,0))}function SUBAUXILIARY(b,e,f){return this.getPrimarySubSectorString(b,e,f.clone().rotate(this.arcrotation,0,0))}
