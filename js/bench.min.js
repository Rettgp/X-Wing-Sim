...
(m=!1);(m?Unit.prototype:this).wrap_after(l,e,function(m,w,x){var v=!1;"removeshield"==l||"warndeath"==l||"endmaneuver"==l?x=activeunit:"undefined"==typeof x&&(x=this);for(i in f)if(f[i].isactive){v=!0;break}if(b.call(q,m,w,x)&&q.noattack<round&&v&&!q.iscloaked&&!q.isfireobstructed()){var z=x.deferred,v=function(){var l,q=[];this.deferred=z;l="function"==typeof h?h.call(this):this.selectnearbyenemy(3);for(var v in f)f[v].isactive&&0<f[v].getenemiesinrange(l).length&&q.push(f[v]);0==q.length?(this.log("no available target for %0",
e.name),this.cleanupattack()):b.call(this,m,w,x)?(this.log("+1 attack [%0]",e.name),"function"==typeof g&&this.wrap_before("resolveattack",this,function(){g.call(this)}.bind(this)).unwrapper("cleanupattack"),this.maxfired++,this.doattack(q,l)):this.cleanupattack()}.bind(q);"endcombatphase"!=l&&"warndeath"!=l&&phase==COMBAT_PHASE?x.newlock().done(v):v()}})},candoendmaneuveraction:function(){return this.candoaction()&&!this.collision&&!this.hascollidedobstacle()},doendmaneuveraction:function(){return this.doaction(this.getactionlist(!0),
...
this.getdial().length;e>=f?(this.m.translate(0,-20),e-=f):this.m.translate(0,20).rotate(180,0,0);this.maneuver=e;this.resolvemaneuver()}.bind(this),!1,!0);b.endnoaction(f,"DEPLOY")}.bind(this))},endcombatphase:function(){$(".fireline").remove()},endphase:function(){},beginplanningphase:function(){this.actionsdone=[];return this.newlock()},beginactivationphase:function(){return this.newlock()},timetoshowmaneuver:function(){return-1<this.maneuver&&phase<=ACTIVATION_PHASE},getmaneuver:function(){return this.hasionizationeffect()?
{move:"F1",difficulty:"WHITE"}:this.getdial()[this.maneuver]},showmaneuver:function(){if(this.timetoshowmaneuver()){var b=this.getmaneuver(),e=C["undefined"!=typeof this.forceddifficulty?this.forceddifficulty:b.difficulty];activeunit!=this&&(e=halftone(e));this.dialspeed.attr({text:P[b.move].speed,fill:e});this.dialdirection.attr({text:P[b.move].key,fill:e})}},clearmaneuver:function(){this.dialspeed.attr({text:""});this.dialdirection.attr({text:""})},beginactivation:function(){this.showmaneuver();
this.show()},endactivationphase:function(){},hasionizationeffect:function(){return 0<this.ionized&&!this.islarge||1<this.ionized},begincombatphase:function(){return this.newlock()},beginattack:function(){},toString:function(){if(phase==SELECT_PHASE||phase==CREATION_PHASE)return this.toString2();var b,e=8;b=squadron.indexOf(this);str=-1==b?"<div class='dead '>":this.isdocked?"<div class='docked'>":"<div>";str+="<div><div class='statskill'>"+this.getskill()+"</div>";t=formatstring(getpilottexttranslation(this,
this.faction));str+="<div class='name'>";""!=t&&(str+="<div class='tooltip outoverflow'><span>"+t+"</span></div>");str+="<div>"+translate(this.name)+"</div></div>";text=SHIP_translation[this.ship.name];"undefined"==typeof text&&(text=this.ship.name);str+="<div><div style='font-size:smaller'><code class='"+this.faction+"'></code>&nbsp;"+text+"</div></div>";e+=2*this.upgrades.length;this.hull+this.shield<=e?(str+="<div class='outoverflow stat'>",str+="<div class='hull'>"+repeat("u ",this.hull)+"</div>",
str+="<div class='shield'>"+repeat("u ",this.shield)+"</div></div>"):this.hull>e?(str+="<div class='outoverflow stat'>",str+="<div class='hull'>"+repeat("u ",e)+"</div></div>",this.hull<=2*e?(str+="<div class='outoverflow stat2'>",str+="<div class='hull'>"+repeat("u ",this.hull-e)+"</div>",this.shield+this.hull<=2*e?str+="<div class='shield'>"+repeat("u ",this.shield)+"</div></div>":(str+="<div class='shield'>"+repeat("u ",2*e-this.hull)+"</div></div>",str+="<div class='outoverflow stat3'>",str+=
"<div class='shield'>"+repeat("u ",this.shield-2*e+this.hull)+"</div></div>")):(str+="<div class='outoverflow stat2'><div class='hull'>"+repeat("u ",e)+"</div></div>",str+="<div class='outoverflow stat3'><div class='hull'>"+repeat("u ",this.hull-2*e)+"</div>",str+="<div class='shield'>"+repeat("u ",this.shield)+"</div></div>")):(str+="<div class='outoverflow stat'><div class='hull'>"+repeat("u ",this.hull)+"</div>",str+="<div class='shield'>"+repeat("u ",e-this.hull)+"</div></div>",str+="<div class='outoverflow stat2'><div class='shield'>"+
repeat("u ",this.shield-e+this.hull)+"</div></div>");str+="<div><div>";-1<b&&(str+="<div class='usabletokens' style='width:100%'>"+this.getusabletokens()+"</div>");str+="</div></div>";var f=e="",g="";b="<td><button class='statevade' onclick='if (!squadron["+b+"].dead&&!squadron["+b+"].isdocked) squadron["+b+"].togglerange();'><span class='val'>"+this.getagility()+"</span><span class='symbols'>^</span></button></td>";e=1==this.team?e+("<tr><td></td>"+b+"</tr>"):e+("<tr>"+b+"<td></td></tr>");for(b=
0;b<this.upgrades.length;b++)f+=this.upgrades[b];for(b=0;b<this.criticals.length;b++)g+=this.criticals[b];return str+="<table class='details' style='width:100%'>"+e+f+g+"</table></div>"},canusefocus:function(){return 0<this.focus},canuseevade:function(){return 0<this.evade},canusetarget:function(b){return 0<this.targeting.length&&("undefined"==typeof b||-1<this.targeting.indexOf(b))},getusabletokens:function(){this.focuses=1<this.focus?[this.focus]:[];this.evades=1<this.evade?[this.evade]:[];this.stresses=
1<this.stress?[this.stress]:[];this.ionizedes=1<this.ionized?[this.ionized]:[];this.tractorbeames=1<this.tractorbeam?[this.tractorbeam]:[];this.targetedname=[];this.targetingname=[];for(var b=0;b<this.istargeted.length;b++)this.targetedname[b]=this.istargeted[b].name.replace(/\'/g,"&#39;");for(b=0;b<this.targeting.length;b++)this.targetingname[b]=this.targeting[b].name.replace(/\'/g,"&#39;");return Mustache.render(TEMPLATES.usabletokens,this)},showskill:function(){var b=this.getskill();$("#unit"+
this.id+" .statskill").html(b);$("#"+this.id+" .statskill").html(b)},showstats:function(){$("#unit"+this.id+" .statevade .val").html(this.getagility());if(phase==SELECT_PHASE||phase==CREATION_PHASE)$("#unit"+this.id+" .stathull .val").html(this.ship.hull),$("#unit"+this.id+" .statshield .val").html(this.ship.shield);else{this.skillbar.attr({text:repeat("u",this.getskill())});this.firebar.attr({text:repeat("u",this.weapons[0].getattack())});this.evadebar.attr({text:repeat("u",this.getagility())});
this.hullbar.attr({text:repeat("u",this.hull)});this.shieldbar.attr({text:repeat("u",this.shield+this.hull)});var b=8+2*this.upgrades.length;this.hull+this.shield<=b?($("#"+this.id+" .stat .hull").html(repeat("u ",this.hull)),$("#"+this.id+" .stat .shield").html(repeat("u ",this.shield))):this.hull>b?($("#"+this.id+" .stat .hull").html(repeat("u ",b)),this.hull<=2*b?($("#"+this.id+" .stat2 .hull").html(repeat("u ",this.hull-b)),this.shield+this.hull<=2*b?$("#"+this.id+" .stat2 .shield").html(repeat("u ",
...
[[],[],[],[],[]],e;for(e in squadron){var f=squadron[e];f!=this&&(f=this.getrange(f),b[f].push({unit:e}))}return b}};var IACOMPUTING=0;function IAUnit(){}
...
this,function(b,f){var e=[],h;for(h in squadron)squadron[h].isally(this)&&(e=e.concat(Unit.prototype.gettargetableunits.vanilla.call(e,3)));return e})}},{name:"Adaptive Ailerons",type:TITLE,points:0,ship:"TIE Striker",done:!0,init:function(b){var e=this;b.adaptive=-1;"undefined"==typeof b.facultativeailerons&&(b.facultativeailerons=!1);b.wrap_after("premove",this,function(){var b=["F1","BR1","BL1"],e=this.moves[0];this.facultativeailerons||(this.moves=[]);this.moves=this.moves.concat([this.getpathmatrix(e,
b[0]),this.getpathmatrix(e,b[1]),this.getpathmatrix(e,b[2])])});b.wrap_before("beginactivation",this,function(){for(var b=this.maneuver,g=this.getdial(),h=[],l=[],m=0;m<g.length;m++)g[m].move.match(/F1|BL1|BR1/)&&(h.push(this.getpathmatrix(this.m,g[m].move)),l.push(m));this.adaptive<round&&(this.adaptive=round,this.donoaction([{org:e,type:"TITLE",name:e.name,action:function(f){this.wrap_after("candoendmaneuveraction",this,function(){return!1}).unwrapper("cleanupmaneuver");this.wrap_after("getdial",
this,function(b){for(var e=[],f=0;f<b.length;f++)e[f]={move:b[f].move,difficulty:"WHITE"};return e}).unwrapper("endmaneuver");this.wrap_before("cleanupmaneuver",e,function(){this.maneuver=b;this.cleanupmaneuver.unwrap(e);this.endnoaction(f,"TITLE");this.hasmoved=!1;this.newlock().done(function(){this.newlock().done(nextactivation);nextactivation()}.bind(this))});this.resolveactionmove(h,function(b,e){this.maneuver=l[e];this.resolvemaneuver()}.bind(this),!1,!0)}.bind(this)}],"",this.facultativeailerons))})}},
{name:"Swarm Leader",unique:!0,points:3,type:ELITE,done:!0,init:function(b){var e=this;b.wrap_after("preattackroll",this,function(b,g){var f=this.selectnearbyally(3,function(b,e){return e.canuseevade()&&e.isinfiringarc(g)?!0:!1}),l=0;0<f.length&&(l++,f[0].removeevadetoken());1<f.length&&(l++,f[1].removeevadetoken());this.log("+%1 attack die [%0]",l,e.name);this.wrap_after("getattackstrength",this,function(b,e,f){return f+l}).unwrapper("attackroll")})}},{name:"Lightweight Frame",type:MOD,points:2,
agilitymax:3,ship:"TIE",done:!0,init:function(b){var e=this;b.wrap_before("defenseroll",this,function(b,g){getattackdice()>getdefensedice()&&(this.log("+1 defense roll [%0]",e.name),this.wrap_after("getagility",e,function(b){return b+1}).unwrapper("defenseroll"))})}},{name:"'Light Scyk' Interceptor",type:TITLE,points:-2,ship:"M3-A Interceptor",lostupgrades:[MOD],done:!0,init:function(b){this.deal=function(b,e){return $.Deferred().resolve({crit:b,face:FACEUP})};var e=[];b.installed=!0;b.wrap_after("getdial",
this,function(b){if(0==e.length)for(var f=0;f<b.length;f++){var h=b[f].move,l=b[f].difficulty;h.match(/BL\d|BR\d/)&&(l="GREEN");e[f]={move:h,difficulty:l}}return e})}},{name:"Hotshot Co-Pilot",type:CREW,points:4,done:!0,init:function(b){var e=this,f=function(){if(this.canusefocus()){this.log("- %0 %FOCUS% [%1]",this.focus,e.name);for(var b=0;b<this.focus;b++)this.removefocustoken()}};b.wrap_before("resolveattack",this,function(b,h){this.weapons[b].isprimary&&h.wrap_before("endmodifydefensestep",e,
f)});b.wrap_before("isattackedby",this,function(b,h){h.wrap_before("endmodifyattackstep",e,f)})}},{name:"Trick Shot",type:ELITE,points:0,done:!0,init:function(b){var e=this;b.wrap_after("getattackstrength",this,function(b,g,h){0<this.getobstructiondef(g)&&(this.log("obstructed attack => +1 die [%0]",e.name),h+=1);return h})}},{name:"Bistan",type:CREW,points:2,unique:!0,done:!0,faction:REBEL,init:function(b){b.wrap_after("modifyattackroll",this,function(b,f,g,h){2>=this.getrange(targetunit)&&(h=h+
FCH_CRIT-FCH_HIT);return h});b.adddicemodifier(ATTACK_M,MOD_M,ATTACK_M,this,{req:function(e,f){return 2>=b.getrange(targetunit)}.bind(this),aiactivate:function(b,f){return!0},f:function(b,f){0<FCH_hit(b)&&(this.unit.log("%HIT% -> %CRIT% [%0]",this.name),b=b+FCH_CRIT-FCH_HIT);return b}.bind(this),str:"hit"})}},{name:"Expertise",type:ELITE,rating:2,points:4,done:!0,init:function(b){b.wrap_after("modifyattackroll",this,function(b,f,g,h){0==this.stress&&FCH_focus(h)&&(h+=(FCH_HIT-FCH_FOCUS)*FCH_focus(h));
...
v/g/ROCKS.length);for(q=0;q<ROCKS.length;q++)this.displayrockdebris(q,v,b,h,e,f,m);for(q=0;q<DEBRISCLOUD.length;q++)this.displayrockdebris(q+MAXROCKS,v,b,h,e,f,l)},checkdead:function(){var b,e=!0;for(b=0;b<this.units.length;b++)if(!this.units[b].dead){e=!1;break}return this.isdead=e},toggleplayer:function(b){this.isia=!this.isia},updatepoints:function(){var b=0;$("#listunits li").each(function(){var e=0;$(this).find(".pts").each(function(){console.log($(this).text());console.log(parseInt($(this).text()));
e+=parseInt($(this).text())});$(this).find(".upts").html(e);b+=e});$("#totalpts").html(b)},addunit:function(b){-1==b&&log("unknown addunit pilot "+pilots[b]);b=new Unit(this.team,b);$("#listunits").append(""+b);this.updatepoints()},tosquadron:function(b){var e=[],f,g,e=this.sortedgenerics(),h=0,l=0;for(f in generics)1==generics[f].team&&h++;for(f=0;f<e.length;f++)if(this.team==e[f].team){e[f].id=l++;2==e[f].team&&(e[f].id+=h);var m=e[f];for(g in PILOTS[m.pilotid]){var q=PILOTS[m.pilotid];"function"==
typeof q[g]&&(m[g]=q[g])}m.tosquadron(b);allunits.push(m);squadron.push(m);this.units.push(m)}for(f in squadron)m=squadron[f],m.team==this.team&&"function"==typeof m.init&&m.init();for(f in squadron)if(m=squadron[f],m.team==this.team)for(g=0;g<m.upgrades.length;g++)b=m.upgrades[g],0<=b.id&&"function"==typeof UPGRADES[b.id].uninstall&&UPGRADES[b.id].uninstall(m),"function"==typeof b.install&&b.install(m);for(f in squadron)if(m=squadron[f],m.team==this.team)for(g=0;g<m.upgrades.length;g++)b=m.upgrades[g],
"function"!=typeof b.init||m.isdocked||b.init(m);this.units.sort(function(b,e){return e.getskill()-b.getskill()});this.history={title:{text:UI_translation["Damage taken per turn"]},axisX:{interval:1,title:UI_translation.Turns},axisY:{title:UI_translation["Cumulated damage"]},rawdata:[],data:[{indexLabelFontColor:"darkSlateGray",name:"views",type:"area",color:"rgba(200,10,10,0.8)",markerSize:8,dataPoints:[]}]};return this.units},endsetup:function(){var b;for(b=0;b<this.units.length;b++)this.units[b].g.undrag()},
...
return b},toASCII:function(){for(var b="",e=this.sortedgenerics(),f=0;f<e.length;f++)b+=e[f].toASCII()+";";return b},toKey:function(){var b="",e=[],f;for(f in generics)generics[f].team==this.team&&e.push(generics[f]);e.sort(function(b,e){return b.pilotid-e.pilotid});for(f=0;f<e.length;f++)b+=e[f].toKey()+";";return b},toJSON:function(){var b={description:""};b.faction={REBEL:"rebels",SCUM:"scum",EMPIRE:"empire"}[this.faction];b.name=this.name;for(var e=[],f=0,g=this.sortedgenerics(),h=0;h<g.length;h++){var l=
g[h].toJSON(),f=f+l.points;e.push(l)}b.pilots=e;this.points=b.points=f;b.vendor={xwsbenchmark:{builder:"Ynot Squadron Benchmark",builder_url:"http://ynot6517.github.io/bench/"}};b.version="0.3.0";return b},toJuggler:function(b){for(var e="",f=this.sortedgenerics(),g=0;g<f.length;g++)e+=f[g].toJuggler(b)+"\n";return e},parseJuggler:function(b,e){var f,g,h,l;f=-1;var m=function(b){return"REBEL"==b?1:"SCUM"==b?2:4};f=7;if(""!=b){var q=b.trim().split("\n");for(g in generics)generics[g].team==this.team&&
delete generics[g];for(g=0;g<q.length;g++){var v=q[g].split(/\s+\+\s+/),w=0;for(h=0;h<PILOTS.length;h++){l=PILOTS[h].name;var x=translate(l),y="";1==PILOTS[h].ambiguous&&"undefined"!=typeof PILOTS[h].edition&&(y="("+PILOTS[h].edition+")");x+=y;l+=y;l.replace(/\'/g,"")==v[0]&&(w|=m(PILOTS[h].faction));x.replace(/\'/g,"")==v[0]&&(w|=m(PILOTS[h].faction))}f&=w}this.faction=1==(f&1)?"REBEL":2==(f&2)?"SCUM":"EMPIRE";this.color="REBEL"==this.faction?RED:"EMPIRE"==this.faction?GREEN:YELLOW;for(g=0;g<q.length;g++){f=
-1;v=q[g].split(/\s+\+\s+/);for(h=0;h<PILOTS.length;h++)if(x=l=PILOTS[h].name,y="",PILOTS[h].faction==this.faction){x=translate(l);1==PILOTS[h].ambiguous&&"undefined"!=typeof PILOTS[h].edition&&(y="("+PILOTS[h].edition+")");l+=y;x+=y;if(l.replace(/\'/g,"")==v[0]){f=h;break}if(x.replace(/\'/g,"")==v[0]){f=h;e=!0;break}}-1==f&&console.log("pid undefined:"+e+"!!"+v[0]+"!!"+this.faction);-1==f&&log("unknown Juggler pilot:"+q[g]+"/"+b);x=new Unit(this.team,f);x.upg=[];for(h=0;10>h;h++)x.upg[h]=-1;y=[TITLE,
MOD].concat(PILOTS[x.pilotid].upgrades);for(h=1;h<v.length;h++)for(l=0;l<UPGRADES.length;l++)if(1==e&&translate(UPGRADES[l].name).replace(/\'/g,"").replace(/\(Crew\)/g,"")==v[h]||UPGRADES[l].name.replace(/\'/g,"")==v[h]){if(-1<y.indexOf(UPGRADES[l].type)){"undefined"!=typeof UPGRADES[l].upgrades&&("Cannon|Torpedo|Missile"==UPGRADES[l].upgrades[0]?(y=y.concat(["Cannon","Torpedo","Missile"]),x.upgradetype=x.upgradetype.concat(["Cannon","Torpedo","Missile"])):(y=y.concat(UPGRADES[l].upgrades),""!=typeof UPGRADES[l].upgrades&&
(x.upgradetype=x.upgradetype.concat(UPGRADES[l].upgrades))));break}l==UPGRADES.length&&log("UPGRADE undefined: "+v[h])}for(h=1;h<v.length;h++)for(l=0;l<UPGRADES.length;l++)if(1==e&&translate(UPGRADES[l].name).replace(/\'/g,"").replace(/\(Crew\)/g,"")==v[h]||UPGRADES[l].name.replace(/\'/g,"")==v[h])if(-1<y.indexOf(UPGRADES[l].type)){for(f=0;f<x.upgradetype.length;f++)if(x.upgradetype[f]==UPGRADES[l].type&&-1==x.upg[f]){x.upg[f]=l;break}break}else log("** "+v[h]+" UPGRADE not listed: "+UPGRADES[l].type+
" in "+x.name)}}},parseASCII:function(b){b=b.split(";");for(var e in generics)generics[e].team==this.team&&delete generics[e];for(e=0;e<b.length-1;e++){var f=b[e].split(":"),g=f[0].split(","),h=parseInt(g[0],10);this.faction=PILOTS[h].faction;this.color="REBEL"==this.faction?RED:"EMPIRE"==this.faction?GREEN:YELLOW;-1==h&&log("unknown ASCII pilot "+b[e]);h=new Unit(this.team,h);h.upg=[];for(var l=0;10>l;l++)h.upg[l]=-1;for(l=1;l<g.length;l++)for(var m=parseInt(g[l],10),q=0;q<h.upgradetype.length;q++)if(h.upgradetype[q]==
UPGRADES[m].type&&-1==h.upg[q]){h.upg[q]=m;break}1<f.length&&(f=f[1].split(","),h.tx=parseInt(f[0],10),h.ty=parseInt(f[1],10),h.alpha=parseInt(f[2],10))}},parseJSON:function(b,e){var f,g={rebel:REBEL,scum:SCUM,imperial:EMPIRE};try{f=$.parseJSON(b),ga("send","event",{eventCategory:"social",eventAction:"receive",eventLabel:"xws"})}catch(z){return this.parseJuggler(b,e)}var h,l,m;this.name=f.name;this.points=f.points;this.faction=g[f.faction];this.color="REBEL"==this.faction?RED:"EMPIRE"==this.faction?
GREEN:YELLOW;for(h in generics)generics[h].team==this.team&&delete generics[h];for(h=0;h<f.pilots.length;h++){var q=f.pilots[h],v,g=-1;q.team=this.team;for(l=0;l<PILOTS.length;l++)if(PILOTS[l].faction==this.faction&&PILOTS[l].unit==PILOT_dict[q.ship]&&(va=PILOTS[l].name,va==PILOT_dict[q.name])){g=l;break}if(-1==g)throw"pid undefined:"+PILOT_dict[q.name];v=new Unit(this.team,g);v.upg=[];for(l=0;10>l;l++)v.upg[l]=-1;if("undefined"!=typeof q.upgrades){var w=0;for(l in q.upgrades){var x=q.upgrades[l];
for(m=0;m<x.length;m++){w++;for(var y=0;y<UPGRADES.length;y++)if(UPGRADES[y].name==UPGRADE_dict[x[m]]){for(g=0;g<v.upgradetype.length;g++)if(v.upgradetype[g]==UPGRADES[y].type&&-1==v.upg[g]){v.upg[g]=y;break}break}}}}}}};var Resample=function(b){function e(){throw"not found: "+this.src;}function f(){var e=this._width,f=this._height,q=this._onresample,v=Math.min(this.height,this.width);null==e&&(e=h(this.width*f/this.height));null==f&&(f=h(this.height*e/this.width));delete this._onresample;delete this._width;delete this._height;b.width=e;b.height=f;g.drawImage(this,0,0,v,v,0,0,e,f);q(b.toDataURL("image/png"))}var g=b.getContext("2d"),h=Math.round;return function(b,g,h,v){var l="string"==typeof b,m=l||b;l&&(m=new Image,
