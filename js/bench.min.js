...
return b+="<div class='xsymbols BLUE'>"+repeat("u",this.shield)+"</div>"},getupgradeaddstring:function(){for(var b="",e=0;e<this.upgradetype.length;e++)-1==this.upg[e]&&(b+="<button num="+e+" class='upgrades "+this.upgradetype[e].replace(/\|/g,"")+"'><sup class='label'>"+this.getupgradelist(this.upgradetype[e]).length+"</sup></button>");return b},showskill_old:function(){$("#unit"+this.id+" .statskill").html(this.getskill())},showupgradeadd:function(){$("#unit"+this.id+" .upgavail").html(this.getupgradeaddstring());
addupgradeaddhandler(this)},getagility:function(){return phase==COMBAT_PHASE?this.agility-this.tractorbeam:this.agility},getskill:function(){return this.skill},getdial:function(){return this.hasionizationeffect()?[{move:"F1",difficulty:"WHITE"}]:this.dial},doplan:function(){this.showdial();return this.deferred},getdialstring:function(){var b=[],e="";for(j=0;5>=j;j++)for(b[j]=[],k=0;7>=k;k++)b[j][k]="<td></td>";var f=this.getdial();for(j=0;j<f.length;j++)d=f[j],b[MPOS[d.move][0]][MPOS[d.move][1]]=
"<td class='symbols "+d.difficulty+"' move='"+d.move+"'>"+P[d.move].key+"</td>";for(j=5;0<=j;j--){e+="<tr>";e=0<j&&5>j?e+("<td>"+j+"</td>"):e+"<td></td>";for(k=0;7>=k;k++)e+=b[j][k];e+="</tr>\n"}return e},canreveal:function(b){return"RED"!=b.difficulty||0==this.stress},showdial:function(){var b=[],e,f,g=this.getdial();if(phase==PLANNING_PHASE||phase==SELECT_PHASE||phase==CREATION_PHASE){for(e=0;5>=e;e++)for(b[e]=[],f=0;7>=f;f++)b[e][f]="<td></td>";$("#select"+this.id).val();for(e=0;e<g.length;e++){f=
g[e];var h=MPOS[f.move][0],l=MPOS[f.move][1];this.canreveal(f)?(b[h][l]="<td",phase==PLANNING_PHASE&&(b[h][l]+=" onclick='activeunit.setmaneuver("+e+")'"),b[h][l]+=" class='symbols maneuver "+f.difficulty,this.maneuver==e&&(b[h][l]+=" selected"),b[h][l]+="' >"+P[f.move].key+"</td>"):b[h][l]="<td></td>"}g="";for(e=5;0<=e;e--){g+="<tr>";g=0<e&&5>e?g+("<td>"+e+"</td>"):g+"<td></td>";for(f=0;7>=f;f++)g+=b[e][f];g+="</tr>\n"}phase==SELECT_PHASE||phase==CREATION_PHASE?$("#dial"+this.id).html(g):$("#maneuverdial").html(g)}phase>=
...
typeof g.noupgrades&&-1<this.upgradetype.indexOf(g.noupgrades)||"undefined"!=typeof g.actionrequired&&-1==this.shipactionList.indexOf(g.actionrequired.toUpperCase())||"undefined"!=typeof this.maxupg[g.type]&&this.maxupg[g.type]<g.points)){if("undefined"!=typeof g.requiredupg){for(var h=!0,l=0;l<g.requiredupg.length;l++)if(-1==this.upgradetype.indexOf(g.requiredupg[l])){h=!1;break}if(!h)continue}!b.match(g.type)||1==g.takesdouble&&this.upgradetype.indexOf(g.type)==this.upgradetype.lastIndexOf(g.type)||
e.push(f)}}e.sort(function(b,e){return translate(UPGRADES[b].name)>translate(UPGRADES[e].name)});return e},turn:function(b){this.alpha+=b;this.m.rotate(b,0,0);this.show()},getactionstring:function(){for(var b="",e=0;e<this.shipactionList.length;e++)b+="<span class='GREEN symbols'>"+A[this.shipactionList[e]].key+"</span>&nbsp;";return b},showactionlist:function(){var b=this.getactionstring();$("#unit"+this.id+" .actionlist").html(b)},getattacktable:function(b){return ATTACK[b]},attackroll:function(b){var e,
f,g,h,l=this.getattacktable(b),m=0,q=Math.random();if(0==b)return 0;for(f=0;f<=b;f++)for(g=0;g<=b-f;g++)for(h=0;h<=b-f-g;h++)if(e=f*FCH_FOCUS+g+FCH_CRIT*h,m+=l[e],m>q)return FCH_FOCUS*f+h*FCH_CRIT+g;return 0},confirm:function(b){return confirm(b)},rollattackdie:function(b,e,f){e=[];for(f=0;f<b;f++)e.push(FACE[ATTACKDICE[this.rand(8)]]);return e},rolldefensedie:function(b,e,f){e=[];for(f=0;f<b;f++)e.push(FACE[DEFENSEDICE[this.rand(8)]]);return e},rand:function(b){return Math.floor(Math.random()*b)},
getdefensetable:function(b){return DEFENSE[b]},defenseroll:function(b){var e,f,g,h=$.Deferred(),l=this.getdefensetable(b),m=0,q=Math.random();if(0==b)return h.resolve({dice:b,roll:0}).promise();"undefined"==typeof l&&this.error("P undefined for n="+b);for(g=0;g<=b;g++)for(f=0;f<=b-g;f++)if(e=g*FE_FOCUS+f*FE_EVADE,m+=l[e],m>q)return h.resolve({dice:b,roll:FE_FOCUS*g+f*FE_EVADE}).promise();return h.resolve({dice:b,roll:0}).promise()},getdicemodifiers:function(){return[{from:ATTACK_M,type:MOD_M,to:ATTACK_M,
org:this,req:function(){return this.canusefocus()}.bind(this),aiactivate:function(b,e){return 0<FCH_focus(b)},f:function(b,e){this.removefocustoken();var f=FCH_focus(b);0<f&&(b=b-FCH_FOCUS*f+FCH_HIT*f);return b}.bind(this),str:"focus",token:!0,noreroll:"focus"},{from:ATTACK_M,type:REROLL_M,to:ATTACK_M,org:this,req:function(b,e,f){return this.canusetarget(f)}.bind(this),n:function(){return 9},dice:["blank","focus"],f:function(){activeunit.removetarget(targetunit)},str:"target",token:!0},{from:DEFENSE_M,
type:MOD_M,to:DEFENSE_M,org:this,req:function(){return this.canusefocus()}.bind(this),aiactivate:function(b,e){mm=getattackvalue();return 0<FE_focus(b)&&FCH_hit(mm)+FCH_crit(mm)>FE_evade(b)},f:function(b,e){this.removefocustoken();var f=FE_focus(b);0<f&&(b=b-FE_FOCUS*f+FE_EVADE*f);return b}.bind(this),str:"focus",token:!0},{from:DEFENSE_M,type:ADD_M,to:DEFENSE_M,org:this,req:function(){return this.canuseevade()}.bind(this),aiactivate:function(b,e){mm=getattackvalue();return FCH_hit(mm)+FCH_crit(mm)>
FE_evade(b)},f:function(b,e){this.removeevadetoken();return{m:b+FE_EVADE,n:e+1}}.bind(this),str:"evade",token:!0,noreroll:"focus"}]},adddicemodifier:function(b,e,f,g,h){h.org=g;h.type=e;h.from=b;h.to=f;this.wrap_after("getdicemodifiers",g,function(b){return b.concat(h)})},setclickhandler:function(b){this.g.unmousedown();this.g.mousedown(b)},setdefaultclickhandler:function(){this.g.unmousedown();this.g.mousedown(function(){this.select()}.bind(this))},dragshow:function(){this.g.transform(this.dragMatrix);
