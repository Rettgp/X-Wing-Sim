...
TEMPLATES.usabletokens=$("#usabletokens").html();Mustache.parse(TEMPLATES.usabletokens);TEMPLATES.selectweapon=$("#selectweapon").html();Mustache.parse(TEMPLATES.selectweapon);w.zoom=1;w.on("pinch",function(b){if("svgout"==b.target.id&&1!=activeunit.dragged){var e=VIEWPORT.m.clone().invert(),f=e.x(b.center.x,b.center.y),e=e.y(b.center.x,b.center.y);VIEWPORT.m.translate(f,e).scale(b.scale).scale(1/w.zoom).translate(-f,-e);w.zoom=b.scale;VIEWPORT.transform(VIEWPORT.m);activeunit.show();b["final"]&&
(w.zoom=1)}});$("aside").on("scroll touchmove touchstart mousewheel",scrolloverflow);$("#squadbattle").html("<thead><tr><th><span class='m-score'></span></th><th><span class='m-opponent'></span></th></tr></thead>");SQUADBATTLE=$("#squadbattle").DataTable({language:{search:UI_translation.Search,lengthMenu:UI_translation["Display _MENU_ records per page"],zeroRecords:UI_translation["Nothing found - sorry"],info:UI_translation["Showing page _PAGE_ of _PAGES_"],infoEmpty:UI_translation["No records available"],
infoFiltered:UI_translation["(filtered from _MAX_ total records)"]},autoWidth:!0,scrollY:"20em",scrollX:!0,deferRender:!0,scrollCollapse:!0,ordering:!0,processing:!0,info:!0,paging:!0});$("#squadbattle tbody").on("click","tr",function(){$(this).hasClass("selected")?$(this).removeClass("selected"):($("#squadbattle tr.selected").removeClass("selected"),$(this).addClass("selected"))});v=LZString.decompressFromEncodedURIComponent(decodeURI(window.location.search.substr(1)));g=[];null!=v&&(g=v.split("&"));
if(1<g.length)return log("Loading permalink..."),ROCKDATA=g[2],phase=CREATION_PHASE,TEAMS[1].parseASCII(g[0]),TEAMS[1].toJSON(),TEAMS[2].parseASCII(g[1]),TEAMS[2].toJSON(),TEAMS[1].isia=!1,TEAMS[2].isia=!1,"true"==g[3]?TEAMS[1].isia=!0:(localStorage.imageplayer=g[7],localStorage.playername=g[8]),"true"==g[4]?TEAMS[2].isia=!0:(localStorage.imageplayer=g[7],localStorage.playername=g[8]),SETUP=SETUPS[g[5]+" Map"],phase=SELECT_PHASE,6<g.length&""!=g[6]&&(REPLAY=g[6]),PERMALINK=LZString.compressToEncodedURIComponent(TEAMS[1].toASCII()+
"&"+TEAMS[2].toASCII()+"&"+saverock()+"&"+TEAMS[1].isia+"&"+TEAMS[2].isia+"&"+g[5]),nextphase();delete localStorage.imageplayer;delete localStorage.playername;phase=0;nextphase();localStorage.getItem("import")&&(log("Importing from another Squad Builder..."),currentteam=""==$("#squad1").val()?TEAMS[1]:TEAMS[2],currentteam.parseJSON(sessionStorage.getItem("import")),sessionStorage.clear(),endselection());SETUP=SETUPS["Classic Map"];$("#squadlist").html("<thead><tr><th></th><th>"+UI_translation.type+
"</th><th><span class='m-points'></span></th><th><span class='m-units'></span></th><th></th><th></th><th></th></tr></thead>");$.fn.dataTable.ext.search.push(function(b,e,f){return-1<e[1].search(stype)});SQUADLIST=$("#squadlist").DataTable({language:{search:UI_translation.Search,lengthMenu:UI_translation["Display _MENU_ records per page"],zeroRecords:UI_translation["Nothing found - sorry"],info:UI_translation["Showing page _PAGE_ of _PAGES_"],infoEmpty:UI_translation["No records available"],infoFiltered:UI_translation["(filtered from _MAX_ total records)"]},
autoWidth:!0,columnDefs:[{targets:[0],render:function(){return"<span class='closemiddle' onclick='removerow($(this))'>&times;</span> "},sortable:!1},{targets:[6],width:"2em",render:function(){return"<span class='squadtop'><span class='squadmiddle' onclick='checkrow(1,$(this))'>1</span>&nbsp;<span class='squadmiddle right' onclick='checkrow(2,$(this))'>2</span></span>"},sortable:!1},{targets:[5],render:function(b,e,f){return"<span class='logmiddle symbols' onclick='battlelog($(this));'>&#xE9;</span>"},
...
visible:!1,searchable:!1},{targets:[3],render:function(b,e,f){"en"!=LANG&&phase==SELECT_PHASE&&-1==f[4].search("SQUAD")&&(TEAMS[0].parseJuggler(b,!1),b=TEAMS[0].toJuggler(!0));return b.replace(/\n/g,"<br>")}}],ajax:"data/full4b.json",scrollY:"20em",scrollCollapse:!0,deferRender:!0,ordering:!0,info:!0,paging:!0});for(q in localStorage)"string"==typeof localStorage[q]&&q.match(/SQUAD.*/)&&(v=$.parseJSON(localStorage[q]),"undefined"==typeof v.jug||"undefined"==typeof v.pts?delete localStorage[q]:"en"!=
LANG?(TEAMS[0].parseJuggler(v.jug,!1),addrow(0,q,v.pts,v.faction,TEAMS[0].toJuggler(!0),!0)):addrow(0,q,v.pts,v.faction,v.jug,!0));$("#squadlist tr:first-child .squadtop").attr("data-intro","Select squad").attr("data-position","bottom");$("#squadlist tr:first-child .logmiddle").attr("data-intro","Battle log").attr("data-position","left");g=[];for(q=0;q<PILOTS.length;q++)v=q,v=translate(PILOTS[q].name),1==PILOTS[q].ambiguous&&"undefined"!=typeof PILOTS[q].edition&&(v+="("+PILOTS[q].edition+")"),g.push(v.replace(/\'/g,
"").replace(/\(Scum\)/g,""));v=[];for(q in UPGRADE_translation)v.push(" "+translate(q).replace(/\'/g,"").replace(/\(Crew\)/g,""));$(".squadbg > textarea").asuggest(g,{delimiters:"^\n",cycleOnTab:!0});$(".squadbg > textarea").asuggest(v,{delimiters:"+",cycleOnTab:!0})})});function util(){}
