...
(q=!1);(q?Unit.prototype:this).wrap_after(l,e,function(m,q,x){var v=!1;"removeshield"==l||"warndeath"==l||"endmaneuver"==l?x=activeunit:"undefined"==typeof x&&(x=this);for(i in f)if(f[i].isactive){v=!0;break}if(b.call(t,m,q,x)&&t.noattack<round&&v&&!t.iscloaked&&!t.isfireobstructed()){var w=x.deferred;console.log("Start add attack");v=function(){console.log("attack");var l,t=[];this.deferred=w;l="function"==typeof h?h.call(this):this.selectnearbyenemy(3);for(var v in f)f[v].isactive&&0<f[v].getenemiesinrange(l).length&&
t.push(f[v]);0==t.length?(this.log("no available target for %0",e.name),this.cleanupattack()):b.call(this,m,q,x)?(this.log("+1 attack [%0]",e.name),"function"==typeof g&&this.wrap_before("resolveattack",this,function(){g.call(this)}.bind(this)).unwrapper("cleanupattack"),this.maxfired++,this.doattack(t,l)):(console.log("CANT CALL F"),this.cleanupattack())}.bind(t);"endcombatphase"!=l&&"warndeath"!=l&&phase==COMBAT_PHASE?(console.log("new lock attack"),e.newlock().done(v)):v()}}).unwrapper(m)},candoendmaneuveraction:function(){return this.candoaction()&&
!this.collision&&!this.hascollidedobstacle()},doendmaneuveraction:function(){return this.doaction(this.getactionlist(!0),"",this.candoendmaneuveraction)},doselection:function(b,e){return this.enqueueaction(b,e)},isactiondone:function(b){return-1!=this.actionsdone.indexOf(b)},doaction:function(b,e,f){"undefined"==typeof f&&(f=this.candoaction);return 0==b.length?(this.log("no action available"),this.enqueueaction(function(b){this.endnoaction(b)}.bind(this),this.name)):this.enqueueaction(function(g){var h;
$("#actiondial").empty();if(f.call(this)){this.select();"undefined"!=typeof e&&""!=e&&this.log(e);$("#actiondial").html($("<div>"));for(h=0;h<b.length;h++)this.isactiondone(b[h].name)||function(e,f){var l=$("<div>").addClass("symbols").text(A[e.type].key).click(function(){this.resolveaction(e,g)}.bind(this));"BOMB"==e.type&&l.addClass("bombs");l.attr("title",b[h].name);"/2"==b[h].name.slice(-2)&&l.css("color","yellow");$("#actiondial > div").append(l)}.call(this,b[h],h);var l=$("<button>").addClass("m-skip").addClass("wbutton").click(function(){this.resolveaction(null,
g)}.bind(this));$("#actiondial > div").append(l)}else this.endaction(g,null)}.bind(this),b[0].name)},donoaction:function(b,e,f,g){return 0==b.length?(this.log("no action available"),this.enqueueaction(function(b){this.endnoaction(b)}.bind(this),this.name)):this.enqueueaction(function(h){var l;"undefined"!=typeof e&&""!=e&&this.log(e);this.select();$("#actiondial").html($("<div>"));for(l=0;l<b.length;l++)(function(b,e){var f=$("<div title='"+b.name+"'>").addClass("symbols").text(A[b.type].key).click(function(){this.resolvenoaction(b,
h)}.bind(this));$("#actiondial > div").append(f)}).call(this,b[l],l);1==f&&(l=$("<button>").addClass("m-skip").addClass("wbutton").click(function(){"function"==typeof g&&g();this.resolvenoaction(null,h)}.bind(this)),$("#actiondial > div").append(l))}.bind(this),b[0].name)},hasnostresseffect:function(){return 0==this.stress},candoaction:function(){return this.hasnostresseffect()},candecloak:function(){return this.iscloaked&&phase==ACTIVATION_PHASE&&!this.hasdecloaked},selecttargetforattack:function(b,
e){var f;ENGAGED=!0;f=this.weapons[b].getenemiesinrange(e);if(0==f.length)return this.log("no target for %0",this.weapons[b].name),this.cleanupattack(),!1;$("#attackdial").empty();this.selectunit(f,function(e,f){e[f]!=this&&this.declareattack(b,e[f])?this.resolveattack(b,e[f]):this.cleanupattack()},[""],!1);return!0},showattack:function(b,e){var f=[],g,h;$("#attackdial").show();"undefined"==typeof b&&(b=this.weapons);var l=this.getenemiesinrange(b,e),m=$("<div>");for(g=h=0;h<b.length;h++)0<l[h].length&&
(f[g++]=this.weapons.indexOf(b[h]));var q=this;for(g=0;g<f.length;g++)(function(b){var f=A[q.weapons[b].type.toUpperCase()];m.append($("<div>").attr({"class":"symbols "+b.color}).html(f.key).click(function(){q.selecttargetforattack(b,e)}))})(f[g]);m.append($("<button>").attr({"class":"m-skip wbutton"}).click(function(){this.cancelattack()}.bind(this)));$("#attackdial").html(m)},cancelattack:function(){this.maxfired--;this.show();this.cleanupattack()},candotarget:function(){return 0<this.gettargetableunits(3).length},
