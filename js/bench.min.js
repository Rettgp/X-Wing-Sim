...
{name:"Captured TIE",unique:!0,type:MOD,ship:"TIE Fighter",faction:REBEL,points:1,done:!0,init:function(b){var e=this,f=!1,g=function(){var b=0,f;for(f in squadron)squadron[f].team==this.team&&b++,this.log("Alive: [%1]",b);1==b&&e.desactivate()};b.wrap_after("declareattack",this,function(b,e,g){g&&(f=!0);return g});b.wrap_after("endsetupphase",this,g);Unit.prototype.wrap_before("dies",this,g);b.wrap_after("isenemy",this,function(b,g){return e.isactive?g&&!(!f&&this.getskill()>b.getskill()):g})}},
...
function(){this.log("+1 attack [%0]",e.name);return this.selectnearbyenemy(3,function(b,e){return e!=targetunit})})}},{name:"Bodhi Rook",type:CREW,points:1,unique:!0,faction:REBEL,done:!0,init:function(b){b.wrap_after("gettargetableunits",this,function(b,f){var e=[],h;for(h in squadron)squadron[h].isally(this)&&(e=e.concat(Unit.prototype.gettargetableunits.vanilla.call(e,3)));return e})}},{name:"Adaptive Ailerons",type:TITLE,points:0,ship:"TIE Striker",done:!0,init:function(b){var e=this;b.adaptive=
-1;"undefined"==typeof b.facultativeailerons&&(b.facultativeailerons=!1);b.wrap_after("premove",this,function(){var b=["F1","BR1","BL1"],e=this.moves[0];this.facultativeailerons||(this.moves=[]);this.moves=this.moves.concat([this.getpathmatrix(e,b[0]),this.getpathmatrix(e,b[1]),this.getpathmatrix(e,b[2])])});b.wrap_before("beginactivation",this,function(){for(var b=this.maneuver,g=this.getdial(),h=[],l=[],m=0;m<g.length;m++)g[m].move.match(/F1|BL1|BR1/)&&(h.push(this.getpathmatrix(this.m,g[m].move)),
l.push(m));this.adaptive<round&&(this.adaptive=round,this.donoaction([{org:e,type:"TITLE",name:e.name,action:function(f){this.wrap_after("candoendmaneuveraction",this,function(){return!1}).unwrapper("cleanupmaneuver");this.wrap_after("getdial",this,function(b){for(var e=[],f=0;f<b.length;f++)e[f]={move:b[f].move,difficulty:"WHITE"};return e}).unwrapper("endmaneuver");this.wrap_before("cleanupmaneuver",e,function(){this.maneuver=b;this.cleanupmaneuver.unwrap(e);this.endnoaction(f,"TITLE");this.hasmoved=
!1;this.newlock().done(function(){this.newlock().done(nextactivation);nextactivation()}.bind(this))});this.resolveactionmove(h,function(b,e){this.maneuver=l[e];this.resolvemaneuver()}.bind(this),!1,!0)}.bind(this)}],"",this.facultativeailerons))})}},{name:"Swarm Leader",unique:!0,points:3,type:ELITE,done:!0,init:function(b){var e=this;b.wrap_after("preattackroll",this,function(b,g){var f=this.selectnearbyally(3,function(b,e){return e.canuseevade()&&e.isinfiringarc(g)?!0:!1}),l=0;0<f.length&&(l++,
f[0].removeevadetoken());1<f.length&&(l++,f[1].removeevadetoken());this.log("+%1 attack die [%0]",l,e.name);this.wrap_after("getattackstrength",this,function(b,e,f){return f+l}).unwrapper("attackroll")})}},{name:"Lightweight Frame",type:MOD,points:2,agilitymax:3,ship:"TIE",done:!0,init:function(b){var e=this;b.wrap_before("defenseroll",this,function(b,g){getattackdice()>getdefensedice()&&(this.log("+1 defense roll [%0]",e.name),this.wrap_after("getagility",e,function(b){return b+1}).unwrapper("defenseroll"))})}},
