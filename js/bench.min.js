...
(m=!1);(m?Unit.prototype:this).wrap_after(l,e,function(m,v,w){var t=!1;"removeshield"==l||"warndeath"==l||"endmaneuver"==l?w=activeunit:"undefined"==typeof w&&(w=this);for(i in f)if(f[i].isactive){t=!0;break}if(b.call(q,m,v,w)&&q.noattack<round&&t&&!q.iscloaked&&!q.isfireobstructed()){var y=w.deferred,t=function(){var l,q=[];this.deferred=y;l="function"==typeof h?h.call(this):this.selectnearbyenemy(3);for(var t in f)f[t].isactive&&0<f[t].getenemiesinrange(l).length&&q.push(f[t]);0==q.length?(this.log("no available target for %0",
e.name),this.cleanupattack()):b.call(this,m,v,w)?(this.log("+1 attack [%0]",e.name),"function"==typeof g&&this.wrap_before("resolveattack",this,function(){g.call(this)}.bind(this)).unwrapper("cleanupattack"),this.maxfired++,this.doattack(q,l)):this.cleanupattack()}.bind(q);"endcombatphase"!=l&&"warndeath"!=l&&phase==COMBAT_PHASE?w.newlock().done(t):t()}})},candoendmaneuveraction:function(){return this.candoaction()&&!this.collision&&!this.hascollidedobstacle()},doendmaneuveraction:function(){return this.doaction(this.getactionlist(!0),
...
f){if(0<FE_focus(e)||0<FE_blank(e,f))b.removefocustoken(),this.log("Cancel %BLANK% and %FOCUS% on target"),console.log("pre M: "+e),console.log("pre N: "+f),e-=FE_FOCUS*FE_focus(e),f-=FE_blank(e,f),console.log("M: "+e),console.log("N: "+f);return{m:e,n:f}},str:"focus"})}},{name:"'Double Edge'",faction:EMPIRE,pilotid:235,unique:!0,done:!0,unit:"TIE Aggressor",skill:4,upgrades:[ELITE,TURRET,MISSILE,MISSILE],points:19,init:function(){}},{name:"Onyx Squadron Escort",faction:EMPIRE,pilotid:236,unique:!1,
done:!0,unit:"TIE Aggressor",skill:5,upgrades:[TURRET,MISSILE,MISSILE],points:19},{name:"Sienar Specialist",faction:EMPIRE,pilotid:237,unique:!1,done:!0,unit:"TIE Aggressor",skill:2,upgrades:[TURRET,MISSILE,MISSILE],points:17}];var UPGRADE_TYPES={Elite:"ept",Torpedo:TORPEDO,Astromech:"amd",Turret:"turret",Missile:"missile",Crew:"crew",Cannon:"cannon",Bomb:"bomb",Title:"title",Mod:"mod",System:"system",Illicit:"illicit",Salvaged:"salvaged",Tech:"tech"};function AUXILIARY(b,e){return this.getPrimarySectorString(b,e.clone().rotate(this.arcrotation,0,0))}function SUBAUXILIARY(b,e,f){return this.getPrimarySubSectorString(b,e,f.clone().rotate(this.arcrotation,0,0))}
