...
g.islarge?!0:!1;this.hull=g.hull;this.shield=g.shield;this.agility=g.evade;this.hasmobilearc="Mobilelaser"==g.weapon_type;for(f=0;f<g.dial.length;f++)this.dial[f]={move:g.dial[f].move,difficulty:g.dial[f].difficulty};this.shipactionList=g.actionList.slice(0);this.weapons=[];this.upgrades=[];this.criticals=[];this.conditions={};this.bombs=[];this.lastdrop=-1;Laser(this,g.weapon_type,g.fire);this.name=PILOTS[e].name;this.pilotid=e;this.unique=1==PILOTS[e].unique?!0:!1;this.skill=PILOTS[e].skill;this.install=
...
m;"getskill"==b&&filltabskill();return m},desactivate:function(){for(var b in this.wrapping){var e=this.wrapping[b];"function"==typeof e.wrap[e.name].unwrap&&e.wrap[e.name].unwrap(this)}this.isactive=!1},wrap_before:function(b,e,f,g){var h=this,l=h[b];if("undefined"!=typeof l){"undefined"==typeof h[b].save&&this!=Bomb.prototype&&this!=Unit.prototype&&this!=Weapon.prototype&&(h[b].save=h.__proto__[b]);"undefined"==typeof l&&console.log("name"+b+" undefined");var m=function(){var b=Array.prototype.slice.call(arguments);
f.apply(this,b);return l.apply(this,b)};m.save=l;m.org=e;"undefined"==typeof l&&console.error("org:"+e.name+" "+b);"undefined"==typeof e.wrapping&&(e.wrapping=[]);e.wrapping.push({name:b,wrap:this});m.vanilla="undefined"!=typeof l.vanilla?l.vanilla:l;m.unwrapper=function(b){var f=h.wrap_before(b,e,function(){m.unwrap(e);f.unwrap(e);h.show()})};l.next=m;m.unwrap=function(e){if(m.org==e)return m.save.next=m.next,"undefined"==typeof m.next&&(h[b]=m.save),h.show(),m.save;"function"==typeof m.save.unwrap&&
(m.save=m.save.unwrap(e));return m};return this[b]=m}},toJSON:function(){var b={};b.name=xws_lookup(this.name);b.points=PILOTS[this.pilotid].points;b.ship=xws_lookup(this.ship.name);for(var e={},f={},g=0;g<this.upg.length;g++){var h=this.upg[g];if(-1<h&&"undefined"!=typeof h){var l=UPGRADES[h];"undefined"==typeof e[upg_lookup(l.type)]&&(e[upg_lookup(l.type)]=[]);b.points+=l.points;if("undefined"!=typeof UPGRADES[h].pointsupg)for(var m=0;m<UPGRADES[h].upgrades.length;m++)f[UPGRADES[h].upgrades[m]]=
UPGRADES[h].pointsupg;e[upg_lookup(l.type)].push(upg_lookup(l.name))}}for(g=0;g<this.upg.length;g++)h=this.upg[g],-1<h&&"undefined"!=typeof h&&"undefined"!=typeof f[UPGRADES[h].type]&&(l=f[UPGRADES[h].type],b.points=0<UPGRADES[h].points+l?b.points+l:b.points-UPGRADES[h].points);this.points=b.points;b.upgrades=e;return b},toJuggler:function(b){var e=this.name;1==b&&(e=translate(this.name));e=e.replace(/\'/g,"");1==PILOTS[this.pilotid].ambiguous&&"undefined"!=typeof PILOTS[this.pilotid].edition&&(e=
e+"("+PILOTS[this.pilotid].edition+")");for(var f=0;f<this.upg.length;f++){var g=this.upg[f];if(-1<g){var h=UPGRADES[g].name;1==b&&(h=translate(UPGRADES[g].name));e+=" + "+h.replace(/\(Crew\)/g,"").replace(/\'/g,"")}}return e},toASCII:function(){for(var b=this.pilotid,e=0;e<this.upgrades.length;e++){var f=this.upgrades[e].id;-1<f&&(b+=","+f)}return b+=":"+Math.floor(this.tx)+","+Math.floor(this.ty)+","+Math.floor(this.alpha)},toKey:function(){for(var b=("00"+this.pilotid.toString(32)).slice(-2),e=
[],f=0;f<this.upg.length;f++)-1<this.upg[f]&&e.push(this.upg[f]);e.sort();for(f=0;f<e.length;f++)b+=("00"+e[f].toString(32)).slice(-2);return b},toString2:function(){var b=PILOTS[this.pilotid].dict;1==PILOTS[this.pilotid].ambiguous&&"undefined"!=typeof PILOTS[this.pilotid].edition&&(b+="-"+PILOTS[this.pilotid].edition.toLowerCase().replace(" ",""));var e=SHIP_translation[this.ship.name];"undefined"==typeof SHIP_translation[this.ship.name]&&(e=this.ship.name);return Mustache.render(TEMPLATES["unit-creation"],
{imgname:b,faction:currentteam.faction,skill:this.getskill(),name:translate(this.name),points:this.points,unique:1==PILOTS[this.pilotid].unique?!1:!0,id:this.id,evade:this.agility,hull:this.hull,shield:this.shield,fire:this.weapons[0].getattack(),shipimg:this.shipimg,diallist:dial2JSON(this.getdial()),shipname:e,actionstring:this.getactionstring(),upgradeaddstring:this.getupgradeaddstring()})},setpriority:function(b){var e={FOCUS:3,EVADE:1,CLOAK:4,TARGET:2,CRITICAL:100}[b.type];"undefined"==typeof e&&
(e=0);b.priority=e;e=[];"BOOST"==b.type&&(e=this.getboostmatrix(this.m));"ROLL"==b.type&&(e=this.getrollmatrix(this.m));if(0<e.length){var f=this.m,g=this.evaluateposition(),h=g-1;for(i=0;i<e.length;i++)this.m=e[i],h=Math.max(h,this.evaluateposition());this.m=f;h>g&&(b.priority=2*(h-g))}},getstatstring:function(){var b;b=""+("<div class='xsymbols RED'>"+repeat("u",this.weapons[0].getattack())+"</div>");b+="<div class='xsymbols GREEN'>"+repeat("u",this.getagility())+"</div>";b+="<div class='xsymbols YELLOW'>"+
repeat("u",this.hull)+"</div>";return b+="<div class='xsymbols BLUE'>"+repeat("u",this.shield)+"</div>"},getupgradeaddstring:function(){for(var b="",e=0;e<this.upgradetype.length;e++)-1==this.upg[e]&&(b+="<button num="+e+" class='upgrades "+this.upgradetype[e].replace(/\|/g,"")+"'><sup class='label'>"+this.getupgradelist(this.upgradetype[e]).length+"</sup></button>");return b},showskill_old:function(){$("#unit"+this.id+" .statskill").html(this.getskill())},showupgradeadd:function(){$("#unit"+this.id+
" .upgavail").html(this.getupgradeaddstring());addupgradeaddhandler(this)},getagility:function(){return phase==COMBAT_PHASE?this.agility-this.tractorbeam:this.agility},getskill:function(){return this.skill},getdial:function(){return this.hasionizationeffect()?[{move:"F1",difficulty:"WHITE"}]:this.dial},doplan:function(){this.showdial();return this.deferred},getdialstring:function(){var b=[],e="";for(j=0;5>=j;j++)for(b[j]=[],k=0;7>=k;k++)b[j][k]="<td></td>";var f=this.getdial();for(j=0;j<f.length;j++)d=
f[j],b[MPOS[d.move][0]][MPOS[d.move][1]]="<td class='symbols "+d.difficulty+"' move='"+d.move+"'>"+P[d.move].key+"</td>";for(j=5;0<=j;j--){e+="<tr>";e=0<j&&5>j?e+("<td>"+j+"</td>"):e+"<td></td>";for(k=0;7>=k;k++)e+=b[j][k];e+="</tr>\n"}return e},canreveal:function(b){return"RED"!=b.difficulty||0==this.stress},showdial:function(){var b=[],e,f,g=this.getdial();if(phase==PLANNING_PHASE||phase==SELECT_PHASE||phase==CREATION_PHASE){for(e=0;5>=e;e++)for(b[e]=[],f=0;7>=f;f++)b[e][f]="<td></td>";$("#select"+
this.id).val();for(e=0;e<g.length;e++){f=g[e];var h=MPOS[f.move][0],l=MPOS[f.move][1];this.canreveal(f)?(b[h][l]="<td",phase==PLANNING_PHASE&&(b[h][l]+=" onclick='activeunit.setmaneuver("+e+")'"),b[h][l]+=" class='symbols maneuver "+f.difficulty,this.maneuver==e&&(b[h][l]+=" selected"),b[h][l]+="' >"+P[f.move].key+"</td>"):b[h][l]="<td></td>"}g="";for(e=5;0<=e;e--){g+="<tr>";g=0<e&&5>e?g+("<td>"+e+"</td>"):g+"<td></td>";for(f=0;7>=f;f++)g+=b[e][f];g+="</tr>\n"}phase==SELECT_PHASE||phase==CREATION_PHASE?
$("#dial"+this.id).html(g):$("#maneuverdial").html(g)}phase>=PLANNING_PHASE&&(-1==this.maneuver||this.hasmoved)&&this.clearmaneuver()},getupgradelist:function(b){for(var e=[],f=0;f<UPGRADES.length;f++){var g=UPGRADES[f];if(!("undefined"!=typeof g.faction&&g.faction!=this.faction||"undefined"!=typeof g.ship&&-1==this.ship.name.search(g.ship)||"undefined"!=typeof g.ishuge||"undefined"!=typeof g.islarge&&this.islarge!=g.islarge||"undefined"!=typeof g.skillmin&&this.getskill()<g.skillmin||"undefined"!=
typeof g.agilitymax&&this.getagility()>=g.agilitymax||"undefined"!=typeof g.noupgrades&&-1<this.upgradetype.indexOf(g.noupgrades)||"undefined"!=typeof g.actionrequired&&-1==this.shipactionList.indexOf(g.actionrequired.toUpperCase())||"undefined"!=typeof this.maxupg[g.type]&&this.maxupg[g.type]<g.points)){if("undefined"!=typeof g.requiredupg){for(var h=!0,l=0;l<g.requiredupg.length;l++)if(-1==this.upgradetype.indexOf(g.requiredupg[l])){h=!1;break}if(!h)continue}!b.match(g.type)||1==g.takesdouble&&
this.upgradetype.indexOf(g.type)==this.upgradetype.lastIndexOf(g.type)||e.push(f)}}e.sort(function(b,e){return translate(UPGRADES[b].name)>translate(UPGRADES[e].name)});return e},turn:function(b){this.alpha+=b;this.m.rotate(b,0,0);this.show()},getactionstring:function(){for(var b="",e=0;e<this.shipactionList.length;e++)b+="<span class='GREEN symbols'>"+A[this.shipactionList[e]].key+"</span>&nbsp;";return b},showactionlist:function(){var b=this.getactionstring();$("#unit"+this.id+" .actionlist").html(b)},
getattacktable:function(b){return ATTACK[b]},attackroll:function(b){var e,f,g,h,l=this.getattacktable(b),m=0,q=Math.random();if(0==b)return 0;for(f=0;f<=b;f++)for(g=0;g<=b-f;g++)for(h=0;h<=b-f-g;h++)if(e=f*FCH_FOCUS+g+FCH_CRIT*h,m+=l[e],m>q)return FCH_FOCUS*f+h*FCH_CRIT+g;return 0},confirm:function(b){return confirm(b)},rollattackdie:function(b,e,f){e=[];for(f=0;f<b;f++)e.push(FACE[ATTACKDICE[this.rand(8)]]);return e},rolldefensedie:function(b,e,f){e=[];for(f=0;f<b;f++)e.push(FACE[DEFENSEDICE[this.rand(8)]]);
return e},rand:function(b){return Math.floor(Math.random()*b)},getdefensetable:function(b){return DEFENSE[b]},defenseroll:function(b){var e,f,g,h=$.Deferred(),l=this.getdefensetable(b),m=0,q=Math.random();if(0==b)return h.resolve({dice:b,roll:0}).promise();"undefined"==typeof l&&this.error("P undefined for n="+b);for(g=0;g<=b;g++)for(f=0;f<=b-g;f++)if(e=g*FE_FOCUS+f*FE_EVADE,m+=l[e],m>q)return h.resolve({dice:b,roll:FE_FOCUS*g+f*FE_EVADE}).promise();return h.resolve({dice:b,roll:0}).promise()},getdicemodifiers:function(){return[{from:ATTACK_M,
type:MOD_M,to:ATTACK_M,org:this,req:function(){return this.canusefocus()}.bind(this),aiactivate:function(b,e){return 0<FCH_focus(b)},f:function(b,e){this.removefocustoken();var f=FCH_focus(b);0<f&&(b=b-FCH_FOCUS*f+FCH_HIT*f);return b}.bind(this),str:"focus",token:!0,noreroll:"focus"},{from:ATTACK_M,type:REROLL_M,to:ATTACK_M,org:this,req:function(b,e,f){return this.canusetarget(f)}.bind(this),n:function(){return 9},dice:["blank","focus"],f:function(){activeunit.removetarget(targetunit)},str:"target",
token:!0},{from:DEFENSE_M,type:MOD_M,to:DEFENSE_M,org:this,req:function(){return this.canusefocus()}.bind(this),aiactivate:function(b,e){mm=getattackvalue();return 0<FE_focus(b)&&FCH_hit(mm)+FCH_crit(mm)>FE_evade(b)},f:function(b,e){this.removefocustoken();var f=FE_focus(b);0<f&&(b=b-FE_FOCUS*f+FE_EVADE*f);return b}.bind(this),str:"focus",token:!0},{from:DEFENSE_M,type:ADD_M,to:DEFENSE_M,org:this,req:function(){return this.canuseevade()}.bind(this),aiactivate:function(b,e){mm=getattackvalue();return FCH_hit(mm)+
FCH_crit(mm)>FE_evade(b)},f:function(b,e){this.removeevadetoken();return{m:b+FE_EVADE,n:e+1}}.bind(this),str:"evade",token:!0,noreroll:"focus"}]},adddicemodifier:function(b,e,f,g,h){h.org=g;h.type=e;h.from=b;h.to=f;this.wrap_after("getdicemodifiers",g,function(b){return b.concat(h)})},setclickhandler:function(b){this.g.unmousedown();this.g.mousedown(b)},setdefaultclickhandler:function(){this.g.unmousedown();this.g.mousedown(function(){this.select()}.bind(this))},dragshow:function(){this.g.transform(this.dragMatrix);
...
e){var f=FCH_crit(b.ch);return f>=b.e?{ch:b.ch-b.e*FCH_CRIT,e:0}:{ch:b.ch-f*FCH_CRIT,e:b.e-f}},evadeattack:function(b){var e=getdefenseresult(),f=getattackresult();displayattackroll(getattackdice(),f);e=this.cancelhit({ch:f,e:e},b);e=this.cancelcritical(e,b);"undefined"==typeof e&&this.error("undefined cancel critical");return e.ch},declareattack:function(b,e){targetunit=e;this.activeweapon=b;if(this.weapons[b].declareattack(e))return this.log("attacks %0 with %1",e.name,this.weapons[b].name),e.isattackedby(b,
this),!0;this.log("cannot attack %0 [%1]",e.name,this.weapons[b].name);return!1},isattackedby:function(b,e){},modifydamageassigned:function(b,e){return b},modifydefenseroll:function(b,e,f){return e},modifyattackroll:function(b,e,f){return b},resolveishit:function(){},hashit:function(b){return 0<this.criticalresolved+this.hitresolved},resolvedamage:function(){$(".fireline").remove();FAST||this.playfiresnd();var b=targetunit.evadeattack(this),b=this.weapons[this.activeweapon].modifydamageassigned(b,
targetunit),b=targetunit.modifydamageassigned(b,this);TEAMS[this.team].allred+=getattackdice();TEAMS[targetunit.team].allgreen+=getdefensedice();TEAMS[this.team].allhits+=FCH_hit(b);TEAMS[this.team].allcrits+=FCH_crit(b);TEAMS[targetunit.team].allevade+=FE_evade(getdefenseresult());var e=FCH_crit(b),f=FCH_hit(b);this.hasdamaged=!0;this.hitresolved=f;this.criticalresolved=e;this.hashit(targetunit)&&(targetunit.resolveishit(this),this.weapons[this.activeweapon].prehit(targetunit,e,f),this.hitresolved+
this.criticalresolved<targetunit.shield?targetunit.log("-%0 %SHIELD%",this.criticalresolved+this.hitresolved):0<targetunit.shield&&targetunit.log("-%0 %SHIELD%",targetunit.shield),this.hitresolved=targetunit.resolvehit(this.hitresolved),this.criticalresolved=targetunit.resolvecritical(this.criticalresolved),this.weapons[this.activeweapon].posthit(targetunit,e,f));this.weapons[this.activeweapon].endattack(e,f);this.usedweapon=this.activeweapon;this.weapons[this.activeweapon].hasdoubleattack()?(this.latedeferred=
this.deferred,targetunit.canbedestroyed(skillturn)&&targetunit.checkdead(),targetunit.dead||this.newlock().done(function(){this.deferred=this.latedeferred;this.log("+1 attack with %0",this.weapons[this.activeweapon].name);this.resolveattack(this.activeweapon,targetunit)}.bind(this)),this.cleanupattack()):TEAMS[targetunit.team].initiative?(targetunit.afterdefenseeffect(e,f,this),barrier(function(){this.afterattackeffect(e,f);targetunit.canbedestroyed(skillturn)&&targetunit.checkdead();targetunit.endbeingattacked(e,
f,this);this.endattack(e,f,targetunit);this.cleanupattack()}.bind(this))):(this.afterattackeffect(e,f),barrier(function(){targetunit.afterdefenseeffect(e,f,this);targetunit.canbedestroyed(skillturn)&&targetunit.checkdead();this.endattack(e,f,targetunit);targetunit.endbeingattacked(e,f,this);this.cleanupattack()}.bind(this)))},afterattackeffect:function(b,e){},afterdefenseeffect:function(b,e){},postattack:function(b){},cleanupattack:function(){this.actionbarrier();ENGAGED=!1},resetfocus:function(){return 0},
resetevade:function(){return 0},resettractorbeam:function(){return 0},endround:function(){for(var b=0;b<this.upgrades.length;b++)this.upgrades[b].endround();this.focus=this.resetfocus();this.evade=this.resetevade();this.hasfired=0;this.maxfired=1;this.tractorbeam=this.resettractorbeam();this.oldoverlap=this.ocollision.overlap;this.ocollision.overlap=-1;this.ocollision.template=[];this.ocollision.mine=[];this.collision=!1;this.touching=[];this.showinfo()},playfiresnd:function(){var b=targetunit.g.getBBox(),
e=transformPoint(this.m,{x:0,y:-(this.islarge?40:20)}),f=s.path("M "+e.x+" "+e.y+" L "+(b.x+b.w/2)+" "+(b.y+b.h/2)).appendTo(VIEWPORT).attr({stroke:this.color,strokeWidth:2}),g=setInterval(function(){f.remove();clearInterval(g)},200);this.movelog("f-"+targetunit.id+"-"+this.activeweapon);"undefined"!=typeof this.weapons[this.activeweapon]&&"undefined"!=typeof this.weapons[this.activeweapon].firesnd?SOUNDS[this.weapons[this.activeweapon].firesnd].play():SOUNDS[this.ship.firesnd].play()},endattack:function(b,
e,f){for(i=0;i<DICES.length;i++)$("."+DICES[i]+"dice").remove();this.show()},endbeingattacked:function(b,e,f){},showpositions:function(b){var e,f=[];for(e=0;e<b.length;e++)f[e]=this.getOutline(b[e].m).attr({title:b[e].move,opacity:.4,fill:halftone(b[e].color),display:"block","class":"possible"}).appendTo(VIEWPORT),function(e){f[e].hover(function(){f[e].attr({stroke:b[e].color,strokeWidth:4})}.bind(this),function(){f[e].attr({strokeWidth:0})}.bind(this))}.call(this,e)},showmeanposition:function(){this.getdial();
this.evaluatemoves(!0,!0);this.showpositions([{color:GREEN,move:"mean",m:this.meanm}])},shownextpositions:function(){var b=this.getdial();this.evaluatemoves(!0,!0);var e=[];for(i=0;i<b.length;i++)e[i]=b[i].next;this.showpositions(e)},showpossiblepositions:function(){this.evaluatemoves(!0,!0);var b=this.getdial();this.showpositions(b)},evaluateposition:function(){var b=0,e=0,f=0,g,h,l=0;NOLOG=!0;for(h in squadron){var m=squadron[h];if(this.isenemy(m)){var q=0;for(g=0;g<m.weapons.length;g++){var t=
m.weapons[g].getrange(this);0<t&&4>t&&(q=Math.max(q,m.getattackstrength(g,this)))}b+=q;for(g=0;g<this.weapons.length;g++)q=this.weapons[g].getrange(m),0<q&&4>q&&(e=Math.max(e,this.getattackstrength(g,m)));l+=this.getdist(this.m,m)/9E4;f++}}NOLOG=!1;return e-b-l/f},evaluatemoves:function(b,e){this.meanmround=round;var f=this.getdial(),g=0,h=0,l=0,m=0,q,t=RED,v={"#000":0,"#F00":1,"#FF0":2,"#FFF":3,"#0F0":4};NOLOG=!0;var w=(this.m.split().rotate+360+180)%360-180;for(q=0;q<f.length;q++)f[q].path=P[f[q].move].path,
f[q].len=f[q].path.getTotalLength()+(this.islarge?40:0);for(q=0;q<f.length;q++){var x=this.getpathmatrix(this.m,f[q].move);f[q].m=x;if(this.canreveal(f[q])){var y=this.getmovecolor(x,b,e,f[q].path,f[q].len,!0);f[q].color=y;if(y!=RED&&y!=BLACK&&b&&e){var z=RED,D=this.ocollision;for(j=0;j<f.length;j++){var B;if(!("F0"==f[j].move||"RED"==f[j].difficulty&&(this.hasnostresseffect()&&"GREEN"!=f[q].difficulty||"RED"==f[q].difficulty))){var E=this.getmatrixwithmove(x,f[j].path,f[j].len);B=GREEN;this.isinzone(E)?
e&&(this.fastgetocollisions(x,E,f[j].path,f[j].len)?this.ocollision.overlap=1:this.ocollision.overlap=-1,this.hascollidedobstacle()&&(B=YELLOW)):B=RED;v[B]>v[z]&&(z=B)}}this.ocollision=D;v[z]<v[y]&&(f[q].color=z)}}else f[q].color=BLACK;v[t]>v[f[q].color]&&(t=f[q].color);f[q].color!=GREEN&&f[q].color!=WHITE||f[q].move.match(/K\d|SR\d|SL\d|TRL\d|TRR\d/)||(x=x.split(),m++,x.rotate=(x.rotate-w+180)%360-180,g+=x.dx,h+=x.dy,l+=x.rotate)}for(q=0;q<f.length;q++)"F0"==f[q].move&&(f[q].color=t);0==m&&(m=1);
g/=m;h/=m;l/=m;this.meanm=(new Snap.Matrix).translate(g,h).rotate(l+w,0,0);NOLOG=!1},removetarget:function(b){var e;e=b.istargeted.indexOf(this);-1<e&&b.istargeted.splice(e,1);e=this.targeting.indexOf(b);-1<e&&(this.targeting.splice(e,1),this.movelog("t-"+b.id),b.show(),this.show());0==this.targeting.length&&$("#atokens > .xtargettoken").remove()},removeevadetoken:function(){this.animateremovetoken("xevadetoken");this.evade--;this.movelog("e");this.show()},removefocustoken:function(){this.animateremovetoken("xfocustoken");
this.focus--;this.movelog("fo");this.show()},resolveactionmove:function(b,e,f,g){var h;this.pos=[];var l=function(b,e,l){for(h=0;h<this.pos.length;h++)this.pos[h].ol.remove();if(f){var m=b.split(),q=this.m.split();s.path("M "+q.dx+" "+q.dy+" L "+m.dx+" "+m.dy).attr({stroke:this.color,display:TRACE?"block":"none",strokeWidth:"20px",strokeLinecap:"round",strokeDasharray:"1, 30",opacity:.2,fill:"rgba(0,0,0,0)"}).addClass("trace").appendTo(VIEWPORT);this.m=b}m=this.getmcollisions(this.m);if(0<m.length)for(h=
0;h<m.length;h++)q=OBSTACLES[m[h]],q.type==BOMB&&"function"==typeof q.detonate?q.detonate(this,!1):(this.ocollision.overlap=h,this.log("colliding with obstacle"),g||this.resolveocollision(1,[]));f&&(m=b.split(),this.movelog("am-"+Math.floor(300+m.dx)+"-"+Math.floor(300+m.dy)+"-"+Math.floor((360+Math.floor(m.rotate))%360)));l(this,e);this.show()}.bind(this);for(h=b.length-1;0<=h;h--){var m=this.getmovecolor(b[h],!0,!0);if(g&&(m==YELLOW||m==RED)||m==GREEN||g&&!f)p=this.getOutline(b[h]).attr({display:"block"}).appendTo(VIEWPORT),
this.pos.push({ol:p,k:h})}if(0<this.pos.length)if(1==this.pos.length)l(b[this.pos[0].k],this.pos[0].k,e);else for(h=0;h<this.pos.length;h++)(function(f){var g=this.pos[f];g.ol.hover(function(){this.pos[f].ol.attr({stroke:this.color,strokeWidth:4})}.bind(this),function(){this.pos[f].ol.attr({strokeWidth:0})}.bind(this));g.ol.click(function(){l(b[this.pos[f].k],this.pos[f].k,e)}.bind(this));g.ol.touchend(function(){l(b[this.pos[f].k],this.pos[f].k,e)}.bind(this))}).call(this,h);else l(this.m,-1,e)},
resolveactionselection:function(b,e){var f;this.pos=[];var g=function(g){for(f=0;f<b.length;f++)b[f].outline.removeClass("outline"),b[f].outline.attr({fill:"rgba(8,8,8,0.5)"}),b[f].setdefaultclickhandler();e(g)}.bind(this);if(0==b.length)g(-1);else if(1==b.length)g(0);else for(f=0;f<b.length;f++)b[f].outline.attr({fill:"rgba(100,100,100,0.8)"}),b[f].outline.addClass("outline"),function(e){b[e].setclickhandler(function(){g(e)})}(f)},getboostmatrix:function(b){return[this.getpathmatrix(this.m,"F1"),
this.getpathmatrix(this.m,"BL1"),this.getpathmatrix(this.m,"BR1")]},resolveboost:function(b){this.resolveactionmove(this.getboostmatrix(this.m),function(e,f){e.endaction(b,"BOOST")},!0,this.canmoveonobstacles("BOOST"))},candoarcrotate:function(){return this.hasmobilearc},setarcrotate:function(b){this.arcrotation=90*b},resolvearcrotate:function(b,e){for(var f=this.weapons[0].auxiliary,g=[],h=this,l=0;4>l;l++)g[l]=s.path(f.call(this,1,this.m.clone().rotate(90*l-this.arcrotation,0,0))).attr({fill:this.color,
stroke:this.color,opacity:.1}).appendTo(VIEWPORT);for(l=0;4>l;l++)(function(f){g[f].hover(function(){g[f].attr({opacity:.4})},function(){g[f].attr({opacity:.1})});g[f].click(function(){h.setarcrotate(f);0==f&&h.log("Mobile firing arc rotated to front");1==f&&h.log("Mobile firing arc rotated to right side");2==f&&h.log("Mobile firing arc rotated to back");3==f&&h.log("Mobile firing arc rotated to left side");h.movelog("R-"+f);for(var l=0;4>l;l++)g[l].attr({display:"none"});1==e?h.endnoaction(b,"ARCMOBILE"):
h.endaction(b,"ARCMOBILE")})})(l)},canmoveonobstacles:function(b){return!1},getdecloakmatrix:function(b){var e=this.getpathmatrix(this.m.clone().rotate(90,0,0),"F2").translate(0,this.islarge?20:0).rotate(-90,0,0),f=this.getpathmatrix(this.m.clone().rotate(-90,0,0),"F2").translate(0,this.islarge?20:0).rotate(90,0,0);return[b.clone(),e.clone().translate(0,-20),e,e.clone().translate(0,20),f.clone().translate(0,-20),f,f.clone().translate(0,20),this.getpathmatrix(b.clone(),"F2")]},removecloaktoken:function(){this.agility-=
2;this.iscloaked=!1;this.animateremovetoken("xcloaktoken");this.movelog("ct");FAST||SOUNDS.decloak.play()},resolvedecloak:function(b){var e="(or self to cancel)";1==b&&(e="(or self)");this.log("select position to decloak "+e);this.doselection(function(e){this.resolveactionmove(this.getdecloakmatrix(this.m),function(f,h){(0<h||1==b)&&this.removecloaktoken();this.hasdecloaked=!0;this.endnoaction(e,"DECLOAK")}.bind(this),!0,this.canmoveonobstacles("DECLOAK"))}.bind(this));return!0},gettallonrollmatrix:function(b,
e){var f=this.getpathmatrix(b,e);return[f.clone().translate(0,-20),f,f.clone().translate(0,20)]},getrollmatrix:function(b){b=this.getpathmatrix(this.m.clone().rotate(90,0,0),"F1").translate(0,this.islarge?20:0).rotate(-90,0,0);var e=this.getpathmatrix(this.m.clone().rotate(-90,0,0),"F1").translate(0,this.islarge?20:0).rotate(90,0,0);p=[b.clone().translate(0,-20),b,b.clone().translate(0,20),e.clone().translate(0,-20),e,e.clone().translate(0,20)];this.islarge&&(p=p.concat([b.clone().translate(0,-40),
b.clone().translate(0,40),e.clone().translate(0,-40),e.clone().translate(0,40)]));return p},resolveroll:function(b){this.resolveactionmove(this.getrollmatrix(this.m),function(e,f){e.endaction(b,"ROLL")},!0,this.canmoveonobstacles("ROLL"))},boundtargets:function(b){if(-1<this.targeting.indexOf(b))return!0;for(b=this.targeting.length-1;0<=b;b--)this.removetarget(this.targeting[b]);return!1},addtarget:function(b){this.boundtargets(b)||(this.targeting.push(b),this.animateaddtoken("xtargettoken"),b.istargeted.push(this),
b.animateaddtoken("xtargetedtoken"),this.movelog("T-"+b.id),b.show(),this.show())},gettargetableunits:function(b){var e=[],f;for(f in squadron)this.isenemy(squadron[f])&&squadron[f].canbetargeted(this)&&this.getrange(squadron[f])<=b&&e.push(squadron[f]);return e},selectnearbyunits:function(b,e){var f=[],g;for(g in squadron)e(this,squadron[g])&&this.getrange(squadron[g])<=b&&f.push(squadron[g]);return f},selectnearbyobstacle:function(b){var e=[],f=9E4;1==b?f=1E4:2==b&&(f=4E4);for(b=0;b<OBSTACLES.length;b++){var g=
OBSTACLES[b];(g.type==DEBRIS||g.type==ROCK)&&this.getdist(this.m,g)<=f&&e.push(g)}return e},selectnearbyally:function(b,e){return this.selectnearbyunits(b,function(b,g){var f=!0;"function"==typeof e&&(f=e(b,g));return b.isally(g)&&b!=g&&f})},selectnearbyallyandself:function(b,e){return this.selectnearbyunits(b,function(b,g){var f=!0;"function"==typeof e&&(f=e(b,g));return b.isally(g)&&f})},selectnearbyenemy:function(b,e){return this.selectnearbyunits(b,function(b,g){var f=!0;"function"==typeof e&&
(f=e(b,g));return b.isenemy(g)&&g.canbetargeted(b)&&f})},isally:function(b){return b.team==this.team},isenemy:function(b){return b.team!=this.team},canbetargeted:function(b){return!0},resolvetargetnoaction:function(b,e){var f=this.gettargetableunits(3);this.resolveactionselection(f,function(g){0<=g&&this.addtarget(f[g]);1==e?this.endnoaction(b,"TARGET"):this.endaction(b,"TARGET")}.bind(this))},resolvetarget:function(b){this.resolvetargetnoaction(b,!1)},addcloaktoken:function(){this.iscloaked=!0;this.agility+=
2;this.animateaddtoken("xcloaktoken");this.movelog("CT");FAST||SOUNDS.cloak.play()},addcloak:function(b){this.addcloaktoken();this.endaction(b,"CLOAK")},resolveslam:function(b){var e=this.getdial();e.length<=this.lastmaneuver&&(this.lastmaneuver=0);for(var f=e[this.lastmaneuver].move.substr(-1),g=[],h=[],l=0;l<e.length;l++)e[l].move.substr(-1)==f&&(g.push(this.getpathmatrix(this.m,e[l].move)),h.push(l));this.log("select maneuver for SLAM");this.noattack=round;this.wrap_after("getdial",this,function(b){for(var e=
[],f=0;f<b.length;f++)e[f]={move:b[f].move,difficulty:"WHITE"};return e}).unwrapper("endmaneuver");this.wrap_after("endmaneuver",this,function(){this.endaction(b,"SLAM")}).unwrapper("endactivationphase");this.wrap_after("candoendmaneuveraction",this,function(){return!1}).unwrapper("endphase");this.resolveactionmove(g,function(b,e){this.maneuver=h[e];this.resolvemaneuver()}.bind(this),!1,!0)},enqueueaction:function(b,e){actionr.push($.Deferred());var f=actionr.length-1;"undefined"==typeof e&&(e="undefined");
actionr[f].name=e;0==f?b(f):actionr[f-1].done(function(){b(f)}.bind(this));return actionr[f]},endnoaction:function(b,e){actionr[b].resolve(e);b==actionr.length-1&&actionrlock.resolve();this.show()},endaction:function(b,e){phase==ACTIVATION_PHASE&&$("#activationdial").show();this.clearaction();this.endnoaction(b,e)},resolveaction:function(b,e){$("#actiondial").empty();null==b?this.endaction(e,null):(this.actionsdone.push(b.name),b.action.call(b.org,e))},resolvenoaction:function(b,e){$("#actiondial").empty();
null==b?this.endnoaction(e,null):b.action.call(b.org,e)},evaluatetohit:function(b,e){var f=this.gethitrange(b,e);if(e!=this&&3>=f&&0<f){var g=this.getattackstrength(b,e),h=e.getdefensestrength(b,this),f=this.focus,l=this.reroll,m=this.weapons[b];-1<this.targeting.indexOf(e)&&(this.reroll=10);1==m.consumes&&"Target".match(m.getrequirements())&&this.canusetarget(e)&&(this.reroll=0);1==m.consumes&&"Focus".match(m.getrequirements())&&this.canusefocus(e)&&this.focus--;g=tohitproba(this,this.weapons[b],
e,this.getattacktable(g),e.getdefensetable(h),g,h);f&&(this.focus=f);l&&(this.reroll=l);return g}return{proba:[],tohit:0,meanhit:0,meancritical:0,tokill:0}},isfireobstructed:function(){return-1<this.ocollision.overlap&&OBSTACLES[this.ocollision.overlap].type==ROCK},hascollidedobstacle:function(){return-1<this.ocollision.overlap||0<this.ocollision.template.length},canfire:function(){return this.noattack<round&&this.hasfired<this.maxfired&&!this.iscloaked&&!this.isfireobstructed()},getattackstrength:function(b,
e){return this.weapons[b].getattack()+this.weapons[b].getrangeattackbonus(e)},getobstructiondef:function(b){return this.getoutlinerange(this.m,b).o?1:0},getdefensestrength:function(b,e){var f=this.getagility(),g=e.getobstructiondef(this);0<g&&this.log("+%0 defense for obstacle",g);return f+e.weapons[b].getrangedefensebonus(this)+g},hasnorerollmodifiers:function(b,e,f,g,h){for(var l=this.getdicemodifiers(),m=0;m<l.length;m++){var q=l[m];if(q.from==b&&q.to==e&&q.type==MOD_M&&q.req(f,g)&&q.noreroll==
h)return!0}return!1},getresultmodifiers:function(b,e,f,g){var h,l=function(b,e){var h=b.str+(f==DEFENSE_M?"modtokend":"modtokena");"undefined"!=typeof b.token&&(h="x"+b.str+"token");h=$("<td>").addClass(h).attr({id:"mod"+e,title:"modify roll ["+b.org.name+"]"}).html("");h.click(function(){modroll(this.f,e,g)}.bind(b));return h},m=function(b,e){var h=b.str+(f==DEFENSE_M?"modtokend":"modtokena");"undefined"!=typeof b.token&&(h="x"+b.str+"token");h=$("<td>").addClass(h).attr({id:"mod"+e,title:"add result ["+
b.org.name+"]"}).html("");h.click(function(){addroll(this.f,e,g)}.bind(b));return h},q=function(b,e){var h=b.str+(f==DEFENSE_M?"modtokend":"modtokena");"undefined"!=typeof b.token&&(h="x"+b.str+"token");h=$("<td>").addClass(h).attr({id:"mod"+e,title:"cancel result ["+b.org.name+"]"}).html("");h.click(function(){cancelroll(this.f,e,g)}.bind(b));return h},t=function(b,e){var h=b.n(),l="R"+h,m="tokens";b.str&&(m="x"+b.str+"token",l="");l=$("<td>").addClass(m).attr({id:"reroll"+e,title:h+" rerolls["+
b.org.name+"]"}).html(l);l.click(function(){reroll(h,f,g,b,e)});return l},v=this.getdicemodifiers(),w=[];for(h=0;h<v.length;h++){var x=v[h];x.from==f&&x.to==g&&(x.type==MOD_M&&x.req.call(this,b,e)&&w.push(l(x,h)),x.type==ADD_M&&x.req.call(this,b,e)&&w.push(m(x,h)),x.type==CANCEL_M&&x.req.call(this,b,e)&&w.push(q(x,h)),x.type==REROLL_M&&x.req.call(this,activeunit,activeunit.weapons[activeunit.activeweapon],targetunit)&&w.push(t(x,h)))}return w},addhasfired:function(){this.hasfired++},resolveattack:function(b,
e){var f;this.gethitrange(b,e);this.addhasfired();this.hasdamaged=!1;displaycombatdial();var g=e.g.getBBox(),h=transformPoint(this.m,{x:0,y:-(this.islarge?40:20)});s.path("M "+h.x+" "+h.y+" L "+(g.x+g.w/2)+" "+(g.y+g.h/2)).appendTo(VIEWPORT).attr({stroke:this.color,strokeWidth:2,strokeDasharray:100,"class":"animated fireline"});this.select();for(f in squadron)if(squadron[f]==this)break;this.preattackroll(b,e);this.doselection(function(g){var h=this.getattackstrength(b,e),l=e.getdefensestrength(b,
this);this.doattackroll(this.attackroll(h),h,l,f,g)}.bind(this),"in combat")},preattackroll:function(b,e){},doattack:function(b,e){this.activeweapons=b;this.activeenemies=e;this.showattack(b,e)},doattackroll:function(b,e,f,g,h){b=this.weapons[this.activeweapon].modifydamagegiven(b);displayattackroll(b,e);this.ar=b;this.ad=e;displayattacktokens(this,function(){targetunit.defenseroll(f).done(function(b){targetunit.dodefenseroll(b.roll,b.dice,g,h)})})},dodefenseroll:function(b,e,f,g){this.dr=b;this.dd=
e;displaydefenseroll(b,e);displaydefensetokens(this,function(){this.resolvedamage();this.endnoaction(g,"in combat")}.bind(squadron[f]))},drawpathmove:function(b,e,f){if(!FAST){if(this.islarge){var g=b.clone();s.path("M 0 0 l 0 -20").transform(g).appendTo(VIEWPORT).attr({stroke:this.color,display:TRACE?"block":"none",strokeWidth:"20px",opacity:.2,fill:"rgba(0,0,0,0)"}).addClass("trace");e=s.path(e.getSubpath(0,f-40)).attr("display","none");e.clone().transform(g.translate(0,-20)).appendTo(VIEWPORT).attr({stroke:this.color,
display:TRACE?"block":"none",strokeWidth:"20px",opacity:.2,fill:"rgba(0,0,0,0)"}).addClass("trace");s.path("M 0 0 l 0 -20").transform(this.getmatrixwithmove(b,e,f-20)).appendTo(VIEWPORT).attr({stroke:this.color,display:TRACE?"block":"none",strokeWidth:"20px",opacity:.2,fill:"rgba(0,0,0,0)"}).addClass("trace")}else s.path(e.getSubpath(0,f)).transform(b).attr({stroke:this.color,display:TRACE?"block":"none",strokeWidth:"20px",opacity:.2,fill:"rgba(0,0,0,0)"}).addClass("trace").appendTo(VIEWPORT);this.show()}},
getmatrixwithmove:function(b,e,f){var g=e.getTotalLength();b=b.clone();this.islarge?20>=f?b.translate(0,-f):(g=f>g+20?f-g-20:0,e=e.getPointAtLength(f-g-20),b.translate(e.x,-20+e.y).rotate(e.alpha-90,0,0).translate(0,-g)):(e=e.getPointAtLength(f),b.translate(e.x,e.y).rotate(e.alpha-90,0,0));return b},removestresstoken:function(){0<this.stress&&(this.stress--,this.animateremovetoken("xstresstoken"));this.movelog("st");this.show()},handledifficulty:function(b){"RED"==b?this.addstress():"GREEN"==b&&0<
this.stress&&this.removestresstoken()},premove:function(){},reavelmaneuver:function(b){},completemaneuver:function(b,e,f,g){var h=P[b].path,l,m;this.maneuverdifficulty=e;if("F0"==b)this.hasmoved=!0,this.handledifficulty(e),this.lastmaneuver=this.maneuver,this.endmaneuver(),this.touching=[];else{var q=h.getTotalLength();this.collision=!1;this.showhitsector(!1);this.islarge&&(q+=40);m=this.m;l=this.getmatrixwithmove(this.m,h,q);var t=this.getcollidingunits(l),v=[];if(0<t.length)for(this.log("collides with %0: no action",
t[0].name),this.collision=!0;0<q&&0<t.length;)v=t,--q,l=this.getmatrixwithmove(this.m,h,q),t=this.getcollidingunits(l);this.drawpathmove(this.m,h,q);for(i=0;i<this.touching.length;i++)t=this.touching[i],t.touching.splice(t.touching.indexOf(this),1);this.touching=v;this.ocollision=this.getocollisions(m,l,h,q);this.isfireobstructed()&&this.log("overlaps obstacle: cannot attack");this.hascollidedobstacle()&&this.log("unit or template overlaps obstacle: no action");0<q&&(this.m=l);var w=0;0<q?(this.hasmoved=
!0,$("#activationdial").empty(),FAST||SOUNDS[this.ship.flysnd].play(),Snap.animate(0,q,function(b){l=this.getmatrixwithmove(m,h,b);this.g.transform(l);this.geffect.transform(l)}.bind(this),TIMEANIM*q/200,mina.linear,function(){this.collision||(b.match(/K\d|SR\d|SL\d/)||1==f?(this.m.rotate(180,0,0),w=180):b.match(/TRL\d/)?(this.m.rotate(-90,0,0),w=-90):b.match(/TRR\d/)&&("undefined"!=typeof g?this.m=g:this.m.rotate(90,0,0),w=90));this.movelog("m-"+b+"-"+(360+w)%360+"-"+Math.floor(q));this.handledifficulty(e);
this.lastmaneuver=this.maneuver;this.hascollidedobstacle()&&this.resolveocollision(this.ocollision.overlap,this.ocollision.template);if(0<this.ocollision.mine.length)for(i=0;i<this.ocollision.mine.length;i++)this.ocollision.mine[i].detonate(this,!1);this.collision&&this.resolvecollision();this.endmaneuver()}.bind(this))):(this.hasmoved=!0,this.log("cannot move"),this.handledifficulty(e),this.lastmaneuver=this.maneuver,this.collision&&this.resolvecollision(),this.endmaneuver())}},getmaneuverlist:function(){var b=
this.getmaneuver(),e={};e[b.move]=b;return"undefined"!=typeof b?e:{}},resolvemaneuver:function(){$("#activationdial").empty();if(!(0>this.maneuver)){var b=[],e=[],f=this.getmaneuverlist(),g;for(g in f)if(e.push(f[g]),f[g].move.match(/TRR\d|TRL\d/))for(var h=this.gettallonrollmatrix(this.m,f[g].move),l=0;l<h.length;l++)b.push(h[l]),0<l&&e.push(f[g]);else 1!=f[g].halfturn||f[g].move.match(/K\d|SR\d|SL\d/)?b.push(this.getpathmatrix(this.m,f[g].move)):b.push(this.getpathmatrix(this.m,f[g].move).rotate(180,
0,0));this.resolveactionmove(b,function(f,g){-1==g&&(g=0);var h=e[g].move,l=e[g].difficulty;1!=e[g].halfturn&&(e[g].halfturn=!1);this.completemaneuver(h,l,e[g].halfturn,b[g])}.bind(this),!1,!0)}},endmaneuver:function(){var b=this.ionized;if(this.hasionizationeffect())for(var e=0;e<b;e++)this.removeiontoken();this.maneuver=-1;this.hasmoved=!0;this.show();this.checkdead()?this.shield=this.hull=0:this.doendmaneuveraction();this.cleanupmaneuver()},cleanupmaneuver:function(){this.actionbarrier()},unlock:function(b){this.show();
return this.deferred.resolve(b)},newlock:function(){this.deferred=$.Deferred();return this.deferred.promise()},enddecloak:function(){return this.newlock()},candomaneuver:function(){return-1<this.maneuver},addafterattackeffect:function(b,e){this.wrap_after("afterattackeffect",b,e)},addafterdefenseeffect:function(b,e){this.wrap_after("afterdefenseeffect",b,e)},isattacktwice:function(){return!1},addattack:function(b,e,f,g,h,l,m,q){var t=this;"undefined"==typeof l&&(l="endattack");"undefined"==typeof q&&
(q=!1);(q?Unit.prototype:this).wrap_after(l,e,function(m,q,x){var v=!1;"removeshield"==l||"warndeath"==l||"endmaneuver"==l?x=activeunit:"undefined"==typeof x&&(x=this);for(i in f)if(f[i].isactive){v=!0;break}if(b.call(t,m,q,x)&&t.noattack<round&&v&&!t.iscloaked&&!t.isfireobstructed()){var w=x.deferred,v=function(){var l,t=[];this.deferred=w;l="function"==typeof h?h.call(this):this.selectnearbyenemy(3);for(var v in f)f[v].isactive&&0<f[v].getenemiesinrange(l).length&&t.push(f[v]);0==t.length?(this.log("no available target for %0",
e.name),this.cleanupattack()):b.call(this,m,q,x)?(this.log("+1 attack [%0]",e.name),"function"==typeof g&&this.wrap_before("resolveattack",this,function(){g.call(this)}.bind(this)).unwrapper("cleanupattack"),this.maxfired++,this.doattack(t,l)):this.cleanupattack()}.bind(t);"endcombatphase"!=l&&"warndeath"!=l&&phase==COMBAT_PHASE?e.newlock().done(v):v()}}).unwrapper(m)},candoendmaneuveraction:function(){return this.candoaction()&&!this.collision&&!this.hascollidedobstacle()},doendmaneuveraction:function(){return this.doaction(this.getactionlist(!0),
"",this.candoendmaneuveraction)},doselection:function(b,e){return this.enqueueaction(b,e)},isactiondone:function(b){return-1!=this.actionsdone.indexOf(b)},doaction:function(b,e,f){"undefined"==typeof f&&(f=this.candoaction);return 0==b.length?(this.log("no action available"),this.enqueueaction(function(b){this.endnoaction(b)}.bind(this),this.name)):this.enqueueaction(function(g){var h;$("#actiondial").empty();if(f.call(this)){this.select();"undefined"!=typeof e&&""!=e&&this.log(e);$("#actiondial").html($("<div>"));
for(h=0;h<b.length;h++)this.isactiondone(b[h].name)||function(e,f){var l=$("<div>").addClass("symbols").text(A[e.type].key).click(function(){this.resolveaction(e,g)}.bind(this));"BOMB"==e.type&&l.addClass("bombs");l.attr("title",b[h].name);"/2"==b[h].name.slice(-2)&&l.css("color","yellow");$("#actiondial > div").append(l)}.call(this,b[h],h);var l=$("<button>").addClass("m-skip").addClass("wbutton").click(function(){this.resolveaction(null,g)}.bind(this));$("#actiondial > div").append(l)}else this.endaction(g,
null)}.bind(this),b[0].name)},donoaction:function(b,e,f,g){return 0==b.length?(this.log("no action available"),this.enqueueaction(function(b){this.endnoaction(b)}.bind(this),this.name)):this.enqueueaction(function(h){var l;"undefined"!=typeof e&&""!=e&&this.log(e);this.select();$("#actiondial").html($("<div>"));for(l=0;l<b.length;l++)(function(b,e){var f=$("<div title='"+b.name+"'>").addClass("symbols").text(A[b.type].key).click(function(){this.resolvenoaction(b,h)}.bind(this));$("#actiondial > div").append(f)}).call(this,
b[l],l);1==f&&(l=$("<button>").addClass("m-skip").addClass("wbutton").click(function(){"function"==typeof g&&g();this.resolvenoaction(null,h)}.bind(this)),$("#actiondial > div").append(l))}.bind(this),b[0].name)},hasnostresseffect:function(){return 0==this.stress},candoaction:function(){return this.hasnostresseffect()},candecloak:function(){return this.iscloaked&&phase==ACTIVATION_PHASE&&!this.hasdecloaked},selecttargetforattack:function(b,e){var f;ENGAGED=!0;f=this.weapons[b].getenemiesinrange(e);
if(0==f.length)return this.log("no target for %0",this.weapons[b].name),this.cleanupattack(),!1;$("#attackdial").empty();this.selectunit(f,function(e,f){e[f]!=this&&this.declareattack(b,e[f])?this.resolveattack(b,e[f]):this.cleanupattack()},[""],!1);return!0},showattack:function(b,e){var f=[],g,h;$("#attackdial").show();"undefined"==typeof b&&(b=this.weapons);var l=this.getenemiesinrange(b,e),m=$("<div>");for(g=h=0;h<b.length;h++)0<l[h].length&&(f[g++]=this.weapons.indexOf(b[h]));var q=this;for(g=
0;g<f.length;g++)(function(b){var f=A[q.weapons[b].type.toUpperCase()];m.append($("<div>").attr({"class":"symbols "+b.color}).html(f.key).click(function(){q.selecttargetforattack(b,e)}))})(f[g]);m.append($("<button>").attr({"class":"m-skip wbutton"}).click(function(){this.cancelattack()}.bind(this)));$("#attackdial").html(m)},cancelattack:function(){this.maxfired--;this.show();this.cleanupattack()},candotarget:function(){return 0<this.gettargetableunits(3).length},candofocus:function(){return!0},
candoevade:function(){return!0},candropbomb:function(){return this.lastdrop!=round&&this.getskill()==skillturn},addactivationdial:function(b,e,f,g){this.activationdial.push({pred:b,action:e,html:f,elt:g})},actionbarrier:function(){actionrlock=$.Deferred();this.areactionspending()?actionrlock.done(function(){this.unlock()}.bind(this)):(actionrlock.resolve(),this.unlock())},addafteractions:function(b){actionrlock.done(b)},areactionspending:function(){for(var b=0;b<actionr.length;b++)if("pending"==actionr[b].state())return!0;
...
this.addactivationdial(function(){return b.lastdrop!=round&&b.bombs[2].canbedropped()},function(){b.lastdrop=round;$(".bombs").remove();b.bombs[2].actiondrop()},A.BOMB.key,$("<div>").attr({"class":"symbols bombs",title:b.bombs[2].name}));case 2:this.bombs[1].canbedropped()&&this.addactivationdial(function(){return b.lastdrop!=round&&b.bombs[1].canbedropped()},function(){b.lastdrop=round;$(".bombs").remove();b.bombs[1].actiondrop()},A.BOMB.key,$("<div>").attr({"class":"symbols bombs",title:b.bombs[1].name}));
case 1:this.bombs[0].canbedropped()&&this.addactivationdial(function(){return b.lastdrop!=round&&b.bombs[0].canbedropped()},function(){b.lastdrop=round;$(".bombs").remove();b.bombs[0].actiondrop()},A.BOMB.key,$("<div>").attr({"class":"symbols bombs",title:b.bombs[0].name}))}return this.activationdial},doactivation:function(){this.showactivation()},showactivation:function(){$("#activationdial").html("<div></div>");if(this.timeformaneuver()&&!this.areactionspending()){for(var b=this.updateactivationdial(),
e=0;e<b.length;e++)(function(e){var f=b[e];f.pred()&&f.elt.appendTo("#activationdial > div").click(function(){$("#activationdial").html("<div></div>");f.action()}).html(f.html)})(e);$("<button>").addClass("m-move").addClass("wbutton").click(function(){this.resolvemaneuver()}.bind(this)).appendTo("#activationdial > div")}},forceshowactivation:function(){$("#activationdial").html("<div></div>");for(var b=this.activationdial,e=0;e<b.length;e++)(function(e){var f=b[e];f.pred()&&f.elt.appendTo("#activationdial > div").click(function(){$("#activationdial").html("<div></div>");
f.action()}).html(f.html)})(e);$("#activationdial").show()},movelog:function(b){b.match(/L-%%.*/)&&this.setinfo(decodeURIComponent(b.substring(4,b.length-2))).delay(1500).fadeOut(400);ANIM+="_"+this.id+"-"+b},computepoints:function(){},error:function(b){b=formatstring(b);log("<div><span style='color:red;font-weight:bold;'>**ERROR** ["+this.name+"]</span> "+b+"</div>")},log:function(b,e,f,g){NOLOG||("undefined"!=typeof UI_translation[b]&&(b=UI_translation[b]),"string"==typeof e&&(e=translate(e)),b=
b.replace(/%0/g,e),"string"==typeof f&&(f=translate(f)),b=b.replace(/%1/g,f),"string"==typeof g&&(g=translate(g)),b=b.replace(/%2/g,g),b=formatstring(b),log("<div><span style='color:"+this.color+"'>["+this.name+"]</span> "+b+"</div>"))},candocloak:function(){return!this.iscloaked},clearaction:function(){this.action=-1},showaction:function(){if(this.action<this.actionList.length&&-1<this.action){var b=A[this.actionList[this.action].type].color;this.actionicon.attr({fill:this==activeunit?b:halftone(b)})}else this.actionicon.attr({text:""})},
showinfo:function(){var b=0,e=$("#"+this.id+" .usabletokens").html(),f=this.getusabletokens();$("#"+this.id+" .usabletokens").html(f);if(e!=f)for(var g in squadron)e=squadron[g],this.isally(e)&&this.getskill()>=e.getskill()&&e.showoverflow();0<this.focus&&this.infoicon[b++].attr({text:A.FOCUS.key,fill:A.FOCUS.color});0<this.evade&&this.infoicon[b++].attr({text:A.EVADE.key,fill:A.EVADE.color});1==this.iscloaked&&this.infoicon[b++].attr({text:A.CLOAK.key,fill:A.CLOAK.color});0<this.targeting.length&&
6>b&&this.infoicon[b++].attr({text:A.TARGET.key,fill:A.TARGET.color});0<this.istargeted.length&&this.infoicon[b++].attr({text:A.ISTARGETED.key,fill:A.ISTARGETED.color});0<this.stress&&6>b&&this.infoicon[b++].attr({text:A.STRESS.key,fill:A.STRESS.color});0<this.ionized&&6>b&&this.infoicon[b++].attr({text:"Z",fill:A.STRESS.color});0<this.tractorbeam&&6>b&&this.infoicon[b++].attr({text:"Y",fill:A.STRESS.color});for(g=b;6>g;g++)this.infoicon[b++].attr({text:""})},showoutline:function(){this.border.attr({stroke:activeunit==
this?this.color:halftone(this.color)})},dock:function(b){this.isdocked=!0;$("#"+this.id).attr("onclick","");$("#"+this.id).addClass("docked");$("#"+this.id).html(""+this);this.g.attr({display:"none"});this.geffect.attr({display:"none"});this.log("docked on %0",b.name);this.show();b.docked=this},deploy:function(b,e){this.movelog("DPY");$("#"+this.id).removeClass("docked");$("#"+this.id).html(""+this);$("#"+this.id+" .outoverflow").each(function(b){"auto"!=$(this).css("top")&&$(this).css("top",$(this).parent().offset().top+
"px")});$("#"+this.id).click(function(){this.select()}.bind(this));this.g.attr({display:"block"});this.geffect.attr({display:"block"});this.m=b.m.clone();this.isdocked=!1;this.log("deploying from %0",b.name);this.show();b.docked=null;this.log("select maneuver for deployment");b.doselection(function(f){this.resolveactionmove(e,function(b,e){var f=this.getdial().length;e>=f?(this.m.translate(0,-20),e-=f):this.m.translate(0,20).rotate(180,0,0);this.maneuver=e;this.resolvemaneuver()}.bind(this),!1,!0);
b.endnoaction(f,"DEPLOY")}.bind(this))},endcombatphase:function(){$(".fireline").remove()},endphase:function(){},beginsetupphase:function(){return this.newlock()},endsetupphase:function(){},beginplanningphase:function(){this.actionsdone=[];return this.newlock()},beginactivationphase:function(){return this.newlock()},timetoshowmaneuver:function(){return-1<this.maneuver&&phase<=ACTIVATION_PHASE},getmaneuver:function(){return this.hasionizationeffect()?{move:"F1",difficulty:"WHITE"}:this.getdial()[this.maneuver]},
showmaneuver:function(){if(this.timetoshowmaneuver()){var b=this.getmaneuver(),e=C["undefined"!=typeof this.forceddifficulty?this.forceddifficulty:b.difficulty];activeunit!=this&&(e=halftone(e));this.dialspeed.attr({text:P[b.move].speed,fill:e});this.dialdirection.attr({text:P[b.move].key,fill:e})}},clearmaneuver:function(){this.dialspeed.attr({text:""});this.dialdirection.attr({text:""})},beginactivation:function(){this.showmaneuver();this.show()},endactivationphase:function(){},hasionizationeffect:function(){return 0<
this.ionized&&!this.islarge||1<this.ionized},begincombatphase:function(){return this.newlock()},beginattack:function(){},toString:function(){var b,e;this.shipname=SHIP_translation[this.ship.name];"undefined"==typeof SHIP_translation[this.ship.name]&&(this.shipname=this.ship.name);this.translatedname=translate(this.name);if(phase==SELECT_PHASE)return e=PILOTS[this.pilotid].dict,1==PILOTS[this.pilotid].ambiguous&&"undefined"!=typeof PILOTS[this.pilotid].edition&&(e+="-"+PILOTS[this.pilotid].edition.toLowerCase().replace(" ",
"")),this.imgname=e,this.isunique=1==PILOTS[this.pilotid].unique?!1:!0,this.fire=this.weapons[0].getattack(),this.diallist=dial2JSON(this.getdial()),Mustache.render(TEMPLATES["unit-creation"],this);b=formatstring(getpilottexttranslation(this,this.faction));this.id=squadron.indexOf(this);this.tooltip=""!=b?[b]:[];b=8+2*this.upgrades.length;this.shieldpts3=this.hullpts3=this.shieldpts2=this.hullpts2="";this.hull+this.shield<=b?(this.hullpts=repeat("u ",this.hull),this.shieldpts=repeat("u ",this.shield)):
this.hull>b?(this.hullpts=repeat("u ",this.hull),this.shieldpts="",this.hull<=2*b?(this.hullpts2=repeat("u ",this.hull-b),this.shield+this.hull<=2*b?this.shieldpts2=repeat("u ",this.shield):(this.shieldpts2=repeat("u ",2*b-this.hull),this.shieldpts3=repeat("u ",this.shield-2*b))):(this.hullpts2=repeat("u ",b),this.hullpts3=repeat("u ",this.hull-2*b),this.shieldpts3=repeat("u ",this.shield))):(this.hullpts=repeat("u ",this.hull),this.shieldpts=repeat("u ",b-this.hull),this.shieldpts2=repeat("u ",this.shield-
b+this.hull));this.isinleft=1==this.team;this.conds=[];for(e in this.conditions)this.conds.push(this.conditions[e]);this.primaryweaponattack=this.weapons[0].getattack();this.primaryweaponkey=A[this.weapons[0].type.toUpperCase()].key;this.actualupgs=[];for(e=0;e<this.upgrades.length;e++)"UPGRADE"==this.upgrades[e].typecast()&&this.actualupgs.push(this.upgrades[e]);return Mustache.render(TEMPLATES["unit-combat"],this)},canusefocus:function(){return 0<this.focus},canuseevade:function(){return 0<this.evade},
canusetarget:function(b){return 0<this.targeting.length&&("undefined"==typeof b||-1<this.targeting.indexOf(b))},getusabletokens:function(){this.focuses=1<this.focus?[this.focus]:[];this.evades=1<this.evade?[this.evade]:[];this.stresses=1<this.stress?[this.stress]:[];this.ionizedes=1<this.ionized?[this.ionized]:[];this.tractorbeames=1<this.tractorbeam?[this.tractorbeam]:[];this.targetedname=[];this.targetingname=[];for(var b=0;b<this.istargeted.length;b++)this.targetedname[b]=this.istargeted[b].name.replace(/\'/g,
"&#39;");for(b=0;b<this.targeting.length;b++)this.targetingname[b]=this.targeting[b].name.replace(/\'/g,"&#39;");return Mustache.render(TEMPLATES.usabletokens,this)},showskill:function(){var b=this.getskill();$("#unit"+this.id+" .statskill").html(b);$("#"+this.id+" .statskill").html(b)},showstats:function(){$("#unit"+this.id+" .statevade .val").html(this.getagility());if(phase==SELECT_PHASE||phase==CREATION_PHASE)$("#unit"+this.id+" .stathull .val").html(this.ship.hull),$("#unit"+this.id+" .statshield .val").html(this.ship.shield);
else{this.skillbar.attr({text:repeat("u",this.getskill())});this.firebar.attr({text:repeat("u",this.weapons[0].getattack())});this.evadebar.attr({text:repeat("u",this.getagility())});this.hullbar.attr({text:repeat("u",this.hull)});this.shieldbar.attr({text:repeat("u",this.shield+this.hull)});var b=8+2*this.upgrades.length;this.hull+this.shield<=b?($("#"+this.id+" .stat .hull").html(repeat("u ",this.hull)),$("#"+this.id+" .stat .shield").html(repeat("u ",this.shield))):this.hull>b?($("#"+this.id+" .stat .hull").html(repeat("u ",
b)),this.hull<=2*b?($("#"+this.id+" .stat2 .hull").html(repeat("u ",this.hull-b)),this.shield+this.hull<=2*b?$("#"+this.id+" .stat2 .shield").html(repeat("u ",this.shield)):($("#"+this.id+" .stat2 .shield").html(repeat("u ",2*b-this.hull)),$("#"+this.id+" .stat3 .shield").html(repeat("u ",this.shield-2*b+this.hull)))):($("#"+this.id+" .stat2 .hull").html(repeat("u ",b)),$("#"+this.id+" .stat3 .hull").html(repeat("u ",this.hull-2*b)),$("#"+this.id+" .stat3 .shield").html(repeat("u ",this.shield)))):
($("#"+this.id+" .stat .hull").html(repeat("u ",this.hull)),$("#"+this.id+" .stat .shield").html(repeat("u ",b-this.hull)),$("#"+this.id+" .stat2 .shield").html(repeat("u ",this.shield-b+this.hull)))}},showpanel:function(){var b=VIEWPORT.m.clone(),e=this.g.getBBox(),f=$("#svgout").width(),g=$("#svgout").height(),h=0,l=0;g>f?l=(g-f)/2:h=(f-g)/2;f=Math.min(f/900,g/900);h+=(b.x(e.x,e.y)+e.width/2)*f;e=l+b.y(e.x,e.y)*f;b=b.split().scalex;$(".phasepanel").css({left:h+b*(this.islarge?40:20),top:e}).show()},
timeformaneuver:function(){return this==activeunit&&-1<this.maneuver&&!this.hasmoved&&this.getskill()==skillturn&&phase==ACTIVATION_PHASE&&subphase==ACTIVATION_PHASE},showoverflow:function(){this.dead||($("#"+this.id).html(""+this),$("#"+this.id+" .outoverflow").each(function(b){"auto"!=$(this).css("top")&&$(this).css("top",$(this).parent().offset().top+"px")}))},show:function(){phase==CREATION_PHASE?$("#unit"+this.id).html(this.toString2()):"undefined"!=typeof this.g&&(this.g.transform(this.m),this.g.appendTo(VIEWPORT),
this.geffect.transform(this.m),this.geffect.appendTo(VIEWPORT),this.showoutline(),this.flameno++,this.showstats(),this.showinfo(),activeunit==this&&(this.showpanel(),this.showdial(),this.showmaneuver(),phase==ACTIVATION_PHASE&&this.showactivation(),ENGAGED||phase!=COMBAT_PHASE||(!this.canfire()||this.areactionspending()||INREPLAY?$("#attackdial").empty():this.showattack(this.activeweapons,this.activeenemies)),this.showoverflow()))},updatetohit:function(b,e){var f=this.weapons[e],g=f.getenemiesinrange();
if(b)for(h in g)g[h].tohitstats[this.id]={unit:this,weapon:e};else for(var h in g)delete g[h].tohitstats[this.id];for(h in g){var l=g[h];NOLOG=!0;var m=1,q=0,t=0,v=l.focus,w=l.evade,x,y;for(y in l.tohitstats){var z=l.tohitstats[y],f=z.weapon;if("undefined"!=typeof z.unit){var D=z.unit.evaluatetohit(z.weapon,l),m=m*(1-D.tohit/100),q=q+D.meanhit,t=t+D.meancritical;0<l.focus&&l.focus--;0<l.evade&&l.evade--;for(x=[];"function"==typeof z.unit.weapons[f].followupattack&&-1==x.indexOf(f);)x.push(f),f=z.unit.weapons[f].followupattack(),
D=z.unit.evaluatetohit(f,l),m*=1-D.tohit/100,q+=D.meanhit,t+=D.meancritical,0<l.focus&&l.focus--,0<l.evade&&l.evade--}}l.tohitstats.tohit=m;l.tohitstats.meanhit=q;l.tohitstats.meancrit=t;l.evade=w;l.focus=v;NOLOG=!1}},displaytohit:function(b){b=this.weapons[b].getenemiesinrange();for(var e in b){var f=b[e],g=1-f.tohitstats.tohit,h=f.tohitstats.meanhit,l=f.tohitstats.meancrit;if(0==h)f.gproba.attr({display:"none"});else{var m=-f.m.split().rotate;f.gproba.transform("r "+m+" 0 0").attr({display:"block"});
f.tohit.attr({text:Math.floor(100*g)+"%"});f.meanhit.attr({text:Math.floor(100*h)/100});f.meancrit.attr({text:Math.floor(100*l)/100})}f.show()}},showhitsector:function(b,e){this.select();"undefined"==typeof e&&(e=0);var f=this.weapons[e];if(b){var g=f.getlowrange(),h=f.gethighrange();if(f.isTurret()||this.isTurret(f))this.showrange(b,g,h);else{var l;if(1==g){for(l=g;l<=h;l++)this.sectors.push(s.path(this.getPrimarySectorString(l,this.m)).attr({fill:this.color,stroke:this.color,opacity:.1,pointerEvents:"none"}).appendTo(VIEWPORT));
if("undefined"!=typeof f.auxiliary)for(f=f.auxiliary,l=g;l<=h;l++)this.sectors.push(s.path(f.call(this,l,this.m)).attr({fill:this.color,stroke:this.color,opacity:.1,pointerEvents:"none"}).appendTo(VIEWPORT))}else{for(l=g;l<=h;l++)this.sectors.push(s.path(this.getPrimarySubSectorString(g-1,l,this.m)).attr({fill:this.color,stroke:this.color,opacity:.1,pointerEvents:"none"}).appendTo(VIEWPORT));if("undefined"!=typeof f.subauxiliary)for(f=f.subauxiliary,l=g;l<=h;l++)this.sectors.push(s.path(f.call(this,
g-1,l,this.m.clone())).attr({fill:this.color,stroke:this.color,opacity:.1,pointerEvents:"none"}).appendTo(VIEWPORT))}}}else{for(l=0;l<this.sectors.length;l++)this.sectors[l].remove();for(l=0;l<this.ranges.length;l++)this.ranges[l].remove();this.ranges=[];this.sectors=[]}this.updatetohit(b,e);this.displaytohit(e)},showrange:function(b,e,f){this.select();if(b)if(1==e)for(b=e;b<=f;b++)this.ranges.push(s.path(this.getRangeString(b,this.m)).attr({fill:this.color,stroke:this.color,opacity:.1,pointerEvents:"none"}).appendTo(VIEWPORT));
else for(b=e;b<=f;b++)this.ranges.push(s.path(this.getSubRangeString(e-1,b,this.m)).attr({fill:this.color,stroke:this.color,opacity:.1,pointerEvents:"none"}).appendTo(VIEWPORT));else{for(b=0;b<this.ranges.length;b++)this.ranges[b].remove();this.ranges=[]}},togglehitsector:function(b){this.showhitsector(0<this.sectors.length+this.ranges.length?!1:!0,b)},togglerange:function(){this.showrange(0<this.ranges.length?!1:!0,1,3)},isPointInside:function(b,e){for(var f=0;f<e.length;f++)if(Snap.path.isPointInside(b,
e[f].x,e[f].y))return!0;return!1},isinsector:function(b,e,f,g,h,l){f=f.getOutlineString(f.m);b=1<e?g.call(this,e-1,e,b):h.call(this,e,b);return null!=b&&(0<Snap.path.intersection(f.s,b).length||this.isPointInside(b,f.p))},isinfiringarc:function(b){return 3>=this.getsector(b)},isinprimaryfiringarc:function(b){return 3>=this.getprimarysector(b)},getsector:function(b,e){return this.weapons[0].getsector(b)},getprimarysector:function(b,e){var f;"undefined"==typeof e&&(e=this.m);var g=this.getoutlinerange(e,
b).d;for(f=g;f<=g+1&&3>=f;f++)if(this.isinsector(e,f,b,this.getPrimarySubSectorString,this.getPrimarySectorString))return f;return 4},isinoutline:function(b,e,f){return this.isPointInside(b,e.getOutlinePoints(f))},checkcollision:function(b){return-1<this.touching.indexOf(b)},resolvecollision:function(){var b;"undefined"==typeof this.touching&&(this.touching=[]);for(b=0;b<this.touching.length;b++){var e=this.touching[b];-1==e.touching.indexOf(this)&&(e.touching.push(this),e.collidedby(this))}},collidedby:function(b){},
canhavehitocollision:function(){return!0},canhavecriticalocollision:function(){return!0},resolveocollision:function(b,e){var f;-1==e.indexOf(b)&&-1<b&&e.push(b);for(f=0;f<e.length;f++){var g=this.rollattackdie(1,OBSTACLES[e[f]],"blank")[0];switch(g){case "focus":this.log("roll for collision: <span class='focusreddice'></span>");break;case "hit":this.log("roll for collision: <span class='hitreddice'></span>");break;case "blank":this.log("roll for collision: <span class='blankreddice'></span>");break;
case "critical":this.log("roll for collision: <span class='criticalreddice'></span>")}OBSTACLES[e[f]].type==ROCK?"hit"==g&&this.canhavehitocollision()?(this.log("+1 %HIT% [collision]"),this.resolvehit(1),this.checkdead()):"critical"==g&&this.canhavecriticalocollision()&&(this.log("+1 %CRIT% [collision]"),this.resolvecritical(1),this.checkdead()):OBSTACLES[e[f]].type==DEBRIS&&(this.addstress(),"critical"==g&&(this.log("+1 %CRIT% [debris collision]"),this.resolvecritical(1),this.checkdead()))}},addshield:function(b){this.movelog("S-"+
b);this.shield<this.ship.shield&&this.animateaddtoken("cshield");this.shield+=b;return this.shield>this.ship.shield?(this.shield=this.ship.shield,!0):!1},addhull:function(b){this.movelog("H-"+b);this.hull<this.ship.hull&&this.animateaddtoken("chull");this.hull+=b;this.hull>this.ship.hull&&(this.hull=this.ship.hull)},animateremovetoken:function(b){if(!FAST){var e=VIEWPORT.m.clone(),f=$("#svgout").width(),g=$("#svgout").height(),h=0,l=0;g>f?l=(g-f)/2:h=(f-g)/2;var m=Math.max(900/f,900/g),q=this.g.getBBox(),
f=$("#svgout").offset();$("#playmat").width();$("#playmat").height();g=e.x(q.x,q.y)/m;g+=f.left+h;e=e.y(q.x,q.y)/m;e+=f.top+l;$("<div>").addClass("upanim").css({left:g,top:e}).html("<code class='"+b+"'></code>").appendTo("body").show()}},animateaddtoken:function(b){if(!FAST){var e=VIEWPORT.m.clone(),f=$("#svgout").width(),g=$("#svgout").height(),h=0,l=0;g>f?l=(g-f)/2:h=(f-g)/2;var m=Math.max(900/f,900/g),q=this.g.getBBox(),f=$("#svgout").offset();$("#playmat").width();$("#playmat").height();g=e.x(q.x,
q.y)/m;g+=f.left+h;e=e.y(q.x,q.y)/m;e+=f.top+l;$("<div>").addClass("downanim").css({left:g,top:e}).html("<code class='"+b+"'></code>").appendTo("body").show()}},removeshield:function(b){0<this.shield&&this.animateremovetoken("cshield");this.shield-=b;this.movelog("s-"+b);0>this.shield&&(this.shield=0);var e=TEAMS[this.team].history.rawdata;"undefined"==typeof e[round]&&(e[round]={hits:0,dead:""});e[round].hits+=b},resolvehit:function(b){var e=0;if(0==b)return 0;this.shield>b?this.removeshield(b):
...
b);this.hull<=this.ship.hull/2&&this.imgsmoke.attr({display:"block"});1==this.hull&&(this.imgsmoke.attr({display:"none"}),this.imgflame.attr({display:"block"}))},selectunit:function(b,e,f,g){g&&b.push(this);0<b.length&&this.doselection(function(h){"undefined"!=typeof f&&""!=f[0]&&this.log.apply(this,f);this.resolveactionselection(b,function(f){g&&this==b[f]||e.call(this,b,f);this.endnoaction(h,"SELECT")}.bind(this))}.bind(this),"selectunit")},selectcritical:function(b,e){var f=function(b,f){$("#actiondial").empty();
e(b);this.endnoaction(f,"CRITICAL")}.bind(this);this.doselection(function(e){var g;$("#actiondial").empty();for(g=0;g<b.length;g++)(function(g){var h=$("<button>").text(CRITICAL_DECK[b[g]].name).click(function(){f(b[g],e)}.bind(this));$("#actiondial").append(h)}).call(this,g);$("#actiondial").show()}.bind(this),"critical")},selectupgradetodesactivate:function(b,e){var f=function(b,f){$("#actiondial").empty();null!=b&&(b.desactivate(),b.unit.show(),e.desactivate(),this.log("desactivating %0 [%1]",
b.name,this.name));this.endnoaction(f,"CREW")}.bind(this);this.doselection(function(e){var g;$("#actiondial").empty();for(g=0;g<b.length;g++)(function(g){var h=$("<button>").text(b[g].name).click(function(){f(b[g],e)});$("#actiondial").append(h)}).call(this,g);g=$("<button>").addClass("m-skip").addClass("wbutton").click(function(){f(null,e)});$("#actiondial").append(g);$("#actiondial").show()}.bind(this),"upgrade")},selectdamage:function(){var b,e=0;for(b=0;b<CRITICAL_DECK.length;b++)-1<CRITICAL_DECK[b].version.indexOf(CURRENT_DECK)&&
(e+=CRITICAL_DECK[b].count);var f=this.rand(e);for(b=e=0;b<CRITICAL_DECK.length;b++)if(-1<CRITICAL_DECK[b].version.indexOf(CURRENT_DECK)&&(e+=CRITICAL_DECK[b].count,e>f))return b;return 0},applydamage:function(b){var e,f;for(f=0;f<b;f++){e=this.selectdamage();CRITICAL_DECK[e].count--;var g=new Critical(this,e);this.deal(g,FACEDOWN).then(function(b){switch(b.face){case FACEUP:b.crit.faceup(),this.movelog("c-"+e);case FACEDOWN:this.removehull(1);break;case DISCARD:this.criticals.slice(this.criticals.indexOf(g),
1)}this.show()}.bind(this))}},applycritical:function(b){var e,f;for(f=0;f<b;f++){e=this.selectdamage();CRITICAL_DECK[e].count--;var g=new Critical(this,e);this.deal(g,FACEUP).then(function(b){switch(b.face){case FACEUP:b.crit.faceup(),this.movelog("c-"+e);case FACEDOWN:this.removehull(1);break;case DISCARD:this.criticals.slice(this.criticals.indexOf(g),1)}this.show()}.bind(this))}},deal:function(b,e){return $.Deferred().resolve({crit:b,face:e}).promise()},gethitrange:function(b,e){return this.isally(e)?
0:this.weapons[b].getrange(e)},getenemiesinrange:function(b,e){var f,g=[];"undefined"==typeof b&&(b=this.weapons);for(f=0;f<b.length;f++)g[f]=b[f].getenemiesinrange(e);return g},getrange:function(b){return this.getoutlinerange(this.m,b).d},getdist:function(b,e){var f=this.getOutlinePoints(b),g=e.getOutlinePoints(e.m),h=-1,l,m;for(l=0;l<f.length;l++)for(m=0;m<g.length;m++){var q=dist(g[m],f[l]);if(q<h||-1==h)h=q}return h},getoutlinerange:function(b,e){var f=util.getOutlineRange(this,e,OBSTACLES);return{d:f.distance,
o:f.obstructed}},getrangeallunits:function(){var b=[[],[],[],[],[]],e;for(e in squadron){var f=squadron[e];f!=this&&(f=this.getrange(f),b[f].push({unit:e}))}return b},updatehtml:function(){$("#"+this.id).html(""+this)}};var IACOMPUTING=0;function IAUnit(){}
...
g.m=g.futurem))}this.evaluatemoves(!0,!0);e=function(b){var e=[],f,g=[GREEN,WHITE,YELLOW,RED];for(f=0;f<b.length;f++){var h=b[f];if(h.color!=BLACK){var l=this.getpathmatrix(this.m,b[f].move),x=24-8*g.indexOf(h.color);h.color==RED&&(x-=20);h.color==BLACK&&(x=-100);var y=this.m;this.m=l;x+=this.evaluateposition();"RED"==h.difficulty&&(x-=1.5);this.m=y;e.push({n:x,m:f})}}return e}.call(this,f);for(b in squadron)squadron[b].m=squadron[b].oldm;if(0<e.length)e.sort(function(b,e){return e.n-b.n}),e=e[0].m;
else{for(b=0;b<f.length&&"RED"==f[b].difficulty&&!f[b].move.match(/F\d/);b++);e=b}this.futurem=this.getpathmatrix(this.m,f[e].move);this.log("Maneuver set");return e},resolveactionselection:function(b,e){e(0)},selectcritical:function(b,e){for(var f=0;f<b.length;f++)if(0==CRITICAL_DECK[b[f]].lethal){e(b[f]);return}e(b[0])},resolveactionmove:function(b,e,f,g,h){var l,m=!1,q=-1E3;g=-1;var t=this.m;for(l=0;l<b.length;l++)if(this.getmovecolor(b[l],!0,!0)==GREEN){var v,m=!0;"array"==typeof h?v=h[l]:(this.m=
b[l],v=this.evaluateposition());q<v&&(q=v,g=l)}this.m=t;if(m&&-1<g){f&&(f=b[g].split(),h=this.m.split(),s.path("M "+h.dx+" "+h.dy+" L "+f.dx+" "+f.dy).appendTo(VIEWPORT).attr({stroke:this.color,display:TRACE?"block":"none",strokeWidth:"20px",strokeLinecap:"round",strokeDasharray:"1, 30",opacity:.2,fill:"rgba(0,0,0,0)"}).addClass("trace"),this.show(),this.m=b[g],f=this.m.split(),this.movelog("am-"+Math.floor(300+f.dx)+"-"+Math.floor(300+f.dy)+"-"+Math.floor((360+Math.floor(f.rotate))%360)));b=this.getmcollisions(this.m);
if(0<b.length)for(l=0;l<b.length;l++)"function"==typeof OBSTACLES[b[l]].detonate?OBSTACLES[b[l]].detonate(this):(this.log("colliding with obstacle"),this.resolveocollision(1,[]));e(this,g)}else this.m=t,e(this,-1)},doplan:function(){$("#move").css({display:"none"});$("#maneuverdial").empty();if(phase==PLANNING_PHASE&&-1==this.maneuver){IACOMPUTING++;1==IACOMPUTING&&$("#npimg").html("<img style='width:10px' src='png/waiting.gif'/>");var b;b=setInterval(function(){var e=this.computemaneuver();IACOMPUTING--;
...
this.resolveaction(m,g)}else this.endaction(g)}.bind(this),"doaction ia")},showattack:function(){},doattack:function(b,e){var f=0,g=null,h,l,m;"undefined"==typeof b&&(b=this.weapons);var q=this.getenemiesinrange(b,e);for(l=0;l<b.length;l++){var t=q[l];m=this.weapons.indexOf(b[l]);for(h=0;h<t.length;h++){var v=this.evaluatetohit(m,t[h]).tohit;v>f&&!t[h].isdocked&&(g=t[h],f=v,this.activeweapon=m)}}if(null!=g)return this.selecttargetforattack(this.activeweapon,[g]);this.addhasfired();this.cleanupattack();
return!1},getresultmodifiers:function(b,e,f,g){var h=this.getdicemodifiers();NOLOG=!1;for(var l=0;l<h.length;l++){var m=h[l];m.from==f&&m.to==g&&(m.type==MOD_M&&m.req(b,e)&&("function"==typeof m.aiactivate&&1!=m.aiactivate(b,e)||modroll(m.f,l,g)),m.type==ADD_M&&m.req(b,e)&&("function"==typeof m.aiactivate&&1!=m.aiactivate(b,e)||addroll(m.f,l,g)),m.type!=REROLL_M||!m.req(activeunit,activeunit.weapons[activeunit.activeweapon],targetunit)||"function"==typeof m.aiactivate&&1!=m.aiactivate(b,e)||("function"==
typeof m.f&&m.f(),reroll(e,f,g,m,l)))}return[]}};var sabine_fct=function(){var b=[];!this.hasionizationeffect()&&this.candoaction()&&(this.candoboost()&&b.push(this.newaction(this.resolveboost,"BOOST")),this.candoroll()&&b.push(this.newaction(this.resolveroll,"ROLL")),this.doaction(b,"free %BOOST% or %ROLL% action"))},zeb_fct=function(b,e){this.log("cancel %CRIT% first");b=this.cancelcritical(b,e);return b=Unit.prototype.cancelhit(b,e)},maarek_fct=function(){var b=this;Unit.prototype.wrap_after("deal",this,function(e,f,g){var h=$.Deferred();g.then(function(e){if(e.face==
...
""))},["select unit, self to cancel [%0]",b.name],!1)}})}},{name:"Captain Rex",faction:REBEL,pilotid:223,unique:!0,done:!0,unit:"TIE Fighter",skill:4,upgrades:[],points:14,init:function(){this.wrap_after("endattack",this,function(b,e,f){new Condition(f,this,"Suppressive Fire")})}},{name:"Heff Tobber",faction:REBEL,pilotid:224,unique:!0,unit:"U-wing",skill:3,upgrades:[SYSTEM,TORPEDO,CREW,CREW],points:24,done:!0,init:function(){this.wrap_after("collidedby",this,function(b){this.doaction(this.getactionlist(),
"")})}},{name:"Bodhi Rook",faction:REBEL,unique:!0,pilotid:225,unit:"U-wing",skill:4,done:!0,upgrades:[SYSTEM,TORPEDO,CREW,CREW],points:25,init:function(){var b=this;Unit.prototype.wrap_after("gettargetableunits",this,function(e,f){if(b.isally(this)){var g=[],h;for(h in squadron){var l=squadron[h];l.isally(b)&&(g=g.concat(Unit.prototype.gettargetableunits.vanilla.call(l,3)))}return g}return f})}},{name:"'Duchess'",faction:EMPIRE,unique:!0,done:!0,pilotid:226,unit:"TIE Striker",skill:8,upgrades:[ELITE],
points:23,init:function(){this.facultativeailerons=!0}},{name:"'Countdown'",faction:EMPIRE,unique:!0,pilotid:227,unit:"TIE Striker",skill:5,upgrades:[],done:!0,points:20,init:function(){this.adddicemodifier(ATTACKCOMPARE_M,ADD_M,DEFENSE_M,this,{req:function(b,e){return 0==this.stress&&0<e}.bind(this),f:function(b,e){return 0==this.stress?(this.log("cancel all dice results"),this.applydamage(1),this.endattack(),this.addstress(),{m:0,n:0}):{m:b,n:e}}.bind(this),str:"hit"})}},{name:"'Pure Sabacc'",faction:EMPIRE,
unique:!0,pilotid:228,unit:"TIE Striker",skill:6,upgrades:[ELITE],points:22,done:!0,init:function(){this.wrap_after("getattackstrength",this,function(b,e,f){1>=this.criticals.length&&(f+=1);return f})}},{name:"Cassian Andor",faction:REBEL,pilotid:229,unit:"U-wing",skill:6,unique:!0,done:!0,upgrades:[ELITE,SYSTEM,TORPEDO,CREW,CREW],points:27,init:function(){var b=this;this.wrap_after("beginactivationphase",this,function(e){var f=this.selectnearbyally(2,function(b,e){return 0<e.stress?!0:!1});0<f.length&&
this.doselection(function(e){this.log("select unit for -1 stress");this.resolveactionselection(f,function(g){f[g].removestresstoken();b.endnoaction(e)})}.bind(this));return e})}},{name:"Kylo Ren",faction:EMPIRE,pilotid:230,unique:!0,unit:"Upsilon-Class Shuttle",skill:6,done:!0,upgrades:[ELITE,SYSTEM,CREW,CREW,TECH,TECH],points:34,init:function(){this.firstroundhit=-1;this.wrap_after("resolveishit",this,function(b){this.firstroundhit<round&&(this.firstroundhit=round,c=new Condition(b,this,"I'll Show You The Dark Side"))})}},
{name:"Major Stridan",faction:EMPIRE,pilotid:231,unique:!0,done:!0,unit:"Upsilon-Class Shuttle",skill:4,upgrades:[SYSTEM,CREW,CREW,TECH,TECH],points:32,init:function(){this.wrap_after("selectnearbyally",this,function(b,e,f){"undefined"==typeof f&&(f=e,e=void 0);return 1<b?f:Unit.prototype.selectnearbyally.call(this,3,e)})}},{name:"Lieutenant Dormitz",faction:EMPIRE,pilotid:232,unique:!0,done:!0,unit:"Upsilon-Class Shuttle",skill:3,upgrades:[SYSTEM,CREW,CREW,TECH,TECH],points:31},{name:"'Zeb' Orrelios",
faction:REBEL,pilotid:233,unique:!0,done:!0,ambiguous:!0,edition:"TIE Fighter",unit:"TIE Fighter",skill:3,wave:["10"],upgrades:[],points:13,cancelhit:zeb_fct},{name:"Lieutenant Kestal",faction:EMPIRE,pilotid:234,unique:!0,done:!0,unit:"TIE Aggressor",skill:7,upgrades:[ELITE,TURRET,MISSILE,MISSILE],points:22,init:function(){var b=this;this.adddicemodifier(ATTACK_M,CANCEL_M,DEFENSE_M,this,{req:function(){return b.canusefocus()},aiactivate:function(b,f){return 0<FE_blank(b,f)||0<FE_focus(b)},f:function(e,
f){if(0<FE_focus(e)||0<FE_blank(e,f))b.removefocustoken(),this.log("Cancel blank and focus defense results"),e-=FE_FOCUS*FE_focus(e),f-=FE_blank(e,f);return{m:e,n:f}},str:"focus"})}},{name:"'Double Edge'",faction:EMPIRE,pilotid:235,unique:!0,done:!0,unit:"TIE Aggressor",skill:4,upgrades:[ELITE,TURRET,MISSILE,MISSILE],points:19,candoubleattack:-1,doubleattackweapons:[],init:function(){var b=this;this.candoubleattack=-1;this.doubleattackweapons=this.weapons;var e=function(b,e){b.addattack(function(e,
f){var g=b.weapons[b.activeweapon];return 0==e+f&&!g.isprimary&&b.candoubleattack<round},b,e,function(){b.candoubleattack=round},null,"endattack","endcombatphase")};this.wrap_before("resolvedamage",this,function(){b.doubleattackweapons=[];for(var f=0;f<b.weapons.length;f++){var g=b.weapons[f];g.name!=b.weapons[b.activeweapon].name&&g.isWeapon()&&b.doubleattackweapons.push(g)}e(b,b.doubleattackweapons)})}},{name:"Onyx Squadron Escort",faction:EMPIRE,pilotid:236,unique:!1,done:!0,unit:"TIE Aggressor",
skill:5,upgrades:[TURRET,MISSILE,MISSILE],points:19},{name:"Sienar Specialist",faction:EMPIRE,pilotid:237,unique:!1,done:!0,unit:"TIE Aggressor",skill:2,upgrades:[TURRET,MISSILE,MISSILE],points:17}];var UPGRADE_TYPES={Elite:"ept",Torpedo:TORPEDO,Astromech:"amd",Turret:"turret",Missile:"missile",Crew:"crew",Cannon:"cannon",Bomb:"bomb",Title:"title",Mod:"mod",System:"system",Illicit:"illicit",Salvaged:"salvaged",Tech:"tech"};function AUXILIARY(b,e){return this.getPrimarySectorString(b,e.clone().rotate(this.arcrotation,0,0))}function SUBAUXILIARY(b,e,f){return this.getPrimarySubSectorString(b,e,f.clone().rotate(this.arcrotation,0,0))}
...
Bomb.prototype={isWeapon:function(){return!1},typecast:function(){return"BOMB"},isBomb:function(){return!0},canbedropped:function(){return this.isactive&&!this.unit.hasmoved&&this.unit.lastdrop!=round},desactivate:function(){this.isactive=!1;this.unit.movelog("D-"+this.unit.upgrades.indexOf(this))},getBall:function(){var b=this.g.getBBox();return{x:b.x+b.width/2,y:b.y+b.height/2,diam:Math.max(b.width/2,b.height/2)}},actiondrop:function(b){this.unit.lastdrop=round;$(".bombs").remove();this.drop(this.unit.getbomblocation(),
b)},toString:function(){this.tooltip=formatstring(getupgtxttranslation(this.name,this.type));this.trname=translate(this.name).replace(/\'/g,"&#39;");this.left=1==this.unit.team;return Mustache.render(TEMPLATES.bomb,this)},getrangeallunits:function(){var b=[[],[],[],[],[]],e;for(e in squadron){var f=this.getrange(squadron[e]);0<f&&b[f].push({unit:e})}return b},getcollisions:function(){var b=this.getOutlineString(),e=[];for(i in squadron){var f=squadron[i],g=f.getOutlineString(f.m);os=g.s;op=g.p;(0<
Snap.path.intersection(b.s,os).length||this.unit.isPointInside(b.s,op)||this.unit.isPointInside(os,b.p))&&e.push(f)}return e},getrange:function(b){var e=this.getOutlineString(this.m).p;b=b.getOutlinePoints(b.m);var f=90001,g,h;for(g=0;g<e.length;g++)for(h=0;4>h;h++){var l=dist(b[h],e[g]);l<f&&(f=l)}return 9E4<f?4:1E4>=f?1:4E4>=f?2:3},resolveactionmove:function(b,e){var f;this.pos=[];var g=function(e,g,m){for(f=0;f<b.length;f++)this.pos[f].remove();this.m=e;m(this,g)}.bind(this);if(1==b.length)this.pos[0]=
this.getOutline(b[0]).attr({fill:this.unit.color,opacity:.7}),g(b[0],0,e);else for(f=0;f<b.length;f++)this.pos[f]=this.getOutline(b[f]).attr({fill:this.unit.color,opacity:.7}),function(f){this.pos[f].hover(function(){this.pos[f].attr({stroke:this.unit.color,strokeWidth:"4px"})}.bind(this),function(){this.pos[f].attr({strokeWidth:"0"})}.bind(this));this.pos[f].click(function(){g(b[f],f,e)})}.call(this,f)},drop:function(b,e){var f=this;this.ordnance?(this.ordnance=!1,f=$.extend({},this)):this.desactivate();
f.resolveactionmove(this.unit.getbombposition(b,this.size),function(b){this.display(0,0);this.unit.bombdropped(this);"undefined"!=typeof e&&this.unit.endnoaction(e,"DROP")}.bind(f),!1,!0)},display:function(b,e){if(0!=b||0!=e)this.m=this.m.clone().translate(b,e);this.img1=s.image("png/"+this.img,-this.width/2,-this.height/2,this.width,this.height);this.outline=this.getOutline(new Snap.Matrix).attr({display:"block","class":"bombanim",stroke:halftone(BLUE),strokeWidth:2,fill:"rgba(8,8,8,0.3)"});this.g=
s.group(this.outline,this.img1);this.g.hover(function(){var b=VIEWPORT.m.clone(),e=$("#svgout").width(),f=$("#svgout").height(),m=0,q=0;f>e?q=(f-e)/2:m=(e-f)/2;var t=Math.max(900/e,900/f),v=this.g.getBBox(),e=$("#svgout").position();$("#playmat").width();$("#playmat").height();f=b.x(v.x,v.y-20)/t;f+=e.left+m;b=b.y(v.x,v.y-20)/t;b+=e.top+q;this.outline.attr({stroke:BLUE});$(".info").css({left:f,top:b}).html(this.name).appendTo("body").show()}.bind(this),function(){$(".info").hide();this.outline.attr({stroke:halftone(BLUE)})}.bind(this));
this.g.transform(this.m);this.g.appendTo(VIEWPORT);this.g.attr("display","block");BOMBS.push(this);if(this.stay){OBSTACLES.push(this);var f=this.getcollisions();0<f.length&&this.unit.resolveactionselection(f,function(b){this.detonate(f[b],!0)}.bind(this))}},getOutline:function(b){return s.path(this.getOutlineString(b).s).appendTo(VIEWPORT)},getOutlineString:function(b){"undefined"==typeof b&&(b=this.m);var e=transformPoint(b,{x:-16,y:-15}),f=transformPoint(b,{x:16,y:-15}),g=transformPoint(b,{x:16,
y:15});b=transformPoint(b,{x:-16,y:15});e=this.op=[e,f,g,b];return{s:"M "+e[0].x+" "+e[0].y+" L "+e[1].x+" "+e[1].y+" "+e[2].x+" "+e[2].y+" "+e[3].x+" "+e[3].y+" Z",p:e}},explode_base:function(){this.exploded=!0;this.unit.log("%0 explodes",this.name);SOUNDS[this.snd].play();this.g.remove();BOMBS.splice(BOMBS.indexOf(this),1)},explode:function(){this.explode_base()},detonate:function(b,e){OBSTACLES.splice(OBSTACLES.indexOf(this),1);this.explode_base()},endround:function(){},show:function(){},wrap_before:Unit.prototype.wrap_before,
...
!1;this.first=!0;this.last=!1;for(j=0;j<this.unit.upgrades.length;j++){var b=this.unit.upgrades[j];if(b==this){j==this.unit.upgrades.length-1&&(this.last=!0);break}"UPGRADE"==b.typecast()&&(this.first=!this.first)}return Mustache.render(TEMPLATES.upgrade,this)},typecast:function(){return"UPGRADE"},isWeapon:function(){return!1},isBomb:function(){return!1},getlowrange:function(){return this.range[0]},gethighrange:function(){return this.range[1]},endround:function(){},desactivate:function(){this.ordnance&&
this.type.match(/Torpedo|Missile/)?this.ordnance=!1:(this.isactive=!1,this.unit.movelog("D-"+this.unit.upgrades.indexOf(this)),this.unit.updatehtml())},show:function(){},install:function(b){if("undefined"!=typeof this.addedaction){var e=this.addedaction.toUpperCase();b["addedaction"+this.id]=b.shipactionList.length;b.shipactionList.push(e);b.showactionlist()}"undefined"!=typeof this.upgrades&&(b["addedupg"+this.id]=b.upgradesno,"undefined"!=typeof this.pointsupg&&(b.upgbonus[this.upgrades[0]]=this.pointsupg),
"undefined"!=typeof this.maxupg&&(b.maxupg[this.upgrades[0]]=this.maxupg),1==this.exclusive&&(b.exclupg[this.upgrades[0]]=!0),b.upgradetype=b.upgradetype.concat(this.upgrades),b.upgradesno=b.upgradetype.length,b.showupgradeadd());if("undefined"!=typeof this.lostupgrades){for(e=0;e<b.upgradetype.length;e++)-1<this.lostupgrades.indexOf(b.upgradetype[e])&&(-1<b.upg[e]&&removeupgrade(b,e,b.upg[e]),b.upg[e]=-2);b.showupgradeadd()}if("undefined"!=typeof this.takesdouble){for(e=0;e<b.upgradetype.length&&
(b.upgradetype[e]!=this.type||!(0>b.upg[e]||UPGRADES[b.upg[e]].name!=this.name));e++);e<b.upgradetype.length&&(-1<b.upg[e]&&removeupgrade(b,e,b.upg[e]),b.upg[e]=-2);b.showupgradeadd()}},uninstall:function(b){"undefined"!=typeof this.addedaction&&(this.addedaction.toUpperCase(),b.shipactionList.splice(b["addedaction"+this.id],1));if("undefined"!=typeof this.upgrades){"undefined"!=typeof this.pointsupg&&(b.upgbonus[this.upgrades[0]]=0);"undefined"!=typeof this.maxupg&&(b.maxupg[this.upgrades[0]]=0);
for(var e=0;e<this.upgrades.length;e++){var f=e+b["addedupg"+this.id],g=$("#unit"+b.id+" .upg div[num="+f+"]");0<g.length&&(g=g.attr("data"),removeupgrade(b,f,g))}1==typeof this.exclusive&&(b.exclupg[this.upgrades[0]]=!1);b.upgradetype.splice(b["addedupg"+this.id],this.upgrades.length);b.upgradesno=b.upgradetype.length}if("undefined"!=typeof this.lostupgrades)for(e=0;e<b.upgradetype.length;e++)-1<this.lostupgrades.indexOf(b.upgradetype[e])&&(b.upg[e]=-1);if("undefined"!=typeof this.takesdouble)for(e=
0;e<b.upgradetype.length;e++)b.upgradetype[e]==this.type&&-2==b.upg[e]&&(b.upg[e]=-1)},wrap_before:Unit.prototype.wrap_before,wrap_after:Unit.prototype.wrap_after};var rebelonly=function(b){var e;for(e=0;e<PILOTS.length;e++)if(b==PILOTS[e].name&&PILOTS[e].faction==REBEL)return!0;return!1},empireonly=function(b){var e;for(e=0;e<PILOTS.length;e++)if(b==PILOTS[e].name&&PILOTS[e].faction==EMPIRE)return!0;return!1};var UPGRADES=[{name:"Ion Cannon Turret",type:TURRET,firesnd:"falcon_fire",points:5,attack:3,upgid:0,done:!0,modifyhit:function(b){return FCH_HIT},prehit:function(b,e,f){this.unit.hitresolved=1;this.unit.criticalresolved=0;b.log("+%1 %HIT%, +1 ion token [%0]",this.name,1);b.addiontoken()},range:[1,2]},{name:"Proton Torpedoes",requires:"Target",consumes:!0,type:TORPEDO,firesnd:"missile",points:4,done:!0,attack:4,init:function(b){b.adddicemodifier(ATTACK_M,MOD_M,ATTACK_M,this,{req:function(e,g){return b.weapons[b.activeweapon]==
...
return this.activationdial})}},{name:"Intensity(Ready)",type:ELITE,points:0,invisible:!0},{name:"Intensity(Exhausted)",type:ELITE,points:0,invisible:!0},{name:"Intensity",type:ELITE,points:2,done:!0,faceup:!0,"switch":function(){this.name=(this.faceup=!this.faceup)?"Intensity(Ready)":"Intensity(Exhausted)"},init:function(b){var e=this;b.wrap_after("updateactivationdial",this,function(b){e.isactive&&e.faceup&&(this.isactiondone("ROLL")||this.isactiondone("BOOST"))&&(this.addactivationdial(function(){return e.faceup&&
(this.isactiondone("ROLL")||this.isactiondone("BOOST"))}.bind(this),function(){this.addfocustoken();e["switch"]();this.show()}.bind(this),A.FOCUS.key,$("<div>").attr({"class":"symbols",title:e.name})),this.addactivationdial(function(){return e.faceup&&(this.isactiondone("ROLL")||this.isactiondone("BOOST"))}.bind(this),function(){this.addevadetoken();e["switch"]();this.show()}.bind(this),A.EVADE.key,$("<div>").attr({"class":"symbols",title:e.name})));return this.activationdial});b.wrap_before("endcombatphase",
this,function(){e.isactive&&!e.faceup&&(this.canuseevade()?(this.removeevadetoken(),e["switch"](),this.show(),this.log("1 %EVADE% -> [%0]",e.name)):this.canusefocus()&&(this.removefocustoken(),e["switch"](),this.show(),this.log("1 %FOCUS% -> [%0]",e.name)))})}},{name:"BB-8",unique:!0,done:!0,type:ASTROMECH,points:2,init:function(b){var e=this;e.bb=-1;b.wrap_after("updateactivationdial",this,function(b){e.isactive&&e.bb!=round&&!this.hasionizationeffect()&&this.addactivationdial(function(){return!this.hasmoved&&
-1<this.maneuver&&"GREEN"==this.getmaneuver().difficulty&&this.candoroll()&&!this.hasionizationeffect()}.bind(this),function(){e.bb=round;this.doaction([this.newaction(this.resolveroll,"ROLL")],e.name+" free roll for green maneuver.")}.bind(this),A[ASTROMECH.toUpperCase()].key,$("<div>").attr({"class":"symbols",title:e.name}));return this.activationdial})}},{name:"Integrated Astromech",points:0,type:MOD,ship:"X-Wing",done:!0,init:function(b){var e=this;b.wrap_after("deal",this,function(b,g,h){var f=
-1,m;for(m in this.upgrades)if(b=this.upgrades[m],b.type==ASTROMECH&&1==b.isactive){f=m;break}if(-1==f||!e.isactive)return h;var q=$.Deferred();h.then(function(b){1==this.shield+this.hull||b.face==FACEUP&&b.crit.lethal&&2>=this.shield+this.hull?(this.upgrades[f].desactivate(),this.log("%0 is inactive, damage discarded [%1]",this.upgrades[f].name,e.name),e.desactivate(),q.resolve({crit:b.crit,face:DISCARD})):q.resolve(b)}.bind(this));return q.promise()})}},{name:"Weapons Guidance",points:2,type:TECH,
done:!0,init:function(b){var e=this;b.adddicemodifier(ATTACK_M,MOD_M,ATTACK_M,this,{req:function(b,g){return e.isactive&&this.canusefocus()}.bind(b),aiactivate:function(b,e){return 0<FCH_blank(b,e)},f:function(b,g){var f=FCH_blank(b,g);this.removefocustoken();displayattacktokens(this);0<f&&(this.log("1 blank -> 1 %HIT% [%0]",e.name),b+=FCH_HIT);return b}.bind(b),str:"blank"})}},{name:"R5-K6",init:function(b){var e=this;b.wrap_after("removetarget",this,function(b){this.defenseroll(1).done(function(f){0<
FE_evade(f.roll)&&(this.addtarget(b),this.log("+1 %TARGET% / %1 [%0]",e.name,b.name))}.bind(this))})},done:!0,unique:!0,type:ASTROMECH,points:2},{name:"R5 Astromech",done:!0,init:function(b){var e=this;b.wrap_before("endphase",this,function(){for(var b=-1,g=-1,h=0;h<this.criticals.length;h++){var l=this.criticals[h];if(l.isactive&&"ship"==l.type&&(b=h,l.lethal)){g=h;break}}-1<g?(this.log("repairing critical %1 [%0]",e.name,this.criticals[g].name),this.criticals[g].facedown()):-1<b&&(this.log("repairing critical %1 [%0]",
e.name,this.criticals[b].name),this.criticals[b].facedown())})},type:ASTROMECH,points:1},{name:"Determination",done:!0,init:function(b){var e=this;b.wrap_after("deal",this,function(b,g,h){if("pilot"!=b.type)return h;var f=$.Deferred();h.then(function(b){b.face==FACEUP?(this.log("discarding critical %1 [%0]",e.name,b.crit.name),f.resolve({crit:b.crit,face:DISCARD})):f.resolve(b)}.bind(this));return f.promise()})},type:ELITE,points:1},{name:"Swarm Tactics",type:ELITE,points:2,done:!0,init:function(b){var e=
this;"undefined"==typeof Unit.prototype.getswarm&&(Unit.prototype.getswarm=function(){return[[],[],[]]});Unit.prototype.wrap_after("getswarm",this,function(b){b[e.unit.team]=b[e.unit.team].concat(e.unit);return b});e.unit.propswarm=-1;b.wrap_before("begincombatphase",this,function(){var b=this.getswarm()[this.team],g=this;if(this==b[0])for(var h=b.length,l=0;l<h;l++)this.doselection(function(f){b.sort(function(b,e){return b.getskill()>e.getskill()?1:b.getskill()<e.getskill()?-1:0});var h=b.pop(),
l=h.selectnearbyally(1,function(b,e){return b.getskill()>e.getskill()});h.select();var m=h.getskill();0==l.length?g.endnoaction(f,"SELECT"):h.resolveactionselection(l,function(b){l[b].wrap_after("getskill",e,function(b){return m}).unwrapper("endcombatphase");l[b].log("PS set to %1 [%0]",e.name,m);l[b].showskill();g.endnoaction(f,"SELECT")})})})}},{name:"Squad Leader",unique:!0,done:!0,type:ELITE,points:2,candoaction:function(){var b=this.unit.selectnearbyally(2,function(b,f){return f.getskill()<b.getskill()&&
f.candoaction()});return this.isactive&&0<b.length},action:function(b){var e=this.unit,f=e.selectnearbyally(2,function(b,e){return e.getskill()<b.getskill()&&e.candoaction()});0<f.length?e.resolveactionselection(f,function(g){f[g].select();f[g].doaction(f[g].getactionlist(),"+1 free action").done(function(){e.select()});e.endaction(b,"ELITE")}):(e.log("no lower skilled pilot within range 2 [%0]",this.name),e.endaction(b,"ELITE"))}},{name:"Expert Handling",candoaction:function(){return this.isactive&&
-1==this.unit.actionsdone.indexOf("ROLL")},action:function(b){-1==this.unit.shipactionList.indexOf("ROLL")&&this.unit.addstress();0<this.unit.istargeted.length?(this.unit.log("select target to lock [%0]",this.name),this.unit.resolveactionselection(this.unit.istargeted,function(e){this.istargeted[e].removetarget(this);this.resolveroll(b)}.bind(this.unit))):this.unit.resolveroll(b)},type:ELITE,done:!0,points:2},{name:"Marksmanship",init:function(b){this.mark=-1;var e=this;b.adddicemodifier(ATTACK_M,
MOD_M,ATTACK_M,this,{req:function(b,e){return this.mark==round&&this.isactive}.bind(this),aiactivate:function(b,e){return 0<FCH_focus(b)},f:function(b,g){var f=FCH_focus(b);0<f&&this.mark==round&&(1<f?this.unit.log("%0 %FOCUS% -> 1 %CRIT%, %1 %HIT% [%2]",f,f-1,e.name):this.unit.log("1 %FOCUS% -> 1 %CRIT% [%1]",f,e.name),b=b-FCH_FOCUS*f+FCH_CRIT+(f-1)*FCH_HIT);return b}.bind(this),str:"focus",noreroll:"focus"})},candoaction:function(){return this.isactive},action:function(b){this.mark=round;this.unit.endaction(b,
ELITE)},done:!0,type:ELITE,points:3},{name:"Concussion Missiles",requires:"Target",consumes:!0,type:MISSILE,firesnd:"missile",points:4,attack:4,done:!0,init:function(b){var e=this;b.adddicemodifier(ATTACK_M,MOD_M,ATTACK_M,this,{req:function(f,g){return b.weapons[b.activeweapon]==this&&e.isactive}.bind(this),f:function(b,e){0<FCH_blank(b,e)&&(b+=FCH_HIT);return b}.bind(this),str:"blank"});b.wrap_after("setpriority",this,function(b){"TARGET"==b.type&&e.isactive&&this.candotarget()&&(b.priority+=10)})},
range:[2,3]},{name:"Cluster Missiles",type:MISSILE,firesnd:"missile",requires:"Target",consumes:!0,points:4,attack:3,done:!0,followupattack:function(){return this.unit.weapons.indexOf(this)},hasdoubleattack:function(){return this.twinattack=!this.twinattack},init:function(b){this.twinattack=!1;b.wrap_after("setpriority",this,function(b){"TARGET"==b.type&&self.isactive&&this.candotarget()&&(b.priority+=10)})},range:[1,2]},{name:"Daredevil",done:!0,candoaction:function(){return this.isactive},action:function(b){var e=
this;this.unit.log("select maneuver [%0]",this.name);this.unit.resolveactionmove([this.unit.getpathmatrix(this.unit.m,"TL1"),this.unit.getpathmatrix(this.unit.m,"TR1")],function(f,g){if(-1==g)return f.endaction(b,ELITE);f.addstress();if(-1==f.shipactionList.indexOf("BOOST")){f.log("2 rolls for damage [%0]",e.name);for(var h=f.rollattackdie(2,e,"hit"),l=0;2>l;l++)"hit"==h[l]?f.resolvehit(1):"critical"==h[l]&&f.resolvecritical(1);f.checkdead()}f.endaction(b,ELITE)},!0,!0)},type:ELITE,points:3},{name:"Elusiveness",
done:!0,init:function(b){var e=this;b.adddicemodifier(DEFENSE_M,MOD_M,ATTACK_M,this,{req:function(){return 0==this.stress&&targetunit==this&&e.isactive}.bind(b),aiactivate:function(e,g){b.log("activate elusiveness "+FCH_crit(e)+" "+FCH_hit(e));return 0<FCH_crit(e)+FCH_hit(e)},f:function(b,e){this.unit.addstress();0<FCH_crit(b)?(this.unit.log("1 %CRIT% rerolled [%0]",this.name),b=b-FCH_CRIT+activeunit.attackroll(1)):0<FCH_hit(b)&&(this.unit.log("1 %HIT% rerolled [%0]",this.name),b=b-FCH_HIT+activeunit.attackroll(1));
return b}.bind(this),str:"critical"})},type:ELITE,points:2},{name:"Homing Missiles",requires:"Target",consumes:!1,type:MISSILE,firesnd:"missile",attack:4,range:[2,3],done:!0,declareattack:function(b){targetunit.wrap_after("canuseevade",this,function(){return!1}).unwrapper("afterdefenseeffect");targetunit.log("cannot use evade tokens [%0]",this.name);return Weapon.prototype.declareattack.call(this,b)},init:function(b){var e=this;b.wrap_after("setpriority",this,function(b){"TARGET"==b.type&&e.isactive&&
this.candotarget()&&(b.priority+=10)})},points:5},{name:"Push the Limit",init:function(b){var e=this;e.r=-1;b.wrap_before("endaction",this,function(b,g){e.r!=round&&this.candoaction()&&null!=g&&(e.r=round,this.doaction(this.getactionbarlist(),"+1 free action (Skip to cancel) ["+e.name+"]").done(function(b){null==b?e.r=-1:this.addafteractions(function(){this.addstress()}.bind(this))}.bind(this)))})},done:!0,type:ELITE,points:3},{name:"Deadeye",init:function(b){for(var e in b.weapons)b.weapons[e].wrap_after("getrequirements",
this,function(b){return"Target"==b?"Target|Focus":b})},done:!0,type:ELITE,points:1},{name:"Expose",candoaction:function(){return this.isactive},action:function(b){var e=this.unit.weapons[0];this.unit.log("-1 agility, +1 primary attack until end of turn [%0]",this.name);this.unit.wrap_after("getagility",this,function(b){return 0<b?b-1:0}).unwrapper("endphase");e.wrap_after("getattack",this,function(b){return b+1}).unwrapper("endround");this.unit.showstats();this.unit.endaction(b,ELITE)},done:!0,type:ELITE,
points:4},{name:"Gunner",done:!0,init:function(b){for(var e in b.weapons)b.weapons[e].immediateattack={pred:function(b){return 0==b},weapon:function(){return 0}};b.addattack(function(b,e){return this.weapons[0].isactive&&0==b+e},this,[b.weapons[0]],function(){this.noattack=round},function(){return this.selectnearbyenemy(3)})},type:CREW,points:5},{name:"Ion Cannon",type:CANNON,firesnd:"slave_fire",done:!0,modifyhit:function(b){return FCH_HIT},prehit:function(b,e,f){this.unit.hitresolved=1;this.unit.criticalresolved=
0;b.log("+%1 %HIT%, +1 ion token [%0]",this.name,1);b.addiontoken()},points:3,attack:3,range:[1,3]},{name:"Heavy Laser Cannon",type:CANNON,firesnd:"slave_fire",done:!0,modifydamagegiven:function(b){if(0<FCH_crit(b)){var e=FCH_crit(b);this.unit.log("%0 %CRIT%-> %0 %HIT% [%1]",e,this.name);b=b-FCH_CRIT*e+e*FCH_HIT}return b},points:7,attack:4,range:[2,3]},{name:"Seismic Charges",done:!0,img:"seismic.png",snd:"explode",width:16,height:8,size:15,explode:function(){if(phase==ACTIVATION_PHASE&&!this.exploded){for(var b=
this.getrangeallunits(),e=0;e<b[1].length;e++){var f=squadron[b[1][e].unit];f.log("+1 %HIT% [%0]",this.name);f.resolvehit(1);f.checkdead()}this.explode_base()}},type:BOMB,points:2},{name:"Mercenary Copilot",init:function(b){var e=this;b.adddicemodifier(ATTACK_M,MOD_M,ATTACK_M,this,{req:function(b,e){return 3==this.getrange(targetunit)}.bind(b),aiactivate:function(b,e){return 0<FCH_hit(b)},f:function(b,g){0<FCH_hit(b)&&(this.log("1 %HIT% -> 1 %CRIT% [%0]",e.name),b=b-FCH_HIT+FCH_CRIT);return b}.bind(b),
str:"hit"})},done:!0,type:CREW,points:2},{name:"Assault Missiles",type:MISSILE,requires:"Target",consumes:!0,firesnd:"missile",done:!0,prehit:function(b,e,f){e=b.getrangeallunits();for(f=0;f<e[1].length;f++)squadron[e[1][f].unit]!=b&&(squadron[e[1][f].unit].log("+1 %HIT% [%0]",this.name),squadron[e[1][f].unit].resolvehit(1))},init:function(b){var e=this;b.wrap_after("setpriority",this,function(b){"TARGET"==b.type&&e.isactive&&this.candotarget()&&(b.priority+=10)})},points:5,attack:4,range:[2,3]},
{name:"Veteran Instincts",done:!0,install:function(b){b.installed=!0;b.wrap_after("getskill",this,function(b){return b+2});b.showskill()},uninstall:function(b){"function"==typeof b.getskill.unwrap&&b.getskill.unwrap(this);b.showskill()},type:ELITE,points:1},{name:"Proximity Mines",img:"proximity.png",snd:"explode",width:18,height:18,size:35,done:!0,stay:!0,candoaction:function(){return this.unit.lastdrop!=round&&this.isactive},action:function(b){this.actiondrop(b)},canbedropped:function(){return!1},
explode:function(){},detonate:function(b){if(!this.exploded){for(var e=this.unit.rollattackdie(3,this,"critical"),f=0;3>f;f++)"hit"==e[f]?(b.log("+1 %HIT% [%0]",this.name),b.resolvehit(1),b.checkdead()):"critical"==e[f]&&(b.log("+1 %CRIT% [%0]",this.name),b.resolvecritical(1),b.checkdead());Bomb.prototype.detonate.call(this)}},getOutlineString:function(b){var e="M ";this.op=[];"undefined"==typeof b&&(b=this.m);for(var f=0;25>f;f++){var g=transformPoint(b,{x:this.size*Math.sin(2*f*Math.PI/25),y:this.size*
Math.cos(2*f*Math.PI/25)});this.op.push(g);e+=g.x+" "+g.y+" ";0==f&&(e+="L ")}return{s:e+"Z",p:this.op}},type:BOMB,points:3},{name:"Weapons Engineer",type:CREW,points:3,done:!0,init:function(b){this.second=!1;var e=this;b.boundtargets=function(b){if(-1<this.targeting.indexOf(b))return!0;for(b=this.targeting.length-2;0<=b;b--)this.removetarget(this.targeting[b]);return!1};b.wrap_after("addtarget",this,function(b){1==this.second?this.second=!1:this.doselection(function(b){this.second=!0;this.log("select target to lock [%0]",
e.name);this.resolvetargetnoaction(b,!0)}.bind(this))})}},{name:"Draw Their Fire",init:function(b){var e=this;e.ea=Unit.prototype.resolvecritical;Unit.prototype.resolvecritical=function(f){!e.unit.dead&&e.isactive&&0<f&&this.isally(b)&&b!=this&&1==this.getrange(b)?(this.selectunit([this,b],function(f,h){0==h?e.ea.call(this,1):e.ea.call(b,1)},["select unit [%0]",e.name],!1),e.ea.call(this,f-1)):e.ea.call(this,f);return f}},done:!0,type:ELITE,points:1},{name:"Luke Skywalker",faction:REBEL,unique:!0,
done:!0,init:function(b){var e=this,f;for(f in b.weapons)b.weapons[f].immediateattack={pred:function(b){return 0==b},weapon:function(){return 0}};b.addattack(function(b,e){return this.weapons[0].isactive&&0==b+e},this,[b.weapons[0]],function(){this.noattack=round},function(){return this.selectnearbyenemy(3)});b.adddicemodifier(ATTACK_M,MOD_M,ATTACK_M,this,{req:function(b,f){return e.unit.addedattack==round&&e.isactive},aiactivate:function(b,e){return 0<FCH_focus(b)},f:function(b,f){0<FCH_focus(b)&&
(this.log("1 %FOCUS% -> 1 %HIT% [%0]",e.name),b=b-FCH_FOCUS+FCH_HIT);return b},str:"focus"})},type:CREW,points:7},{name:"Nien Nunb",faction:REBEL,done:!0,install:function(b){b.installed=!0;b.wrap_after("getdial",this,function(b){for(var e=0;e<b.length;e++)b[e].move.match(/F[1-5]/)&&(b[e].difficulty="GREEN");return b})},uninstall:function(b){"function"==typeof b.getdial.unwrap&&b.getdial.unwrap(this)},unique:!0,type:CREW,points:1},{name:"Chewbacca",faction:REBEL,unique:!0,done:!0,type:CREW,init:function(b){var e=
this;b.wrap_after("deal",this,function(b,g,h){if(!e.isactive)return h;var f=$.Deferred();h.then(function(b){1==this.hull+this.shield||b.face==FACEUP&&b.crit.lethal&&2>=this.hull+this.shield?(this.shield<this.ship.shield&&this.addshield(1),this.log("+1 %SHIELD%, 1 damage discarded [%0]",e.name),e.desactivate(),f.resolve({crit:b.crit,face:DISCARD})):f.resolve(b)}.bind(this));return f.promise()})},points:4},{name:"Advanced Proton Torpedoes",requires:"Target",consumes:!0,type:TORPEDO,firesnd:"missile",
attack:5,done:!0,range:[1,1],init:function(b){var e=this;b.adddicemodifier(ATTACK_M,MOD_M,ATTACK_M,this,{req:function(e,g){return b.weapons[b.activeweapon]==this}.bind(this),aiactivate:function(b,e){return 0<FCH_blank(b,e)},f:function(b,e){var f=FCH_blank(b,e);3<f&&(f=3);0<f&&(this.unit.log("%0 blanks -> %0 %FOCUS% [%1]",f,this.name),b+=f*FCH_FOCUS);return b}.bind(this),str:"blank"});b.wrap_after("setpriority",this,function(b){"TARGET"==b.type&&e.isactive&&this.candotarget()&&(b.priority+=10)})},
points:6},{name:"Autoblaster",type:CANNON,done:!0,firesnd:"slave_fire",attack:3,declareattack:function(b){var e=this;b.wrap_after("cancelhit",e,function(b,g,h){e.unit.log("%HIT% cannot be cancelled [%0]",e.name);return b}).unwrapper("afterdefenseeffect");return Weapon.prototype.declareattack.call(this,b)},range:[1,1],points:5},{name:"Fire-Control System",done:!0,init:function(b){var e=this;e.f=-1;b.wrap_before("postattack",this,function(b){this.reroll=10});b.addafterattackeffect(this,function(){-1<
this.gettargetableunits(3).indexOf(targetunit)?(this.log("+1 %TARGET% / %1 [%0]",e.name,targetunit.name),this.addtarget(targetunit)):this.log("no valid target [%0]",e.name)})},type:SYSTEM,points:2},{name:"Blaster Turret",type:TURRET,done:!0,firesnd:"falcon_fire",requires:"Focus",consumes:!0,points:4,attack:3,range:[1,2]},{name:"Recon Specialist",init:function(b){var e=this;b.wrap_before("addfocus",this,function(f){b.log("+1 %FOCUS% [%0]",e.name);b.addfocustoken()})},done:!0,type:CREW,points:3},{name:"Saboteur",
type:CREW,done:!0,candoaction:function(){var b=this.unit.selectnearbyenemy(1);return this.isactive&&0<b.length},action:function(b){var e=this;if(this.isactive){var f=this.unit.selectnearbyenemy(1);0<f.length?(this.unit.log("select unit [%0]",this.name),this.unit.resolveactionselection(f,function(g){var h,l=[];for(h=0;h<f[g].criticals.length;h++)0==f[g].criticals[h].isactive&&l.push(h);0<l.length?(h=f[g].rand(l.length),f[g].log("turn faceup one damage card [%0]",e.name),f[g].criticals[l[h]].faceup(),
f[g].show()):f[g].log("no damage card [%0]",e.name);this.endaction(b,"CREW")}.bind(this.unit))):this.unit.endaction(b,"CREW")}else this.unit.endaction(b,"CREW")},points:2},{name:"Intelligence Agent",done:!0,init:function(b){var e=this;b.wrap_before("beginactivationphase",this,function(){this.selectunit(this.selectnearbyenemy(2),function(b,g){b[g].showmaneuver();var f=b[g].getmaneuver();b[g].log("has a %0<span class='symbols'>"+P[f.move].key+"</span> maneuver [%1]",P[f.move].speed,e.name)},["select unit [%0]",
e.name],!1)})},type:CREW,points:1},{name:"Proton Bombs",done:!0,width:32,height:30,size:15,snd:"explode",img:"proton.png",explode:function(){if(phase==ACTIVATION_PHASE&&!this.exploded){for(var b=this.getrangeallunits(),e=0;e<b[1].length;e++)squadron[b[1][e].unit].applycritical(1),squadron[b[1][e].unit].checkdead();this.explode_base()}},type:BOMB,points:5},{name:"Adrenaline Rush",done:!0,init:function(b){var e=this;b.wrap_after("updateactivationdial",this,function(){this.addactivationdial(function(){return!this.hasionizationeffect()&&
...
"CREW")}.bind(this)}],"",!0)})},type:CREW,points:3},{name:"Rebel Captive",faction:EMPIRE,done:!0,init:function(b){var e=this;b.rebelcaptive=0;b.wrap_before("isattackedby",this,function(b,g){this.rebelcaptive!=round&&(g.log("+1 %STRESS% [%0]",e.name),g.addstress(),this.rebelcaptive=round)}.bind(this))},unique:!0,type:CREW,points:3},{name:"Flight Instructor",init:function(b){var e=this;b.adddicemodifier(DEFENSE_M,REROLL_M,DEFENSE_M,this,{dice:["focus"],n:function(){return 2>=activeunit.getskill()?2:
1},req:function(b,g,h){this.isactive&&this.unit.log("+%1 %FOCUS% reroll(s) [%0]",e.name,2>=activeunit.getskill()?2:1);return this.isactive}.bind(this)})},done:!0,type:CREW,points:4},{name:"Navigator",init:function(b){b.wrap_after("getmaneuverlist",this,function(b){var e=this.getdial();if(this.hasionizationeffect())return b;for(var g in b){var h=g.replace(/\d/,"");for(j=0;j<e.length;j++)!e[j].move.match(h)||"undefined"!=typeof b[e[j].move]||"RED"==e[j].difficulty&&0!=this.stress||(b[e[j].move]=e[j])}return b})},
done:!0,type:CREW,points:3},{name:"Opportunist",done:!0,init:function(b){var e=this;b.wrap_after("preattackroll",this,function(b,g){0==g.focus+g.evade&&0==this.stress&&this.donoaction([{org:this,name:this.name,type:"ELITE",action:function(b){this.wrap_after("getattackstrength",e,function(b,e,f){return f+1}).unwrapper("endattack");this.addstress();this.log("+1 attack against %1, +1 %STRESS% [%0]",e.name,g.name);this.endnoaction(b,"ELITE")}.bind(this)}],"",!0)})},type:ELITE,points:4},{name:"Ion Pulse Missiles",
...
this,function(){this.selectunit(this.selectnearbyally(1,function(b,e){return 0<e.stress}),function(b,e){b[e].removestresstoken()},["select unit [%0]",e.name],!1)})},type:ELITE,points:2},{name:"Decoy",init:function(b){var e=this;b.wrap_before("begincombatphase",this,function(){this.selectunit(this.selectnearbyally(2),function(b,g){var f=b[g].getskill(),l=this.getskill();this.wrap_after("getskill",e,function(b){return f}).unwrapper("endcombatphase");b[g].wrap_after("getskill",e,function(b){return l}).unwrapper("endcombatphase")},
["select unit (or self to cancel) [%0]",e.name],!0)})},done:!0,type:ELITE,points:2},{name:"Outmaneuver",done:!0,init:function(b){var e=this;b.wrap_before("resolveattack",this,function(b,g){g.wrap_after("getdefensestrength",e,function(b,f,g){return!this.isinfiringarc(f)&&f.isinfiringarc(this)&&0<g?(this.log("-1 defense [%0]",e.name),g-1):g}).unwrapper("dodefenseroll")})},type:ELITE,points:3},{name:"Predator",done:!0,init:function(b){var e=this;b.adddicemodifier(ATTACK_M,REROLL_M,ATTACK_M,this,{dice:["blank",
"focus"],n:function(){return 2>=targetunit.getskill()?2:1},req:function(b,g,h){this.log("+%1 reroll(s) [%0]",e.name,2>=targetunit.getskill()?2:1);return e.isactive}.bind(b)})},type:ELITE,points:3},{name:"Flechette Torpedoes",requires:"Target",consumes:!0,type:TORPEDO,firesnd:"missile",done:!0,endattack:function(b,e){4>=targetunit.hull&&targetunit.addstress();Weapon.prototype.endattack.call(this)},init:function(b){var e=this;b.wrap_after("setpriority",this,function(b){"TARGET"==b.type&&e.isactive&&
...
this.name),this.unit.resolveactionselection(e,function(f){e[f]!=this?(e[f].isinfiringarc(this)&&this.addtarget(e[f]),this.resolveboost(b)):this.endaction(b,"ASTROMECH")}.bind(this.unit))):this.unit.endaction(b,"ASTROMECH")},done:!0,unique:!0,type:ASTROMECH,points:3},{name:"Tactician",type:CREW,limited:!0,points:2,done:!0,init:function(b){var e=this;b.addafterattackeffect(this,function(b,g){2==this.getsector(targetunit)&&(targetunit.addstress(),targetunit.log("+1 %STRESS% [%0]",e.name))})}},{name:"R2-D2",
faction:REBEL,unique:!0,type:CREW,points:4,done:!0,init:function(b){var e=this;b.wrap_after("endphase",this,function(){for(var b=[],g=this.criticals,h=0;h<g.length;h++)g[h].isactive||b.push(g[h]);0==this.shield&&0<this.ship.shield&&(this.log("+1 %SHIELD% [%0]",e.name),this.addshield(1),this.show(),0<b.length&&(b=b[this.rand(b.length)],0<FCH_hit(this.attackroll(1))&&(this.log("+1 %CRIT% [%0]",this.name),b.faceup())))})}},{name:"C-3PO",unique:!0,faction:REBEL,type:CREW,points:3,done:!0,init:function(b){var e=
-1;b.wrap_after("defenseroll",this,function(b,g){if(e==round)return g;var f=$.Deferred();e=round;g.done(function(b){this.guessevades(b,f)}.bind(this));return f.promise()})}},{name:"R3-A2",done:!0,init:function(b){var e=this;b.wrap_before("resolveattack",this,function(b,g){this.isinfiringarc(g)&&this.donoaction([{org:e,name:e.name,type:"ASTROMECH",action:function(b){this.addstress();this.log("+1 %STRESS% [%0]",e.name);g.log("+1 %STRESS% [%0]",e.name);g.addstress();this.endnoaction(b,"ASTROMECH")}.bind(this)}],
"",!0)})},unique:!0,type:ASTROMECH,points:2},{name:"R2-D6",upgrades:[ELITE],noupgrades:ELITE,skillmin:3,done:!0,unique:!0,type:ASTROMECH,points:1},{name:"Enhanced Scopes",done:!0,init:function(b){var e=this;b.wrap_before("beginactivationphase",this,function(){this.log("PS set to %1 [%0]",e.name,0);this.wrap_after("getskill",e,function(b){return 0}).unwrapper("endactivationphase")})},type:SYSTEM,points:1},{name:"Chardaan Refit",type:MISSILE,done:!0,firesnd:"missile",isWeapon:function(){return!1},points:-2,
ship:"A-Wing"},{name:"Proton Rockets",type:MISSILE,firesnd:"missile",requires:"Focus",consumes:!1,points:3,attack:2,done:!0,getattack:function(){a=this.attack;return a=3>=this.unit.agility?a+this.unit.agility:a+3},init:function(b){var e=this;b.wrap_after("setpriority",this,function(b){"FOCUS"==b.type&&e.isactive&&this.candofocus()&&(b.priority+=10)})},range:[1,1]},{name:"Kyle Katarn",faction:REBEL,unique:!0,done:!0,type:CREW,points:3,init:function(b){var e=this;b.wrap_after("removestresstoken",this,
function(){this.log("-1 stress -> +1 %FOCUS% [%0]",e.name);this.addfocustoken()})}},{name:"Jan Ors",faction:REBEL,unique:!0,type:CREW,points:2,done:!0,init:function(b){this.jan=-1;var e=this;Unit.prototype.wrap_after("addfocustoken",this,function(){!e.unit.dead&&3>=this.getrange(b)&&this.isally(b)&&e.jan<round&&(this.log("select %FOCUS% or %EVADE% token [%0]",e.name),this.donoaction([{name:e.name,org:e,type:"FOCUS",action:function(b){this.endnoaction(b,"FOCUS")}.bind(this)},{name:e.name,org:e,type:"EVADE",
action:function(b){e.jan=round;this.focus--;this.addevadetoken();this.endnoaction(b,"EVADE")}.bind(this)}],"",!1))})}},{name:"R4-D6",init:function(b){var e=this;b.wrap_after("cancelhit",this,function(f,g,h){f=FCH_hit(h.ch);if(3<=f){b.log("cancelling %0 hits [%1]",f-2,e);f-=2;g=h.ch-f*FCH_HIT;for(var l=0;l<f;l++)b.addstress();return{ch:g,e:h.e}}return h})},done:!0,unique:!0,type:ASTROMECH,points:1},{name:"R5-P9",done:!0,init:function(b){var e=this;b.wrap_before("endcombatphase",this,function(){this.canusefocus()&&
this.shield<this.ship.shield&&(this.addshield(1),this.log("1 %FOCUS% -> 1 %SHIELD% [%0]",e.name),this.removefocustoken())})},unique:!0,type:ASTROMECH,points:3},{name:"Han Solo",faction:REBEL,init:function(b){var e=this;b.adddicemodifier(ATTACK_M,MOD_M,ATTACK_M,this,{req:function(b,g){return e.isactive&&-1<this.targeting.indexOf(targetunit)}.bind(b),aiactivate:function(b,e){return 0<FCH_focus(b)},f:function(b,g){var f=FCH_focus(b);this.log("%0 %FOCUS% -> %0 %HIT% [%1]",f,e.name);this.removetarget(targetunit);
return b-FCH_FOCUS*f+FCH_HIT*f}.bind(b),str:"target",noreroll:"focus"})},type:CREW,unique:!0,done:!0,points:2},{name:"Leia Organa",faction:REBEL,type:CREW,unique:!0,done:!0,init:function(b){var e=this;b.wrap_before("beginactivationphase",this,function(){e.isactive&&this.donoaction([{type:"CREW",org:e,name:e.name,action:function(f){e.desactivate();for(var g in squadron)squadron[g].isally(b)&&squadron[g].wrap_after("getmaneuver",e,function(b){"RED"==b.difficulty&&(b.difficulty="WHITE");return b}).unwrapper("endactivationphase");
this.endnoaction(f,"CREW")}.bind(this)}],"",!0)})},points:4},{name:"Targeting Coordinator",type:CREW,limited:!0,done:!0,points:4},{name:"Lando Calrissian",faction:REBEL,type:CREW,unique:!0,done:!0,candoaction:function(){return this.isactive},action:function(b){var e=this,f="";this.isactive?this.unit.defenseroll(2).done(function(g){var h=FE_focus(g.roll);g=FE_evade(g.roll);for(var l=0;l<h;l++)this.addfocustoken();0<h&&(f+=" +"+h+" %FOCUS%");for(l=0;l<g;l++)this.addevadetoken();0<g&&(f+=" +"+g+" %EVADE%");
""==f?this.log("no effect [%0]",e.name):this.log(f+" [%0]",e.name);this.endaction(b,"CREW")}.bind(this.unit)):this.unit.endaction(b,"CREW")},points:3},{name:"Mara Jade",faction:EMPIRE,type:CREW,unique:!0,done:!0,init:function(b){var e=this;b.wrap_before("endcombatphase",this,function(){for(var b=this.gettargetableunits(1),g=0;g<b.length;g++)0==b[g].stress&&(b[g].log("+1 %STRESS% [%0]",e.name),b[g].addstress())})},points:3},{name:"Fleet Officer",faction:EMPIRE,type:CREW,done:!0,candoaction:function(){return this.isactive},
action:function(b){if(this.isactive){var e=this.unit.selectnearbyally(2);0<e.length?1==e.length?(e[0].addfocustoken(),this.unit.addstress(),this.unit.endaction(b,CREW)):2==e.length?(e[0].addfocustoken(),e[1].addfocustoken(),e[0].log("adding focus"),e[1].log("adding focus"),this.unit.addstress(),this.unit.endaction(b,CREW)):(this.unit.log("select 2 units [%0]",this.name),this.unit.resolveactionselection(e,function(f){e[f].addfocustoken();e.splice(f,1);0<e.length?this.resolveactionselection(e,function(f){e[f].addfocustoken();
this.addstress();this.endaction(b,CREW)}.bind(this)):this.endaction(b,CREW)}.bind(this.unit))):this.unit.endaction(b,CREW)}else this.unit.endaction(b,CREW)},points:3},{name:"Stay On Target",type:ELITE,points:2,done:!0,init:function(b){b.wrap_after("getmaneuverlist",this,function(b){var e=this.getdial();if(this.hasionizationeffect()||0<this.stress)return b;for(var g in b)for(var h=b[g].move.substr(-1),l=0;l<e.length;l++)e[l].move.substr(-1)==h&&"undefined"==typeof b[e[l].move]&&(b[e[l].move]={move:e[l].move,
difficulty:"RED",halfturn:!1});return b})}},{name:"Dash Rendar",faction:REBEL,unique:!0,done:!0,init:function(b){b.wrap_after("isfireobstructed",this,function(){return!1});b.wrap_after("getobstructiondef",this,function(){return 0})},type:CREW,points:2},{name:"Lone Wolf",done:!0,init:function(b){var e=this;b.adddicemodifier(ATTACK_M,REROLL_M,ATTACK_M,this,{dice:["blank"],n:function(){return 1},req:function(b,g,h){b=this.unit.selectnearbyally(2);0==b.length&&e.isactive&&this.unit.log("+1 blank reroll [%0]",
e.name);return 0==b.length&&e.isactive}.bind(this)});b.adddicemodifier(DEFENSE_M,REROLL_M,DEFENSE_M,this,{dice:["blank"],n:function(){return 1},req:function(b,g,h){b=this.unit.selectnearbyally(2);0==b.length&&e.isactive&&this.unit.log("+1 blank reroll [%0]",e.name);return 0==b.length&&e.isactive}.bind(this)})},unique:!0,type:ELITE,points:2},{name:"'Leebo'",faction:REBEL,unique:!0,candoaction:function(){return this.isactive},action:function(b){this.isactive?(this.unit.log("free %BOOST% and ion token [%0]",
this.name),this.unit.addiontoken(),this.unit.resolveboost(b)):this.unit.endaction(b,"BOOST")},done:!0,type:CREW,points:2},{name:"Ruthlessness",faction:EMPIRE,type:ELITE,points:3,done:!0,init:function(b){var e=this;b.addafterattackeffect(this,function(b,g){if(0!=b+g){var f=targetunit.selectnearbyunits(1,function(b,e){return e!=targetunit});this.selectunit(f,function(b,f){b[f].log("+%1 %HIT% [%0]",e.name,1);b[f].resolvehit(1);b[f].checkdead()},["select unit [%0]",e.name],!1)}})}},{name:"Intimidation",
done:!0,init:function(b){var e=this.unit,f=this;Unit.prototype.wrap_after("getagility",this,function(b){return!e.dead&&this.isenemy(e)&&0<b&&"undefined"!=typeof this.touching&&-1<this.touching.indexOf(e)?(this.log("-1 agility [%0]",f.name),b-1):b})},type:ELITE,points:2},{name:"Ysanne Isard",faction:EMPIRE,unique:!0,done:!0,init:function(b){var e=this;b.wrap_before("begincombatphase",this,function(){0<this.criticals.length&&this.candoevade()&&(this.addevadetoken(),this.log("+1 %EVADE% [%0]",e.name))})},
type:CREW,points:4},{name:"Moff Jerjerrod",faction:EMPIRE,unique:!0,done:!0,type:CREW,points:2,init:function(b){var e=this;b.wrap_after("deal",this,function(b,g,h){if(!e.isactive)return h;var f=$.Deferred();h.then(function(g){var h,l=[];if(g.crit.lethal&&2>=this.hull+this.shield&&g.face==FACEUP||1==this.hull+this.shield){for(h=0;h<this.upgrades.length;h++){var m=this.upgrades[h];m.type==CREW&&m!=e&&m.isactive&&l.push(m)}l.push(e);l[0].desactivate();this.log("discard %0 to remove critical %1 [%2]",
l[0].name,b.name,e.name);f.resolve({crit:g.crit,face:FACEDOWN});return!1}f.resolve(g)}.bind(this));return f.promise()})}},{name:"Ion Torpedoes",requires:"Target",consumes:!0,type:TORPEDO,firesnd:"missile",done:!0,prehit:function(b,e,f){b.addiontoken();b=b.getrangeallunits();for(e=0;e<b[1].length;e++)squadron[b[1][e].unit].log("+1 ion token [%0]",this.name),squadron[b[1][e].unit].addiontoken()},init:function(b){var e=this;b.wrap_after("setpriority",this,function(b){"TARGET"==b.type&&e.isactive&&this.candotarget()&&
(b.priority+=10)})},points:5,attack:4,range:[2,3]},{name:"Bodyguard",faction:SCUM,unique:!0,done:!0,init:function(b){var e=this;b.wrap_before("begincombatphase",this,function(){var b=this.selectnearbyally(1,function(b,e){return b.getskill()<e.getskill()});this.canusefocus()&&this.selectunit(b,function(b,f){b[f].wrap_after("getagility",e,function(b){return b+1}).unwrapper("endcombatphase");this.removefocustoken()},["select unit (or self to cancel) [%0]",e.name],!0)})},type:ELITE,points:2},{name:"Calculation",
done:!0,init:function(b){var e=this;b.adddicemodifier(ATTACK_M,MOD_M,ATTACK_M,this,{req:function(b,g){return this.canusefocus()&&e.isactive}.bind(b),aiactivate:function(b,e){return FCH_focus(b)},f:function(b,g){var f=FCH_focus(b);this.removefocustoken();displayattacktokens(this);return 0<f?(this.log("1 %FOCUS% -> 1 %CRIT% [%0]",e.name),b-FCH_FOCUS+FCH_CRIT):b}.bind(b),str:"focus"})},type:ELITE,points:1},{name:"Accuracy Corrector",init:function(b){var e=this;b.wrap_after("modifyattackroll",this,function(b,
e,h,l){return 2>FCH_hit(l)+FCH_crit(l)?2*FCH_HIT:l});b.adddicemodifier(ATTACK_M,ADD_M,ATTACK_M,this,{req:function(b,g){return e.isactive},aiactivate:function(b,e){return 2>FCH_hit(b)+FCH_crit(b)},f:function(b,g){this.log("replace all dice by 2 %HIT% [%0]",e.name);return{m:2,n:2}}.bind(b),str:"hit"})},done:!0,type:SYSTEM,points:3},{name:"Inertial Dampeners",done:!0,init:function(b){var e=this;b.wrap_after("updateactivationdial",this,function(){this.addactivationdial(function(){return!this.hasmoved&&
e.isactive&&!this.hasionizationeffect()}.bind(this),function(){e.desactivate();this.addstress();this.wrap_after("getmaneuver",e,function(b){return{move:"F0",difficulty:"WHITE"}}).unwrapper("endactivationphase");this.show()}.bind(this),A[ILLICIT.toUpperCase()].key,$("<div>").attr({"class":"symbols"}));return this.activationdial})},type:ILLICIT,points:1},{name:"Tractor Beam",type:CANNON,points:1,attack:3,done:!0,modifyhit:function(b){return 0},prehit:function(b,e,f){this.unit.hitresolved=0;this.unit.criticalresolved=
0;b.log("+1 tractor beam token [%0]",this.name);b.addtractorbeam(this.unit)},range:[1,3]},{name:"Flechette Cannon",type:CANNON,firesnd:"slave_fire",done:!0,modifyhit:function(b){return FCH_HIT},prehit:function(b,e,f){this.unit.hitresolved=1;this.unit.criticalresolved=0;b.log("+1 %HIT%, +1 %STRESS% [%0]",this.name);0==b.stress&&b.addstress()},points:2,attack:3,range:[1,3]},{name:"'Mangler' Cannon",type:CANNON,firesnd:"slave_fire",points:4,attack:3,done:!0,init:function(b){var e=this;b.adddicemodifier(ATTACK_M,
MOD_M,ATTACK_M,this,{req:function(f,g){return b.weapons[b.activeweapon]==this?e.isactive:!1}.bind(this),aiactivate:function(b,e){return 0<FCH_hit(b)},f:function(b,g){return 0<FCH_hit(b)?(this.log("1 %HIT% -> 1 %CRIT% [%0]",e.name),b+FCH_CRIT-FCH_HIT):b}.bind(b),str:"hit"})},range:[1,3]},{name:"Dead Man's Switch",done:!0,init:function(b){var e=this;b.wrap_before("dies",this,function(){for(var f=b.getrangeallunits(),g=0;g<f[1].length;g++)squadron[f[1][g].unit].log("+%1 %HIT% [%0]",e.name,1),squadron[f[1][g].unit].applydamage(1)})},
type:ILLICIT,points:2},{name:"Feedback Array",type:ILLICIT,done:!0,range:[1,1],isTurret:function(){return!0},issecondary:!1,firesnd:"missile",isWeapon:function(){return!1},declareattack:function(b){this.unit.addhasfired();this.unit.resolvehit(1);this.unit.addiontoken();SOUNDS.explode.play();this.unit.log("-1 %HIT%, +1 %ION% [%0]",this.name);b.log("-1 %HIT% [%0]",this.name);b.resolvehit(1);b.checkdead();this.unit.checkdead();this.unit.hasdamaged=!0;return!1},init:function(b){this.toString=Upgrade.prototype.toString},
points:2},{name:"'Hot Shot' Blaster",done:!0,isWeapon:function(){return!0},isTurret:function(){return!0},endattack:function(b,e){this.desactivate()},type:ILLICIT,firesnd:"xwing_fire",points:3,attack:3,range:[1,2]},{name:"Greedo",faction:SCUM,unique:!0,done:!0,type:CREW,init:function(b){b.greedoa=-1;b.greedod=-1;var e=this;b.wrap_before("hashit",e,function(b,g){e.unit.greedoa<round&&b.wrap_after("deal",e,function(b,f,g){return e.unit.greedoa<round?(e.unit.greedoa=round,this.log("first damage is a faceup damage [%0]",
e.name),dd=$.Deferred(),dd.resolve({crit:b,face:FACEUP}).promise()):g}).unwrapper("endbeingattacked");return g});b.wrap_after("resolveishit",e,function(){this.greedod<round&&this.wrap_after("deal",e,function(b,g,h){return this.greedod<round?(this.greedod=round,this.log("first damage is a faceup damage [%0]",e.name),dd=$.Deferred(),dd.resolve({crit:b,face:FACEUP}).promise()):h}).unwrapper("endbeingattacked")})},points:1},{name:"Salvaged Astromech",type:SALVAGED,done:!0,points:2,init:function(b){var e=
this;b.wrap_after("deal",this,function(b,g,h){if(!e.isactive)return h;var f=$.Deferred();h.then(function(b){"ship"==b.crit.type&&b.face==FACEUP?(e.desactivate(),this.log("remove critical %0 [%1]",b.crit.name,e.name),f.resolve({crit:b.crit,face:DISCARD})):f.resolve(b)}.bind(this));return f.promise()})}},{name:"Bomb Loadout",upgrades:[BOMB],done:!0,firesnd:"missile",isWeapon:function(){return!1},limited:!0,type:TORPEDO,points:0,ship:"Y-Wing"},{name:"'Genius'",unique:!0,done:!0,init:function(b){var e=
this;b.wrap_after("handledifficulty",this,function(b){b=[];if(this.lastdrop!=round){for(var f=0;f<this.bombs.length;f++){var h=this.bombs[f];"undefined"==typeof h.action&&h.isactive&&b.push({type:"BOMB",name:h.name,org:e,action:function(b){this.actiondrop(b)}.bind(h)})}this.donoaction(b,"",!0)}})},type:SALVAGED,points:0},{name:"Unhinged Astromech",type:SALVAGED,done:!0,install:function(b){var e=[];b.installed=!0;b.wrap_after("getdial",this,function(b){if(0==e.length)for(var f=0;f<b.length;f++){var h=
b[f].difficulty,l=b[f].move;l.match(/[A-Z]+3/)&&(h="GREEN");e[f]={move:l,difficulty:h}}return e})},uninstall:function(b){"function"==typeof b.getdial.unwrap&&b.getdial.unwrap(this)},points:1},{name:"R4-B11",unique:!0,type:SALVAGED,points:3,done:!0,init:function(b){var e=this;b.adddicemodifier(ATTACK_M,MOD_M,DEFENSE_M,this,{req:function(b,e){return-1<this.targeting.indexOf(targetunit)}.bind(b),f:function(b,g){var f=FE_evade(b),l=FE_focus(b);targetunit.canusefocus()||(l=0);this.removetarget(targetunit);
if(0<f+l){targetunit.log("Reroll %0 %EVADE%, %1 %FOCUS% [%2]",f,l,e.name);var m=targetunit.rolldefensedie(l,e,"evade");b-=FE_EVADE*f+FE_FOCUS*l;for(var q=0;q<l+f;q++)"evade"==m[q]&&(b+=FE_EVADE),"focus"==m[q]&&(b+=FE_FOCUS)}return b}.bind(b),str:"target"})}},{name:"Autoblaster Turret",type:TURRET,firesnd:"falcon_fire",done:!0,points:2,attack:2,declareattack:function(b){var e=this;b.wrap_after("cancelhit",e,function(b,g,h){e.unit.log("%HIT% cannot be cancelled [%0]",e.name);return b}).unwrapper("afterdefenseeffect");
return Weapon.prototype.declareattack.call(this,b)},range:[1,1]},{name:"R4 Agromech",done:!0,init:function(b){var e=this;this.spendfocus=!1;b.adddicemodifier(ATTACK_M,MOD_M,ATTACK_M,this,{req:function(b,g){return e.spendfocus}.bind(b),f:function(b,g){e.spendfocus=!1;this.addtarget(targetunit);this.log("+1 %TARGET% / %1 [%0]",e.name,targetunit.name);displayattacktokens2(this);return b}.bind(b),str:"target"});b.wrap_before("resolveattack",this,function(b,g){e.spendfocus=!1;this.wrap_before("removefocustoken",
e,function(){e.spendfocus=!0;displayattacktokens2(this);this.log("+1 %TARGET% / %1 [%0]",e.name,g.name)}).unwrapper("endattack")})},type:SALVAGED,points:2},{name:"K4 Security Droid",faction:SCUM,type:CREW,done:!0,init:function(b){var e=this;b.wrap_before("handledifficulty",this,function(b){"GREEN"==b&&this.selectunit(this.gettargetableunits(3),function(b,f){this.addtarget(b[f]);this.log("+1 %TARGET% / %1 [%0]",e.name,b[f].name)},["select unit (or self to cancel) [%0]",e.name],!0)})},points:3},{name:"Outlaw Tech",
faction:SCUM,beta:!0,limited:!0,done:!0,type:CREW,init:function(b){var e=this;b.wrap_after("handledifficulty",this,function(f){"RED"==f&&(b.log("+1 %FOCUS% [%0]",e.name),b.addfocustoken())})},points:2},{name:"Advanced Targeting Computer",type:SYSTEM,points:5,init:function(b){var e=this;b.adddicemodifier(ATTACK_M,ADD_M,ATTACK_M,this,{req:function(b,g){return-1<this.targeting.indexOf(targetunit)&&1==e.isactive}.bind(b),f:function(b,g){return-1<this.targeting.indexOf(targetunit)?(this.log("+1 %CRIT% [%0]",
e.name),$("#atokens > .xtargettoken").remove(),{m:b+10,n:g+1}):{m:b,n:g}}.bind(b),str:"critical"})},ship:"TIE Advanced",done:!0},{name:"Stealth Device",type:MOD,done:!0,install:function(b){b.wrap_after("getagility",this,function(b){return b+1});b.showstats()},uninstall:function(b){"function"==typeof b.getagility.unwrap&&b.getagility.unwrap(this);b.showstats()},init:function(b){var e=this;b.log("+1 agility [%0]",e.name);b.wrap_before("resolveishit",this,function(b){e.isactive&&(e.uninstall(this),e.desactivate(),
this.log("%0 is hit => destroyed",e.name),this.show())})},points:3},{name:"Shield Upgrade",type:MOD,done:!0,install:function(b){b.shield++;b.ship.shield++;b.installed=!0;b.showstats()},points:4},{name:"Engine Upgrade",type:MOD,done:!0,addedaction:"Boost",points:4},{name:"Anti-Pursuit Lasers",type:MOD,islarge:!0,done:!0,points:2,init:function(b){var e=this;b.wrap_before("collidedby",this,function(b){if(e.isactive&&b.isenemy(this)){var f=this.rollattackdie(1,e,"hit")[0];"hit"==f||"critical"==f?(b.log("+%1 %HIT% [%0]",
e.name,1),b.resolvehit(1),b.checkdead()):b.log("no effect [%0]",e.name)}})}},{name:"Targeting Computer",type:MOD,done:!0,addedaction:"Target",points:2},{name:"Hull Upgrade",type:MOD,done:!0,install:function(b){b.hull++;b.ship.hull++;b.installed=!0;b.showstats()},points:3},{name:"Munitions Failsafe",type:MOD,init:function(b){var e=this;b.addafterattackeffect(this,function(b,g){this.weapons[this.activeweapon].isprimary||0!=b+g||(this.log("%0 still active [%1]",this.weapons[this.activeweapon].name,e.name),
this.weapons[this.activeweapon].isactive=!0,this.show())})},done:!0,points:1},{name:"Stygium Particle Accelerator",type:MOD,done:!0,init:function(b){b.wrap_after("resolvedecloak",this,function(){this.candoevade()&&this.doaction([this.newaction(this.addevade,"EVADE")],"Stygium P.A.: +1 %EVADE%");return!0});b.wrap_after("addcloak",this,function(b){this.candoevade()&&this.doaction([this.newaction(this.addevade,"EVADE")],"Stygium P.A.: +1 %EVADE%")})},points:2},{name:"Advanced Cloaking Device",type:MOD,
points:4,done:!0,init:function(b){var e=this;b.addafterattackeffect(this,function(){this.candoaction()&&this.candocloak()&&this.doaction([this.newaction(this.addcloak,"CLOAK")],e.name+": free cloack action")})},ship:"TIE Phantom"},{name:"B-Wing/E2",type:MOD,done:!0,upgrades:[CREW],points:1,ship:"B-Wing",install:function(b){b.shipimg="b-wing-1.png"},uninstall:function(b){b.shipimg="b-wing-2.png"}},{name:"Countermeasures",type:MOD,islarge:!0,done:!0,init:function(b){var e=this;b.wrap_before("begincombatphase",
this,function(){e.isactive&&this.donoaction([{action:function(b){e.desactivate();this.wrap_after("getagility",e,function(b){return b+1}).unwrapper("endphase");0<this.istargeted.length?(this.log("select a lock to remove [%0]",e.name),this.resolveactionselection(this.istargeted,function(e){this.istargeted[e].removetarget(this);this.endnoaction(b,"MOD")}.bind(this))):this.endnoaction(b,"MOD")}.bind(this),type:e.type.toUpperCase(),name:e.name}],"",!0)})},points:3},{name:"Experimental Interface",type:MOD,
unique:!0,points:3,init:function(b){var e=this;e.r=-1;b.wrap_before("endaction",this,function(b,g){e.r!=round&&this.candoaction()&&null!=g&&(e.r=round,this.doaction(this.getupgactionlist(),"+1 free action (Skip to cancel)").done(function(b){null==b?e.r=-1:this.addafteractions(function(){this.addstress()}.bind(this))}.bind(this)))})},done:!0},{name:"Tactical Jammer",type:MOD,islarge:!0,points:1,done:!0,init:function(b){var e=this;Unit.prototype.wrap_after("getobstructiondef",this,function(f,g){!e.unit.dead&&
this.isenemy(b)&&0==g&&(OBSTACLES.push(b),g=this.getoutlinerange(this.m,f).o?1:0,OBSTACLES.splice(OBSTACLES.indexOf(b),1),1==g&&this.log("fire obstructed by %0",b.name));return g})}},{name:"Autothrusters",type:MOD,actionrequired:"Boost",points:2,done:!0,init:function(b){var e=this;b.wrap_after("modifydefenseroll",this,function(b,e,h,l){2<b.getsector(this)&&0<FE_blank(l,h)&&(l+=FE_EVADE);return l});b.adddicemodifier(DEFENSE_M,MOD_M,DEFENSE_M,this,{req:function(b,g){return 2<activeunit.getsector(this)?
e.isactive:!1}.bind(b),f:function(b,g){0<FE_blank(b,g)&&(this.log("1 blank -> 1 %EVADE% [%0]",e.name),b+=FE_EVADE);return b}.bind(b),str:"blank"})}},{name:"Slave I",type:TITLE,unique:!0,points:0,done:!0,ship:"Firespray-31",upgrades:[TORPEDO]},{name:"Millennium Falcon",type:TITLE,done:!0,addedaction:"Evade",unique:!0,points:1,ship:"YT-1300"},{name:"Moldy Crow",type:TITLE,init:function(b){var e=this;b.wrap_after("resetfocus",this,function(){0<this.focus&&this.log("keep %FOCUS% tokens [%0]",e.name);
return this.focus})},unique:!0,done:!0,points:3,ship:"HWK-290"},{name:"ST-321",type:TITLE,done:!0,init:function(b){b.wrap_after("gettargetableunits",this,function(b){b=[];for(i in squadron)squadron[i].isenemy(this)&&b.push(squadron[i]);return b})},unique:!0,points:3,ship:"Lambda-Class Shuttle"},{name:"Royal Guard TIE",type:TITLE,done:!0,upgrades:[MOD],skillmin:5,points:0,install:function(b){b.shipimg="tie-interceptor-1.png"},uninstall:function(b){b.shipimg="tie-interceptor-2.png"},ship:"TIE Interceptor"},
{name:"A-Wing Test Pilot",type:TITLE,done:!0,upgrades:[ELITE],skillmin:2,points:0,ship:"A-Wing",exclusive:!0,install:function(b){b.shipimg="a-wing-1.png"},uninstall:function(b){b.shipimg="a-wing-2.png"}},{name:"Outrider",type:TITLE,done:!0,init:function(b){var e;for(e=0;e<b.weapons.length;e++)if(b.weapons[e].type==CANNON){b.weapons[0].desactivate();b.log("primary weapon inactive [%0]",this.name);b.weapons[e].isTurret=function(){return!0};b.log("%0 can fire in 360 degrees [%0]",b.weapons[e].name,this.name);
break}},unique:!0,points:5,ship:"YT-2400"},{name:"Dauntless",type:TITLE,done:!0,init:function(b){var e=this;b.wrap_after("doendmaneuveraction",this,function(){this.candoaction()&&this.collision&&(this.log("+1 free action [%0]",e.name),this.doaction(this.getactionlist(),"").done(function(b){null!=b&&this.addstress()}.bind(this)))})},unique:!0,points:2,ship:"VT-49 Decimator"},{name:"Virago",type:TITLE,done:!0,upgrades:[ILLICIT,SYSTEM],unique:!0,points:1,skillmin:4,ship:"StarViper"},{name:"'Heavy Scyk' Interceptor",
done:!0,upgrades:["Cannon|Torpedo|Missile"],type:TITLE,install:function(b){b.hull++;b.ship.hull++;b.installed=!0;b.showstats()},points:2,ship:"M3-A Interceptor"},{name:"IG-2000",type:TITLE,done:!0,install:function(b){b.ig2000=!0},uninstall:function(b){b.ig2000=!1},init:function(b){for(var e in squadron){var f=squadron[e];f!=b&&1==f.ig2000&&f.isally(b)&&(b.log("copying %0 abilities [%1]",f.name,this.name),f.init.call(b,f))}},points:0,ship:"Aggressor"},{name:"BTL-A4 Y-Wing",type:TITLE,done:!0,init:function(b){for(var e=
[],f=0;f<b.weapons.length;f++){var g=b.weapons[f];g.type==TURRET&&0==g.isprimary&&(e.push(g),g.wrap_after("isTurret",this,function(){return!1}))}0!=e.length&&(b.wrap_after("isTurret",this,function(b,e){return!1}),b.addattack(function(b,e){return this.weapons[this.activeweapon].isprimary},this,e))},points:0,ship:"Y-Wing"},{name:"Andrasta",type:TITLE,done:!0,upgrades:[BOMB,BOMB],unique:!0,points:0,ship:"Firespray-31"},{name:"TIE/x1",type:TITLE,done:!0,upgrades:[SYSTEM],pointsupg:-4,points:0,ship:"TIE Advanced"},
{name:"Emperor Palpatine",type:CREW,unique:!0,takesdouble:!0,done:!0,points:8,faction:EMPIRE,init:function(){var b=this;b.unit.emperor=-1;var e=function(e,g,h,l){if(b.unit.isally(this)&&!b.unit.dead&&"undefined"!=typeof h&&b.unit.emperor<round){for(e=0;e<l.length&&l[e]==h;e++);e<l.length&&confirm("Emperor Palpatine effect\n"+g.name+": "+l[0]+" die -> "+h+" die ?")&&(b.unit.log("%0 -> %1 [%2]",l[e],h,b.name),l[e]=h,b.unit.emperor=round)}return"undefined"!=typeof h?l:g};Unit.prototype.wrap_after("rollattackdie",
b,e);Unit.prototype.wrap_after("rolldefensedie",b,e);Unit.prototype.adddicemodifier(ATTACK_M,MOD_M,ATTACK_M,this,{req:function(e,g){return b.unit.emperor<round&&activeunit.isally(b.unit)},f:function(e,g){b.unit.emperor=round;var f=FCH_focus(e),l=FCH_blank(e,g),m=FCH_hit(e);0<l?(activeunit.log("blank -> %CRIT% [%0]",b.name),e+=FCH_CRIT,b.round=round):0<f?(activeunit.log("%FOCUS% -> %CRIT% [%0]",b.name),e=e-FCH_FOCUS+FCH_CRIT):0<m&&(activeunit.log("%HIT% -> %CRIT% [%0]",b.name),e=e-FCH_HIT+FCH_CRIT);
return e},str:"crew"});Unit.prototype.adddicemodifier(DEFENSE_M,MOD_M,DEFENSE_M,this,{req:function(e,g){return!b.unit.dead&&targetunit.isally(b.unit)&&b.unit.emperor<round},f:function(e,g){b.unit.emperor=round;var f=FE_focus(e);0<FE_blank(e,g)?(targetunit.log("blank -> %EVADE% [%0]",b.name),e+=FE_EVADE):0<f&&(targetunit.log("%FOCUS% -> %EVADE% [%0]",b.name),e=e+FE_EVADE-FE_FOCUS);return e},str:"crew"})}},{name:"Extra Munitions",type:TORPEDO,limited:!0,firesnd:"missile",isWeapon:function(){return!1},
points:2,done:!0,init:function(b){for(var e=0;e<b.upgrades.length;e++){var f=b.upgrades[e];f.type.match(/Missile|Torpedo|Bomb/)&&(f.ordnance=!0)}}},{name:"Cluster Mines",type:BOMB,snd:"explode",img:"cluster.png",width:15,height:10,repeatx:42,size:22,stay:!0,done:!0,getOutlineStringsmall:function(b){var e="M ";this.op=[];"undefined"==typeof b&&(b=this.m);for(var f=0;20>f;f++){var g=transformPoint(b,{x:this.size*Math.sin(2*f*Math.PI/20),y:this.size*Math.cos(2*f*Math.PI/20)});this.op.push(g);e+=g.x+
" "+g.y+" ";0==f&&(e+="L ")}return{s:e+"Z",p:this.op}},candoaction:function(){return this.unit.lastdrop!=round&&this.isactive},action:function(b){this.actiondrop(b)},canbedropped:function(){return!1},explode:function(){},detonate:function(b){if(!this.exploded){for(var e=this.unit.rollattackdie(2,this,"hit"),f=0;2>f;f++)"hit"==e[f]&&(b.log("+1 %HIT% [%0]",this.name),b.resolvehit(1),b.checkdead());Bomb.prototype.detonate.call(this)}},display:function(b,e){this.getOutlineString=this.getOutlineStringsmall;
...
FCH_blank(h,e)?h+=f:0<FCH_focus(h)?h=h-FCH_FOCUS+f:0<FCH_crit(h)&&(h=h-FCH_HIT+f);return h})}b.adddicemodifier(ATTACK_M,MOD_M,ATTACK_M,this,{req:function(b,e){var f=this.weapons[this.activeweapon].type;return f==TORPEDO||f==MISSILE?!0:!1}.bind(b),f:function(f,g){var h=FCH_blank(f,g),l=FCH_focus(f),m=FCH_hit(f),w=FCH_HIT,x="%HIT%";this.weapons[0].isactive&&3<=this.weapons[0].getattack()&&(w=FCH_CRIT,x="%CRIT%");0<h?(b.log("+1 "+x+" [%0]",e.name),f+=w):0<l?(b.log("%FOCUS% -> "+x+" [%0]",e.name),f+=
w-FCH_FOCUS):0<m&&w==FCH_CRIT&&(b.log("%HIT% -> %CRIT% [%0]",e.name),f+=w-FCH_HIT);return f}.bind(b),str:"target"})}},{name:"TIE/v1",ship:"TIE Adv. Prototype",points:1,done:!0,init:function(b){var e=this;b.wrap_after("addtarget",this,function(b){e.isactive&&this.candoaction()&&this.candoevade()&&(this.log("free %EVADE% action [%0]",this.name),this.doselection(function(b){this.addevade(b)}.bind(this)))})},type:TITLE},{name:"Zuckuss",faction:SCUM,points:1,unique:!0,done:!0,type:CREW,init:function(b){var e=
...
{name:"Captured TIE",unique:!0,type:MOD,ship:"TIE Fighter",faction:REBEL,points:1,done:!0,init:function(b){var e=this,f=!1,g=function(){var b=0,f;for(f in squadron)squadron[f].isally(this)&&!squadron[f].dead&&b++;1==b&&e.desactivate()};b.wrap_after("declareattack",this,function(b,g,m){m&&(f=!0);e.desactivate();return m});b.wrap_after("endsetupphase",this,g);b.wrap_after("warndeath",this,g);Unit.prototype.wrap_before("dies",this,g);b.wrap_after("canbetargeted",this,function(b,g){return e.isactive?
g&&!(!f&&this.getskill()>b.getskill()):g})}},{name:"Inspiring Recruit",type:CREW,points:1,done:!0,init:function(b){var e=this;Unit.prototype.wrap_after("removestresstoken",this,function(){this.isally(b)&&2>=this.getrange(b)&&0<this.stress&&(this.log("-1 stress token [%0]",e.name),this.removestresstoken.vanilla.call(this))})}},{name:"Baze Malbus",type:CREW,points:3,unique:!0,done:!0,faction:REBEL,init:function(b){var e=this;b.addattack(function(b,e){return this.weapons[0].isactive&&0==b+e},this,[b.weapons[0]],
function(){this.noattack=round},function(){this.log("+1 attack [%0]",e.name);return this.selectnearbyenemy(3,function(b,e){return e!=targetunit})})}},{name:"Bodhi Rook",type:CREW,points:1,unique:!0,faction:REBEL,done:!0,init:function(b){b.wrap_after("gettargetableunits",this,function(b,f){var e=[],h;for(h in squadron)squadron[h].isally(this)&&(e=e.concat(Unit.prototype.gettargetableunits.vanilla.call(e,3)));return e})}},{name:"Adaptive Ailerons",type:TITLE,points:0,ship:"TIE Striker",done:!0,init:function(b){var e=
this;b.adaptive=-1;"undefined"==typeof b.facultativeailerons&&(b.facultativeailerons=!1);b.wrap_after("premove",this,function(){var b=["F1","BR1","BL1"],e=this.moves[0];this.facultativeailerons||(this.moves=[]);this.moves=this.moves.concat([this.getpathmatrix(e,b[0]),this.getpathmatrix(e,b[1]),this.getpathmatrix(e,b[2])])});b.wrap_before("beginactivation",this,function(){for(var b=this.maneuver,g=this.getdial(),h=[],l=[],m=0;m<g.length;m++)g[m].move.match(/F1|BL1|BR1/)&&(h.push(this.getpathmatrix(this.m,
g[m].move)),l.push(m));this.adaptive<round&&(this.adaptive=round,this.donoaction([{org:e,type:"TITLE",name:e.name,action:function(f){this.wrap_after("candoendmaneuveraction",this,function(){return!1}).unwrapper("cleanupmaneuver");this.wrap_after("getdial",this,function(b){for(var e=[],f=0;f<b.length;f++)e[f]={move:b[f].move,difficulty:"WHITE"};return e}).unwrapper("endmaneuver");this.wrap_before("cleanupmaneuver",e,function(){this.maneuver=b;this.cleanupmaneuver.unwrap(e);this.endnoaction(f,"TITLE");
this.hasmoved=!1;this.newlock().done(function(){this.newlock().done(nextactivation);nextactivation()}.bind(this))});this.resolveactionmove(h,function(b,e){this.maneuver=l[e];this.resolvemaneuver()}.bind(this),!1,!0)}.bind(this)}],"",this.facultativeailerons))})}},{name:"Swarm Leader",unique:!0,points:3,type:ELITE,done:!0,init:function(b){var e=this;b.wrap_after("preattackroll",this,function(b,g){var f=this.selectnearbyally(3,function(b,e){return e.canuseevade()&&e.isinfiringarc(g)?!0:!1}),l=0;0<f.length&&
(l++,f[0].removeevadetoken());1<f.length&&(l++,f[1].removeevadetoken());this.log("+%1 attack die [%0]",l,e.name);this.wrap_after("getattackstrength",this,function(b,e,f){return f+l}).unwrapper("attackroll")})}},{name:"Lightweight Frame",type:MOD,points:2,agilitymax:3,ship:"TIE",done:!0,init:function(b){var e=this;b.wrap_before("defenseroll",this,function(b,g){getattackdice()>getdefensedice()&&(this.log("+1 defense roll [%0]",e.name),this.wrap_after("getagility",e,function(b){return b+1}).unwrapper("defenseroll"))})}},
{name:"'Light Scyk' Interceptor",type:TITLE,points:-2,ship:"M3-A Interceptor",lostupgrades:[MOD],done:!0,init:function(b){this.deal=function(b,e){return $.Deferred().resolve({crit:b,face:FACEUP})};var e=[];b.installed=!0;b.wrap_after("getdial",this,function(b){if(0==e.length)for(var f=0;f<b.length;f++){var h=b[f].move,l=b[f].difficulty;h.match(/BL\d|BR\d/)&&(l="GREEN");e[f]={move:h,difficulty:l}}return e})}},{name:"Hotshot Co-Pilot",type:CREW,points:4,done:!0,init:function(b){var e=this,f=function(){if(this.canusefocus()){this.log("- %0 %FOCUS% [%1]",
...
b.points=f;b.vendor={xwsbenchmark:{builder:"Ynot Squadron Benchmark",builder_url:"http://ynot6517.github.io/bench/"}};b.version="0.3.0";return b},toJuggler:function(b){for(var e="",f=this.sortedgenerics(),g=0;g<f.length;g++)e+=f[g].toJuggler(b)+"\n";return e},parseJuggler:function(b,e){var f,g,h,l;f=-1;var m=function(b){return"REBEL"==b?1:"SCUM"==b?2:4};f=7;if(""!=b){var q=b.trim().split("\n");for(g in generics)generics[g].team==this.team&&delete generics[g];for(g=0;g<q.length;g++){var t=q[g].split(/\s+\+\s+/),
v=0;for(h=0;h<PILOTS.length;h++){l=PILOTS[h].name;var w=translate(l),x="";1==PILOTS[h].ambiguous&&"undefined"!=typeof PILOTS[h].edition&&(x="("+PILOTS[h].edition+")");w+=x;l+=x;l.replace(/\'/g,"")==t[0]&&(v|=m(PILOTS[h].faction));w.replace(/\'/g,"")==t[0]&&(v|=m(PILOTS[h].faction))}f&=v}this.faction=1==(f&1)?"REBEL":2==(f&2)?"SCUM":"EMPIRE";this.color="REBEL"==this.faction?RED:"EMPIRE"==this.faction?GREEN:YELLOW;for(g=0;g<q.length;g++){f=-1;t=q[g].split(/\s+\+\s+/);for(h=0;h<PILOTS.length;h++)if(w=
l=PILOTS[h].name,x="",PILOTS[h].faction==this.faction){w=translate(l);1==PILOTS[h].ambiguous&&"undefined"!=typeof PILOTS[h].edition&&(x="("+PILOTS[h].edition+")");l+=x;w+=x;if(l.replace(/\'/g,"")==t[0]){f=h;break}if(w.replace(/\'/g,"")==t[0]){f=h;e=!0;break}}-1==f&&console.log("pid undefined:"+e+"!!"+t[0]+"!!"+this.faction);-1==f&&log("unknown Juggler pilot:"+q[g]+"/"+b);w=new Unit(this.team,f);w.upg=[];for(h=0;10>h;h++)w.upg[h]=-1;x=[TITLE,MOD].concat(PILOTS[w.pilotid].upgrades);for(h=1;h<t.length;h++)for(l=
0;l<UPGRADES.length;l++)if(1==e&&translate(UPGRADES[l].name).replace(/\'/g,"").replace(/\(Crew\)/g,"")==t[h]||UPGRADES[l].name.replace(/\'/g,"")==t[h]){if(-1<x.indexOf(UPGRADES[l].type)){"undefined"!=typeof UPGRADES[l].upgrades&&("Cannon|Torpedo|Missile"==UPGRADES[l].upgrades[0]?(x=x.concat(["Cannon","Torpedo","Missile"]),w.upgradetype=w.upgradetype.concat(["Cannon","Torpedo","Missile"])):(x=x.concat(UPGRADES[l].upgrades),""!=typeof UPGRADES[l].upgrades&&(w.upgradetype=w.upgradetype.concat(UPGRADES[l].upgrades))));
break}l==UPGRADES.length&&log("UPGRADE undefined: "+t[h])}for(h=1;h<t.length;h++)for(l=0;l<UPGRADES.length;l++)if(1==e&&translate(UPGRADES[l].name).replace(/\'/g,"").replace(/\(Crew\)/g,"")==t[h]||UPGRADES[l].name.replace(/\'/g,"")==t[h])if(-1<x.indexOf(UPGRADES[l].type)){for(f=0;f<w.upgradetype.length;f++)if(w.upgradetype[f]==UPGRADES[l].type&&-1==w.upg[f]){w.upg[f]=l;break}break}else log("** "+t[h]+" UPGRADE not listed: "+UPGRADES[l].type+" in "+w.name)}}},parseASCII:function(b){b=b.split(";");
...
m;break}1<f.length&&(f=f[1].split(","),h.tx=parseInt(f[0],10),h.ty=parseInt(f[1],10),h.alpha=parseInt(f[2],10))}},parseJSON:function(b,e){var f,g={rebel:REBEL,scum:SCUM,imperial:EMPIRE};try{f=$.parseJSON(b),ga("send","event",{eventCategory:"social",eventAction:"receive",eventLabel:"xws"})}catch(y){return this.parseJuggler(b,e)}var h,l,m;this.name=f.name;this.points=f.points;this.faction=g[f.faction];this.color="REBEL"==this.faction?RED:"EMPIRE"==this.faction?GREEN:YELLOW;for(h in generics)generics[h].team==
this.team&&delete generics[h];for(h=0;h<f.pilots.length;h++){var q=f.pilots[h],t,g=-1;q.team=this.team;for(l=0;l<PILOTS.length;l++)if(PILOTS[l].faction==this.faction&&PILOTS[l].unit==PILOT_dict[q.ship]&&(va=PILOTS[l].name,va==PILOT_dict[q.name])){g=l;break}if(-1==g)throw"pid undefined:"+PILOT_dict[q.name];t=new Unit(this.team,g);t.upg=[];for(l=0;10>l;l++)t.upg[l]=-1;if("undefined"!=typeof q.upgrades){var v=0;for(l in q.upgrades){var w=q.upgrades[l];for(m=0;m<w.length;m++){v++;for(var x=0;x<UPGRADES.length;x++)if(UPGRADES[x].name==
UPGRADE_dict[w[m]]){for(g=0;g<t.upgradetype.length;g++)if(t.upgradetype[g]==UPGRADES[x].type&&-1==t.upg[g]){t.upg[g]=x;break}break}}}}}}};var Resample=function(b){function e(){throw"not found: "+this.src;}function f(){var e=this._width,f=this._height,q=this._onresample,t=Math.min(this.height,this.width);null==e&&(e=h(this.width*f/this.height));null==f&&(f=h(this.height*e/this.width));delete this._onresample;delete this._width;delete this._height;b.width=e;b.height=f;g.drawImage(this,0,0,t,t,0,0,e,f);q(b.toDataURL("image/png"))}var g=b.getContext("2d"),h=Math.round;return function(b,g,h,t){var l="string"==typeof b,m=l||b;l&&(m=new Image,
m.onload=f,m.onerror=e);m._onresample=t;m._width=g;m._height=h;l?m.src=b:f.call(b)}}(this.document.createElement("canvas"));(function(){var b,e={settings:{bod:$("#setting"),img:$("#profile-avatar"),fileInput:$("#uploader")},init:function(){b=e.settings;var f;b.bod.on("dragover",function(g){clearTimeout(f);g.currentTarget==b.bod[0]&&e.showDroppableArea();return!1});b.bod.on("dragleave",function(g){g.currentTarget==b.bod[0]&&(f=setTimeout(function(){e.hideDroppableArea()},200))});b.bod.on("drop",function(b){b.preventDefault();e.handleDrop(b.dataTransfer.files)});b.fileInput.on("change",function(b){e.handleDrop(b.target.files)})},
...
function attackwithreroll(b,e,f){var g,h,l,m,q,t,v,w,x=[];if(0==b.reroll||"undefined"==typeof b.reroll)return e;for(g=0;g<=f;g++)for(h=0;h<=f-g;h++)for(l=0;l<=f-h-g;l++)v=100*g+h+10*l,x[v]=0;var y,z;for(g=0;g<=f;g++)for(h=0;h<=f-g;h++)for(l=0;l<=f-h-g;l++)if(v=100*g+h+10*l,m=f-h-l-g,z=b.reroll,y=g,b.reroll>m&&(0==b.focus?b.reroll>g+m?(z=g+m,y=0):y=g-(z-m):z=m),0==z)x[v]+=e[v];else for(m=0;m<=z;m++)for(q=0;q<=z-m;q++)for(t=0;t<=z-m-q;t++)w=100*m+q+10*t,k=100*(y+m)+h+q+10*(l+t),x[k]+=e[v]*ATTACK[z][w];
return x}function defendwithreroll(b,e,f){var g,h,l,m,q,t,v=[];if(0==b.reroll||"undefined"==typeof b.reroll)return e;for(g=0;g<=f;g++)for(h=0;h<=f-g;h++)v[10*g+h]=0;var w,x;for(g=0;g<=f;g++)for(h=0;h<=f-g;h++)if(q=10*g+h,l=f-h-g,x=b.reroll,w=g,b.reroll>l&&(0==b.focus?b.reroll>g+l?(x=g+l,w=0):w=g-(x-l):x=l),0==x)v[q]+=e[q];else for(l=0;l<=x;l++)for(m=0;m<=x-l;m++)t=10*l+m,k=10*(w+l)+h+m,v[k]+=e[q]*DEFENSE[x][t];return v}
function tohitproba(b,e,f,g,h,l,m){var q=[],t,v,w,x,y,z,D,B,E=0,J=0,K=0,L=h;h=0==m?[]:h;for(v=0;v<=l;v++)for(w=0;w<=l-v;w++)y=v+10*w,q[y]=0;if("undefined"==typeof g)return{proba:[],tohit:0,meanhit:0,meancritical:0,tokill:0};g=attackwithreroll(b,g,l);0<m&&(L=defendwithreroll(f,h,m));for(h=0;h<=l;h++)for(v=0;v<=l-h;v++)for(w=0;w<=l-v-h;w++){D=FCH_FOCUS*h+FCH_CRIT*w+FCH_HIT*v;var F,G,H,N=b.focus,O=b.reroll,I=g[FCH_FOCUS*h+FCH_HIT*v+FCH_CRIT*w];"undefined"!=typeof e.modifyattackroll&&(D=e.modifyattackroll(D,
l,f));"undefined"!=typeof b.modifyattackroll&&(D=b.modifyattackroll(D,l,f));y=FCH_focus(D);F=FCH_crit(D);D=FCH_hit(D);0<b.focus&&0<y&&(D+=y,b.focus--);for(G=0;G<=m;G++)for(H=0;H<=m-G;H++){var Q=f.evade,R=f.focus;y=FE_FOCUS*G+FE_EVADE*H;"undefined"!=typeof f.modifydefenseroll&&(y=f.modifydefenseroll(b,y,m));t=FE_focus(y);B=FE_evade(y);x=0==m?1:L[y];y=0;0<f.focus&&0<t&&B<D+F&&(B+=t,f.focus--);0<f.evade&&B<D+F&&(B+=1,f.evade--);D>B?(y=FCH_HIT*(D-B),B=0):B-=D;F>B&&(y+=FCH_CRIT*(F-B));"function"==typeof e.modifyhit&&
0<y&&(y=e.modifyhit(y));b.reroll=0;if("undefined"!=typeof e.immediateattack&&e.immediateattack.pred(y)&&"undefined"==typeof b.iar){b.iar=!0;t=e.immediateattack.weapon();B=b.gethitrange(t,f);if(3>=B&&0<B){B=b.getattackstrength(t,f);var M=f.getdefensestrength(t,b);B=tohitproba(b,b.weapons[t],f,b.getattacktable(B),f.getdefensetable(M),B,M);for(z in B.proba)t=y+1*z,"undefined"==typeof q[t]&&(q[t]=0),q[t]+=B.proba[z]*I*x}else q[y]+=I*x;delete b.iar}else q[y]+=I*x;f.focus=R;f.evade=Q}b.focus=N;b.reroll=
O}for(v=0;v<=l;v++)for(w=0;w<=l-v;w++)y=FCH_HIT*v+FCH_CRIT*w,0<y&&(E+=q[y]),J+=v*q[y],K+=w*q[y];return{proba:q,tohit:Math.floor(1E4*E)/100,meanhit:0==E?0:Math.floor(100*J)/100,meancritical:0==E?0:Math.floor(100*K)/100}};var cmd=[],startreplayall=function(){if(0!=REPLAY.length&&(FAST="W"==REPLAY.substr(-1)?!1:!0,ANIM=REPLAY,cmd=LZString.decompressFromEncodedURIComponent(decodeURI(window.location.search.substr(1))).split("&")[6].split("_"),cmd.splice(0,1),0!=cmd.length)){$(".nextphase").prop("disabled",!0);$(".unit").css("cursor","pointer");actionrlock=$.Deferred();actionrlock.progress(replayall);1==TEAMS[1].isia&&TEAMS[1].setia();1==TEAMS[2].isia&&TEAMS[2].setia();subphase=ACTIVATION_PHASE;for(i in squadron)squadron[i].hasmoved=
...
var AIstats=function(b,e,f){if("undefined"!=typeof f.rows)for(b=1;b<f.rows.length;b+=200){for(var g=e=0,h=1;200>h&&h+b<f.rows.length;h++){var l=f.rows[b+h].cellsArray[0].split(" "),m=l[0].split(":"),q=m[0],m=m[1],t=l[1].split(":"),l=t[0],t=t[1],v=0,w=0;l!=q&&("Human"==l?w+=parseInt(t,10):v+=parseInt(t,10),"Human"==q?w+=parseInt(m,10):v+=parseInt(m,10),g+=Math.floor(v/(v+w)*100),e++)}console.log(g/e)}},mk2split=function(b){b=b.split(".");for(var e=[],f=!1,g=1;g<b.length;g++)b[g].match(/_II.*/)?(e.push(b[g-
1]+"."+b[g]),b[g]=null,f=!1):(b[g-1]&&e.push(b[g-1]),f=!0);f&&e.push(b[b.length-1]);return e},save=function(){movelog("W");var b="http://gdphelps.github.io/X-Wing-Sim/?"+permalink(!1);$(".social").html(Mustache.render(TEMPLATES.social,{url:b,name:"save this link",encodedurl:encodeURI(b)}))},myCallback=function(b,e,f){if(null!=f&&"undefined"!=typeof f.rows){ga("send","event",{eventCategory:"interaction",eventAction:"battlelog",eventLabel:"battlelog",eventValue:f.rows.length});e=b="";for(var g=mk2split(SEARCHINGSQUAD),
h=0;h<g.length;h++)b+=g[h].replace(/\*/g," + ").replace(/_/g," ")+"<br>",e+=g[h].replace(/\*/g," + ").replace(/_/g," ")+"\n";stype="";TEAMS[1].parseJuggler(e,!1);for(h=1;h<f.rows.length;h++)myTemplate(h,f.rows[h].cellsArray,null,null);SQUADBATTLE.columns.adjust().draw()}},myTemplate=function(b,e,f,g){g=e[0].split(" ");f=g[0].split(":");b=f[0];f=f[1];var h=g[1].split(":");g=h[0];var h=h[1],l=e[1].split("VS"),m=mk2split(l[0]),q=mk2split(l[1]),t="",v="";if(l[0]==SEARCHINGSQUAD){var l=h,w=g,m=q,h=f;g=
b;f=l;b=w}for(q=0;q<m.length-1;q++)v+=m[q].replace(/\*/g," + ").replace(/_/g," ")+"\n",t+=m[q].replace(/\*/g," + ").replace(/_/g," ")+"<br>";TEAMS[2].parseJuggler(v,!1);"en"!=LANG&&(t=TEAMS[2].toJuggler(!0).replace(/\n/g,"<br>"));f=""+f;h=""+h;for(m=0;3>m;m++)3>f.length&&(f="0"+f),3>h.length&&(h="0"+h);"Human"==g&&(h="<b>"+h+"</b>");"Human"==b&&(f="<b>"+f+"</b>");SQUADBATTLE.row.add([h+"-"+f,'<span onclick=\'$(".replay").attr("src","'+e[2]+"\")'>"+t+"</span>"]).draw(!1)},computeurl=function(b,e,f){b=
[];if("undefined"!=typeof f.rows)for(var g=1;g<f.rows.length;g++){var h=f.rows[g].cellsArray[0].split("VS");e=mk2split(h[0]);for(var h=mk2split(h[1]),l="",m="",q=0;q<e.length-1;q++)l+=e[q].replace(/\*/g," + ").replace(/_/g," ")+"\n";try{TEAMS[1].parseJuggler(l,!1);for(q=0;q<h.length-1;q++)m+=h[q].replace(/\*/g," + ").replace(/_/g," ")+"\n";TEAMS[2].parseJuggler(m,!1)}catch(t){}for(q in generics)"undefined"==typeof b[generics[q].pilotid]&&(b[generics[q].pilotid]=0),b[generics[q].pilotid]++}for(g in b)console.log(PILOTS[g].name+
":"+b[g])};
...
function cancelroll(b,e,f){if(f==DEFENSE_M)return cancelrolld(b,e);f=getattackdice();var g=$(".focusreddice").length,h=$(".hitreddice").length,l=$(".criticalreddice").length;b=b(100*g+10*l+h,f);displaydefenseroll(b.m,b.n);$("#atokens #mod"+e).remove()}function cancelrolld(b,e){var f=getdefensedice(),g=$(".focusgreendice").length,h=$(".evadegreendice").length,f=b(10*g+h,f);displaydefenseroll(f.m,f.n);$("#dtokens #mod"+e).remove()}
...
function reroll(b,e,f,g,h){var l,m,q=0,t=["blank","focus","hit","critical"],v=["blank","focus","evade"];"function"==typeof g.f&&g.f();var w="";if(f==ATTACK_M){for(l=0;4>l;l++)if((!activeunit.hasnorerollmodifiers(e,f,getattackvalue(),getattackdice(),"focus")||"undefined"!=typeof g.mustreroll||"focus"!=t[l])&&-1<g.dice.indexOf(t[l]))if(m=$("."+t[l]+"reddice:not([noreroll])"),m.length<b)m.remove(),w+=("<span class='"+t[l]+"reddice'></span>").repeat(m.length),q+=m.length,b-=m.length;else{$("."+t[l]+"reddice:lt("+
b+"):not([noreroll])").remove();w+=("<span class='"+t[l]+"reddice'></span>").repeat(b);q+=b;b=0;break}w+=" -> ";$("#atokens #reroll"+h).remove();b=activeunit.rollattackdie(q);for(l=0;l<q;l++)w+="<span class='"+b[l]+"reddice'></span>",$("#attack").append("<td class='"+b[l]+"reddice' noreroll></td>");addredclickchange()}else{for(l=0;3>l;l++)if(("undefined"!=typeof g.mustreroll||!targetunit.hasnorerollmodifiers(e,f,getattackvalue(),getattackdice(),"focus")||"focus"!=t[l])&&-1<g.dice.indexOf(v[l]))if(m=
$("."+v[l]+"greendice:not([noreroll])"),m.length<b)m.remove(),q+=m.length,b-=m.length;else{$("."+t[l]+"greendice:lt("+b+"):not([noreroll])").remove();q+=b;b=0;break}$("#dtokens #reroll"+h).remove();activeunit.defenseroll(q).done(function(b){var e;for(e=0;e<FE_evade(b.roll);e++)$("#defense").append("<td class='evadegreendice'></td>");for(e=0;e<FE_focus(b.roll);e++)$("#defense").append("<td class='focusgreendice'></td>");for(e=0;e<FE_blank(b.roll,b.dice);e++)$("#defense").append("<td class='blankgreendice'></td>");
...
function win(b){log("Team "+b+" was destroyed!");movelog("W");var e="m-draw",f,g="",h="",l=0,m=0,q=!1,t=!1;for(f=0;f<allunits.length;f++){var v=allunits[f];v.dead||1!=v.team||(q=!0);v.dead||2!=v.team||(t=!0);if(v.dead||v.islarge&&v.shield+v.hull<(v.ship.hull+v.ship.shield)/2){var w=parseInt(v.dead?v.points:v.points/2);1==v.team?(h+="<tr><td>"+v.name+(v.dead?"":" (1/2 points)")+"</td><td>"+w+"</td></tr>",m+=w):(g+="<tr><td>"+v.name+(v.dead?"":" (1/2 points)")+"</td><td>"+w+"</td></tr>",l+=w)}}0==q&&
(m=100);0==t&&(l=100);""==g&&(g="<tr><td class='m-nocasualty'></td><td>0</td></tr>");""==h&&(h="<tr><td class='m-nocasualty'></td><td>0</td></tr>");q=l-m;l=q+100;m=100-q;$(".victory-table").empty();$(".victory-table").append("<tr><th class='m-squad1'></th><th>"+l+"</th></tr>");$(".victory-table").append(g);$(".victory-table").append("<tr><th class='m-squad2'></th><th>"+m+"</th></tr>");$(".victory-table").append(h);if(0<q&&0>WINCOND||2==b&&(WINCOND<round||0==WINCOND))e="m-1win",log("Team 1 wins! "+
l+" to "+m);else if(0>q&&0>WINCOND||1==b&&(WINCOND<round||0==WINCOND))e="m-2win",log("Team 2 wins! "+m+" to "+l);$(".victory").attr("class",e);b=(TEAMS[1].isia?"Computer":"Human")+":"+l+" "+(TEAMS[2].isia?"Computer":"Human")+":"+m;e=TEAMS[1].toJuggler(!1);e+="VS"+TEAMS[2].toJuggler(!1);e=e.replace(/\n/g,".");e=e.replace(/ \+ /g,"*");e=e.replace(/ /g,"_");g=encodeURI("https://gdphelps.github.io/X-Wing-Sim/index.html?"+permalink(!1));$("#submission").contents().find("#entry_209965003").val(b);$("#submission").contents().find("#entry_390767903").val(e);
$("#submission").contents().find("#entry_245821581").val("no short url");$("#submission").contents().find("#entry_1690611500").val(g);$(".tweet").hide();save();for(f in["email","facebook","tweet","googlep"])(function(b){$("."+b).click(function(){ga("send","event",{eventCategory:"social",eventAction:"send",eventLabel:b})})})(f);$(".victory-link").attr("href",g);window.location="#modal"}document.addEventListener("win",win,!1);
function battlelog(b){b=SQUADLIST.row(b.parents("tr")).data()[3];TEAMS[0].parseJuggler(b,!1);b=TEAMS[0].toJuggler(!1);displaycombats(b);window.location="#battlelog"}
function createsquad(){$(".activeunit").prop("disabled",!0);$("#selectphase").hide();$("#addcomment").hide();ga("send","event",{eventCategory:"interaction",eventAction:"create",eventLabel:"create"});phase=CREATION_PHASE;$("footer").hide();$(".fTab").hide();$("#consolecb").removeAttr("Checked");$(".nextphase").prop("disabled",!1);currentteam.changefaction("REBEL");$(".factionselect selected").val("REBEL");$("#creation").show();var b={getdial:function(){return[{move:"TL1",difficulty:"WHITE"},{move:"BL1",
difficulty:"WHITE"},{move:"F1",difficulty:"WHITE"},{move:"SL2",difficulty:"WHITE"},{move:"TL2",difficulty:"WHITE"},{move:"BL2",difficulty:"WHITE"},{move:"F2",difficulty:"WHITE"},{move:"K2",difficulty:"WHITE"},{move:"SL3",difficulty:"WHITE"},{move:"TL3",difficulty:"WHITE"},{move:"BL3",difficulty:"WHITE"},{move:"F3",difficulty:"WHITE"},{move:"K3",difficulty:"WHITE"},{move:"F4",difficulty:"WHITE"},{move:"K4",difficulty:"WHITE"},{move:"F5",difficulty:"WHITE"},{move:"K5",difficulty:"WHITE"}]}};$("#dialfilter").html(Unit.prototype.getdialstring.call(b));
...
b.upg[f];-1<g&&addupgrade(b,g,f)}}}function switchdialimg(b){1==b?($("#caroussel .shipimg").css("display","none"),$("#caroussel .shipdial").css("display","table-cell")):($("#caroussel .shipdial").css("display","none"),$("#caroussel .shipimg").css("display","table-cell"))}
function SwitchToCardDetails(b){b?($("#caroussel .shipimg").css("display","none"),$("#caroussel .shipdial").css("display","table-cell")):($("#caroussel .shipdial").css("display","none"),$("#caroussel .shipimg").css("display","table-cell"))}var mySpreadsheets=["https://docs.google.com/spreadsheets/d/1KR1uc7QgbiDkxCU5J1rm9qBMMjwKC0WyfAuDhnrbgAA/edit#gid=0"];
...
function displayfactionunits(b){var e=0,f=0,g,h,l,m=currentteam.faction,q={},t=[];if(phase==CREATION_PHASE){"REBEL"==m?$("#dialfilter td[move='SL3']").text(P.TRL3.key).attr("move","TRL3"):$("#dialfilter td[move='TRL3']").text(P.SL3.key).attr("move","SL3");for(g in unitlist)-1<unitlist[g].faction.indexOf(m)&&e++;1==b?$("#caroussel").html(""):$(".caroussel").html("");for(g=0;g<PILOTS.length;g++){var v=PILOTS[g].unit;PILOTS[g].faction==m&&("undefined"==typeof q[v]&&(q[v]=[]),-1<PILOTS[g].upgrades.indexOf(ELITE)&&
(PILOTS[g].haselite=!0),b=getpilottexttranslation(PILOTS[g],m),""!=b&&(b+=1==PILOTS[g].done?"":"<div><strong class='m-notimplemented'></strong></div>"),PILOTS[g].tooltip=b,PILOTS[g].trname=translate(PILOTS[g].name),q[v].push(PILOTS[g]))}for(v in q)q[v].sort(function(b,e){return b.points-e.points});for(g in unitlist)-1<unitlist[g].faction.indexOf(m)&&(unitlist[g].trname=SHIP_translation[g],unitlist[g].name=g,"undefined"==typeof unitlist[g].trname&&(unitlist[g].trname=g),t.push(unitlist[g]));t.sort(function(b,
e){return b.trname>e.trname});for(g=0;g<t.length;g++){f++;v=t[g];b=q[v.name];var w=q[v.name][0].upgrades,e=!0;for(h in UNITFILTER)-1==w.indexOf(h)&&(e=!1);for(h in ACTIONFILTER)-1==v.actionList.indexOf(h)&&(e=!1);if(""!=TEXTFILTER){b=[];for(l in q[v.name]){var w=q[v.name][l],x=getpilottexttranslation(w,m),y=translate(w.name),z=new RegExp(TEXTFILTER,"i");(x.match(z)||y.match(z))&&b.push(w)}0==b.length&&(e=!1)}for(h in MOVEFILTER){w=!1;for(l=0;l<v.dial.length;l++)v.dial[l].move==h&&(w=!0);w||(e=!1)}e&&
(b=Mustache.render(TEMPLATES.faction,{shipimg:v.img[0],fire:repeat("u",v.fire),evade:repeat("u",v.evade),hull:repeat("u",v.hull),shield:repeat("u",v.shield),diallist:dial2JSON(v.dial),shipname:v.trname,primary:v.weapon_type,actionlist:function(){var b=[];for(h=0;h<v.actionList.length;h++)b[h]=A[v.actionList[h]].key;return b},hastitle:v.hastitle,shipupgrades:q[v.name][0].upgrades,pilots:b}),$("#caroussel").append("<li>"+b+"</li>"))}}}
...
function addupgradeaddhandler(b){$("#unit"+b.id+" button.upgrades").click(function(b){var e=b.currentTarget.getAttribute("class").split(" ")[1];b=b.currentTarget.getAttribute("num");var g=this.getupgradelist(e);$("#unit"+this.id+" .upgs .upgavail").hide();$("#unit"+this.id+" .upgs .upg").hide();"undefined"==typeof this.upgbonus[e]&&(this.upgbonus[e]=0);for(var h=[],l=0;l<g.length;l++){var m=UPGRADES[g[l]],q,t=[];if(!m.invisible){q=1==UNIQUE[m.name]||(1==m.limited||1==this.exclupg[m.type])&&0<$("#unit"+
this.id+" .upg tr[data="+g[l]+"]").length;var v=m.points+this.upgbonus[e];0<m.points&&0>v&&(v=0);var w=formatstring(getupgtxttranslation(m.name,m.type));1!=m.done&&(w+="<div><strong class='m-notimplemented'></strong></div>");"undefined"!=typeof m.attack&&(t=[{attack:m.attack,lrange:m.range[0],hrange:m.range[1]}]);h.push({pts:v,tooltip:[w],text:w,isdisabled:q,num:b,data:g[l],name:translate(m.name).replace(/\(Crew\)/g,""),attacks:t})}}$("#unit"+this.id+" .upglist").html(Mustache.render(TEMPLATES["upglist-creation"],
...
1==PILOTS[e.pilotid].unique&&removeunique(e.name);$("#unit"+b).remove();delete generics["u"+b];currentteam.updatepoints()});$("#unit"+e.id+" .duplicate").click(function(){var b=$(this).attr("data"),e=generics["u"+b],h=addunit(e.pilotid);$("#unit"+b+" .upg tr[data]").each(function(){var b=$(this).attr("data"),f=$(this).attr("num");1!=UPGRADES[b].unique&&e.upgnocopy!=b&&addupgrade(h,b,f)})});$("#unit"+e.id+" .dialopen").click(function(){var b=$(this).attr("data");$("#unit"+b+" .upg").hide();$("#unit"+
b+" .upglist").hide();$("#unit"+b+" .upgavail").hide();$("#unit"+b+" .statlist").hide();$("#unit"+b+" .shipdial").show();$("#unit"+b+" .movelist").hide()});$("#unit"+e.id+" .upgradelists").click(function(){var b=$(this).attr("data");$("#unit"+b+" .upg").show();$("#unit"+b+" .upglist").empty();$("#unit"+b+" .upglist").show();$("#unit"+b+" .upgavail").show();$("#unit"+b+" .statlist").hide();$("#unit"+b+" .shipdial").hide();$("#unit"+b+" .movelist").hide()});$("#unit"+e.id+" .moves").click(function(){var b=
$(this).attr("data"),e=generics["u"+b];$("#unit"+b+" .upg").hide();$("#unit"+b+" .upglist").hide();$("#unit"+b+" .upgavail").hide();$("#unit"+b+" .statlist").hide();$("#unit"+b+" .shipdial").hide();$("#unit"+b+" .movelist").show();var h=Snap("#unit"+b+" .movesvg");$("#unit"+b+" .statbutton");h.clear();var l=$(".movesvg").width();targetunit=new Unit(0,13);for(var m in metaUnit.prototype)targetunit[m]=metaUnit.prototype[m];e.moves=[MT(l/2,l/2)];e.doactivation();e.s=h;setTimeout(function(){for(m in e.moves)h.path(e.getOutlineString(e.moves[m]).s).attr({"stroke-width":5,
stroke:"#0a0",opacity:.5,fill:"rgba(0,0,0,0)",pointerEvents:"none"});h.path(e.getOutlineString(MT(l/2,l/2)).s).attr({"stroke-width":5,stroke:"#a00",opacity:1,fill:"rgba(0,0,0,0)",pointerEvents:"none"})})});$("#unit"+e.id+" .statistics").click(function(){var b=$(this).attr("data"),e=generics["u"+b];$("#unit"+b+" .upg").hide();$("#unit"+b+" .upglist").hide();$("#unit"+b+" .upgavail").hide();$("#unit"+b+" .statlist").show();$("#unit"+b+" .shipdial").hide();$("#unit"+b+" .movelist").hide();var h=Snap("#unit"+
b+" .statisticsvg");$("#unit"+b+" .statbutton");h.clear();var l=$(".statisticsvg").width();targetunit=new Unit(0,13);for(var m in metaUnit.prototype)targetunit[m]=metaUnit.prototype[m];e.moves=[MT(l/2,l/2)];e.doactivation();e.s=h;var q=h.text(0,0,"Computing...").attr({"font-size":50,stroke:WHITE});setTimeout(function(){e.showattack(e.weapons,h);q.attr({display:"none"});h.path(e.getOutlineString(MT(l/2,l/2)).s).attr({"stroke-width":5,stroke:"#0a0",opacity:.5,fill:"rgba(0,0,0,0)",pointerEvents:"none"});
for(m=1;5>=m;m++)h.path(e.getRangeString(m,MT(l/2,l/2))).attr({"stroke-width":5,stroke:"#0a0",opacity:.5,fill:"rgba(0,0,0,0)",pointerEvents:"none","stroke-dasharray":"5,5"});var b=h.gradient("l(0,0,0,1)hsl(0,80,50)-hsl(60,100,50)-hsl(120,100,25)");h.rect(-400,-500,30,800).attr({fill:b});h.text(-350,-450,"100%").attr({"font-size":50,stroke:WHITE});h.text(-350,-75,"50%").attr({"font-size":50,stroke:WHITE});h.text(-350,300,"0%").attr({"font-size":50,stroke:WHITE})},30)});currentteam.updatepoints();addupgradeaddhandler(e);
return e}
function addupgrade(b,e,f,g){var h=UPGRADES[e];$("#unit"+b.id+" .upglist").empty();if("undefined"!=typeof h){1==h.unique&&addunique(h.name);1==h.limited&&addlimited(b,e);$("#unit"+b.id+" .upgavail span[num="+f+"]").css("display","none");var l=translate(h.name).replace(/\(Crew\)/g,"").replace(/\'/g,"");"undefined"==typeof b.upgbonus[h.type]&&(b.upgbonus[h.type]=0);var m=h.points+b.upgbonus[h.type];0<=h.points&&0>m&&(m=0);var q="",t=formatstring(getupgtxttranslation(h.name,h.type));""!=t&&(q="<div class='tooltip'>"+
t+(1==h.done?"":"<div><strong class='m-notimplemented'></strong></div></div>"));$("#unit"+b.id+" .upg").append("<tr data="+e+" num="+f+"><td><code class='upgrades "+h.type+"'></code></td><td>"+l+q+"</td><td class='pts'>"+m+"<button class='removeupg'>-</button></td></tr>");b.upg[f]=e;Upgrade.prototype.install.call(h,b);"undefined"!=typeof h.install&&h.install(b);$("#unit"+b.id+" .shipdial").html("<table>"+b.getdialstring()+"</table>");b.showupgradeadd();b.showactionlist();b.showstats();currentteam.updatepoints();
"undefined"==typeof g?($("#unit"+b.id+" .upg tr[num="+f+"] button").click(function(e){var f=e.currentTarget.parentElement.parentElement.getAttribute("num");e=e.currentTarget.parentElement.parentElement.getAttribute("data");$("#unit"+b.id+" .upglist").empty();removeupgrade(b,f,e)}.bind(b)),$("#unit"+b.id+" .upg tr[num="+f+"] button").click(function(e){var f=e.currentTarget.parentElement.parentElement.getAttribute("num");e=e.currentTarget.parentElement.parentElement.getAttribute("data");$("#unit"+b.id+
" .upglist").empty();removeupgrade(b,f,e)}.bind(b))):b.upgnocopy=e}}
...
jwerty.key("alt+shift+5",function(){0<activeunit.ionized&&activeunit.removeiontoken()});jwerty.key("alt+shift+6",function(){0<activeunit.tractorbeam&&activeunit.removetractorbeamtoken()});jwerty.key("alt+f",function(){var b="";for(f in activeunit.actionsdone)b+=activeunit.actionsdone[f]+" ";activeunit.log("actions done:"+b)});jwerty.key("alt+d",function(){activeunit.resolvehit(1)});jwerty.key("alt+c",function(){activeunit.resolvecritical(1)});jwerty.key("alt+shift+d",function(){activeunit.hull<activeunit.ship.hull?
activeunit.addhull(1):activeunit.shield<activeunit.ship.shield&&activeunit.addshield(1);activeunit.show()});for(f in squadron)squadron[f].beginsetupphase();0<SETUPS.asteroids&&loadrock(s,ROCKDATA);log("<div>["+UI_translation["turn #"]+round+"]"+UI_translation["phase"+phase]+"</div>");$(".unit").css("cursor","move");$("#positiondial").show();$(".permalink").show();$("footer").show();$(".fTab").show();$("#savebtn").hide();1!=b&&startreplayall();break;case PLANNING_PHASE:active=0;actionr=[$.Deferred().resolve()];
...
b="";if("en"!=LANG){for(q in ENUPGRADE_translation){f=ENUPGRADE_translation[q];var m=UPGRADE_translation[q];"undefined"==typeof m&&(UPGRADE_translation[q]=f)}for(q in ENPILOT_translation)f=ENPILOT_translation[q],m=PILOT_translation[q],"undefined"==typeof m&&(PILOT_translation[q]=f)}for(var q in h)b+="."+q+'::after { content:"'+h[q]+'";}\n';$("#localstrings").html(b);UPGRADE_dict=g[0].upgrades;PILOT_dict=g[0].pilots;for(var t in PILOT_dict){for(q=0;q<PILOTS.length;q++)PILOTS[q].name==PILOT_dict[t]&&
(PILOTS[q].dict=t);for(q in unitlist)q==PILOT_dict[t]&&(unitlist[q].dict=t)}for(q=0;q<UPGRADES.length;q++)f=UPGRADES[q],f.type==TITLE&&(unitlist[f.ship].hastitle=!0);for(q=0;q<PILOTS.length;q++){g=!1;for(t in PILOT_dict)if(PILOTS[q].name==PILOT_dict[t]){g=!0;break}g||log("no xws translation for "+PILOTS[q].name)}for(q=0;q<UPGRADES.length;q++){g=!1;for(t in UPGRADE_dict)if(UPGRADES[q].name==UPGRADE_dict[t]){g=!0;break}g||log("no xws translation for "+UPGRADES[q].name)}squadron=[];s.attr({width:"100%",
height:"100%",viewBox:"0 0 900 900"});TEAMS[1].setfaction("REBEL");TEAMS[2].setfaction("EMPIRE");g=f=t=0;b="";for(q=0;q<PILOTS.length;q++)1==PILOTS[q].done&&(PILOTS[q].unique&&f++,t++),PILOTS[q].done||(b=PILOTS[q].unique?b+", .":b+", ",b+=PILOTS[q].name);log(t+"/"+PILOTS.length+" pilots with full effect");""!=b&&log("Pilots NOT implemented"+b);t=0;b="";for(q=0;q<UPGRADES.length;q++)UPGRADES[q].invisible||(1==UPGRADES[q].done?t++:b+=(""==b?"":", ")+(UPGRADES[q].unique?".":"")+UPGRADES[q].name,g++);
$(".ver").html(VERSION);log(t+"/"+g+" upgrades with full effect");log("Upgrades NOT working yet:"+b);$("#showproba").prop("disabled",!0);"undefined"==typeof localStorage.volume&&(localStorage.volume=.8);"undefined"!=typeof localStorage.image&&$("#profile-avatar").attr("src",localStorage.image);"undefined"!=typeof localStorage.name?$("#nameinput").val(localStorage.name):$("#nameinput").val("Human");Howler.volume(localStorage.volume);$("#vol").val(100*localStorage.volume);var v=new Hammer(document.getElementById("svgout"));
v.get("pinch").set({enable:!0});v.get("pan").set({direction:Hammer.DIRECTION_ALL});v.on("panleft panright panup pandown",function(b){"svgout"==b.target.id&&1!=activeunit.dragged&&($("#svgout").css("cursor","-webkit-grabbing"),viewport_translate(b.deltaX-LAST_PAN_DELTA[0],b.deltaY-LAST_PAN_DELTA[1]),LAST_PAN_DELTA=[b.deltaX,b.deltaY])});v.on("panend",function(b){"svgout"==b.target.id&&1!=activeunit.dragged&&(LAST_PAN_DELTA=[0,0],$("#svgout").css("cursor","-webkit-grab"))});TEMPLATES["unit-creation"]=
$("#unit-creation").html();Mustache.parse(TEMPLATES["unit-creation"]);TEMPLATES["upglist-creation"]=$("#upglist-creation").html();Mustache.parse(TEMPLATES["upglist-creation"]);TEMPLATES.faction=$("#faction").html();Mustache.parse(TEMPLATES.faction);TEMPLATES.usabletokens=$("#usabletokens").html();Mustache.parse(TEMPLATES.usabletokens);TEMPLATES.selectweapon=$("#selectweapon").html();Mustache.parse(TEMPLATES.selectweapon);v.zoom=1;v.on("pinch",function(b){if("svgout"==b.target.id&&1!=activeunit.dragged){var e=
VIEWPORT.m.clone().invert(),f=e.x(b.center.x,b.center.y),e=e.y(b.center.x,b.center.y);VIEWPORT.m.translate(f,e).scale(b.scale).scale(1/v.zoom).translate(-f,-e);v.zoom=b.scale;VIEWPORT.transform(VIEWPORT.m);activeunit.show();b["final"]&&(v.zoom=1)}});$("aside").on("scroll touchmove touchstart mousewheel",scrolloverflow);$("#squadbattle").html("<thead><tr><th><span class='m-score'></span></th><th><span class='m-opponent'></span></th></tr></thead>");SQUADBATTLE=$("#squadbattle").DataTable({language:{search:UI_translation.Search,
lengthMenu:UI_translation["Display _MENU_ records per page"],zeroRecords:UI_translation["Nothing found - sorry"],info:UI_translation["Showing page _PAGE_ of _PAGES_"],infoEmpty:UI_translation["No records available"],infoFiltered:UI_translation["(filtered from _MAX_ total records)"]},autoWidth:!0,scrollY:"20em",scrollX:!0,deferRender:!0,scrollCollapse:!0,ordering:!0,processing:!0,info:!0,paging:!0});$("#squadbattle tbody").on("click","tr",function(){$(this).hasClass("selected")?$(this).removeClass("selected"):
($("#squadbattle tr.selected").removeClass("selected"),$(this).addClass("selected"))});t=LZString.decompressFromEncodedURIComponent(decodeURI(window.location.search.substr(1)));g=[];null!=t&&(g=t.split("&"));if(1<g.length)return log("Loading permalink..."),ROCKDATA=g[2],phase=CREATION_PHASE,TEAMS[1].parseASCII(g[0]),TEAMS[1].toJSON(),TEAMS[2].parseASCII(g[1]),TEAMS[2].toJSON(),TEAMS[1].isia=!1,TEAMS[2].isia=!1,"true"==g[3]?TEAMS[1].isia=!0:(localStorage.imageplayer=g[7],localStorage.playername=g[8]),
"true"==g[4]?TEAMS[2].isia=!0:(localStorage.imageplayer=g[7],localStorage.playername=g[8]),SETUP=SETUPS[g[5]+" Map"],phase=SELECT_PHASE,6<g.length&""!=g[6]&&(REPLAY=g[6]),PERMALINK=LZString.compressToEncodedURIComponent(TEAMS[1].toASCII()+"&"+TEAMS[2].toASCII()+"&"+saverock()+"&"+TEAMS[1].isia+"&"+TEAMS[2].isia+"&"+g[5]),nextphase();delete localStorage.imageplayer;delete localStorage.playername;phase=0;nextphase();localStorage.getItem("import")&&(log("Importing from another Squad Builder..."),currentteam=
""==$("#squad1").val()?TEAMS[1]:TEAMS[2],currentteam.parseJSON(sessionStorage.getItem("import")),sessionStorage.clear(),endselection());SETUP=SETUPS["Classic Map"];$("#squadlist").html("<thead><tr><th></th><th>"+UI_translation.type+"</th><th><span class='m-points'></span></th><th><span class='m-units'></span></th><th></th><th></th><th></th></tr></thead>");$.fn.dataTable.ext.search.push(function(b,e,f){return-1<e[1].search(stype)});SQUADLIST=$("#squadlist").DataTable({language:{search:UI_translation.Search,
lengthMenu:UI_translation["Display _MENU_ records per page"],zeroRecords:UI_translation["Nothing found - sorry"],info:UI_translation["Showing page _PAGE_ of _PAGES_"],infoEmpty:UI_translation["No records available"],infoFiltered:UI_translation["(filtered from _MAX_ total records)"]},autoWidth:!0,columnDefs:[{targets:[0],render:function(){return"<span class='closemiddle' onclick='removerow($(this))'>&times;</span> "},sortable:!1},{targets:[6],width:"2em",render:function(){return"<span class='squadtop'><span class='squadmiddle' onclick='checkrow(1,$(this))'>1</span>&nbsp;<span class='squadmiddle right' onclick='checkrow(2,$(this))'>2</span></span>"},
sortable:!1},{targets:[5],render:function(b,e,f){return"<span class='logmiddle symbols' onclick='battlelog($(this));'>&#xE9;</span>"},sortable:!1},{targets:[1],sortable:!1,render:function(b,e,f){return-1<f[4].search("SQUAD")?"<span style='display:none'>"+b+" USER</span><span class='"+b+"'></span>":"ELITE"==f[4]?"<span style='display:none'>"+b+" ELITE</span><span class='"+b+"'></span><span style='font-size:larger'></span><code style='color:orange' class='symbols'>\u00ef</code>":"<span style='display:none'>"+
b+" PREBUILT</span><span class='"+b+"'></span><code style='font-size:larger' class='symbols'>\u00ec</code>"}},{targets:[4],visible:!1,searchable:!1},{targets:[3],render:function(b,e,f){"en"!=LANG&&phase==SELECT_PHASE&&-1==f[4].search("SQUAD")&&(TEAMS[0].parseJuggler(b,!1),b=TEAMS[0].toJuggler(!0));return b.replace(/\n/g,"<br>")}}],ajax:"data/full4b.json",scrollY:"20em",scrollCollapse:!0,deferRender:!0,ordering:!0,info:!0,paging:!0});for(q in localStorage)"string"==typeof localStorage[q]&&q.match(/SQUAD.*/)&&
(t=$.parseJSON(localStorage[q]),"undefined"==typeof t.jug||"undefined"==typeof t.pts?delete localStorage[q]:"en"!=LANG?(TEAMS[0].parseJuggler(t.jug,!1),addrow(0,q,t.pts,t.faction,TEAMS[0].toJuggler(!0),!0)):addrow(0,q,t.pts,t.faction,t.jug,!0));$("#squadlist tr:first-child .squadtop").attr("data-intro","Select squad").attr("data-position","bottom");$("#squadlist tr:first-child .logmiddle").attr("data-intro","Battle log").attr("data-position","left");g=[];for(q=0;q<PILOTS.length;q++)t=q,t=translate(PILOTS[q].name),
1==PILOTS[q].ambiguous&&"undefined"!=typeof PILOTS[q].edition&&(t+="("+PILOTS[q].edition+")"),g.push(t.replace(/\'/g,"").replace(/\(Scum\)/g,""));t=[];for(q in UPGRADE_translation)t.push(" "+translate(q).replace(/\'/g,"").replace(/\(Crew\)/g,""));$(".squadbg > textarea").asuggest(g,{delimiters:"^\n",cycleOnTab:!0});$(".squadbg > textarea").asuggest(t,{delimiters:"+",cycleOnTab:!0})})});function util(){}
util.getOutlineRange=function(b,e,f){b=b.getOutlinePoints(b.m);e=e.getOutlinePoints(e.m);var g=90001,h,l,m=!1,q=0,t,v;for(h=0;h<b.length;h++)for(l=0;l<e.length;l++){var w=dist(e[l],b[h]);w<g&&(g=w,t=h,v=l)}if(9E4<g)return{distance:4,obstructed:m,obstructionCount:q};var w=e[v].x-b[t].x,x=e[v].y-b[t].y,y=-b[t].x*x+b[t].y*w;if(0<f.length)for(l=0;l<f.length;l++)if(f[l].type!=NONE&&f[l].type!=BOMB){var z=f[l].getOutlineString().p;if(0==z.length)break;var D=z[0].x*x-z[0].y*w+y,B=D;for(h=1;h<z.length&&!(dist(e[v],
z[h])<1.2*g&&dist(b[t],z[h])<1.2*g&&(B=z[h].x*x-z[h].y*w+y,0>B*D));h++);0>B*D&&(m=!0,q++)}return 1E4>=g?{distance:1,obstructed:m,obstructionCount:q}:4E4>=g?{distance:2,obstructed:m,obstructionCount:q}:{distance:3,obstructed:m,obstructionCount:q}};var Unit=window.Unit||{},Mustache=window.Mustache||{},Critical=window.Critical||{};function Condition(b,e,f){this.name=f;this.org=e;f in TEAMS[b.team].conditions&&TEAMS[b.team].conditions[f].remove();$.extend(this,CONDITIONS[f]);log("New Condition: "+f+" to "+b.name+" from "+this.org.name);b.conditions[f]=this;TEAMS[b.team].conditions[f]=this;this.unit=b;this.isactive=!0;this.assign(b);activeunit=b;b.show();activeunit=e}
...
var CONDITIONS={"I'll Show You The Dark Side":{assign:function(b){for(var e=this,f=[],g=0;g<Critical.CRITICAL_DECK.length;g++)-1<Critical.CRITICAL_DECK[g].version.indexOf(CURRENT_DECK)&&"pilot"==Critical.CRITICAL_DECK[g].type&&0<Critical.CRITICAL_DECK[g].count&&f.push(g);this.org.selectcritical(f,function(f){Critical.CRITICAL_DECK[f].count--;b.darkside=new Critical(b,f);f=Critical.CRITICAL_DECK[f].name;"undefined"!=typeof CRIT_translation[f].name&&(f=CRIT_translation[f].name);e.name+=" ["+f+"]"});
b.wrap_after("deal",this,function(b,f,g){return f==Critical.FACEUP?(b=$.Deferred(),e.remove(),b.resolve({crit:this.darkside,face:f})):g}).unwrapper("deal")}},"Suppressive Fire":{assign:function(b){var e=this;b.wrap_after("getattackstrength",this,function(b,g,h){return g.name!=e.org.name&&e.isactive&&e.unit==this?h-1:h});b.wrap_after("declareattack",this,function(b,g,h){h&&g.name==e.org.name&&e.isactive&&e.unit==this&&e.remove();return h});this.org.wrap_before("dies",this,function(){e.remove()});this.org.wrap_before("endcombatphase",
this,function(){0==this.hasfired&&e.remove()})}},"A Debt To Pay":{assign:function(b){var e=this;b.adebttopay=e;b.adddicemodifier(Unit.ATTACK_M,Unit.MOD_M,Unit.ATTACK_M,this,{req:function(b,e){return"undefined"!=typeof targetunit.ascoretosettle?targetunit.ascoretosettle.isactive:!1},f:function(b,g){this.log("1 %FOCUS% -> 1 %CRIT% [%0]",e.name);return b=b-Unit.FCH_FOCUS+Unit.FCH_CRIT}.bind(b),str:"elite"})}},"Fanatical Devotion":{assign:function(b){var e=this;b.wrap_before("isattackedby",this,function(){this.wrap_after("canusefocus",
e,function(){return!1}).unwrapper("endbeingattacked")});b.wrap_before("endround",this,function(){e.remove()});b.wrap_after("declareattack",this,function(b,g,h){h&&this.wrap_after("removefocustoken",e,function(){Unit.prototype.wrap_after("cancelcritical",e,function(b,e,f){return{ch:f.ch+Unit.FCH_HIT,e:f.e}}).unwrap("endbeingattacked")}).unwrap("endattack");return h}).unwrap("endattack")}}};//@ sourceMappingURL=bench.js.map
