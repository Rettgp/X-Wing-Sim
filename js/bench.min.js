...
this.dialdirection.attr({text:""})},beginactivation:function(){this.showmaneuver();this.show()},endactivationphase:function(){},hasionizationeffect:function(){return 0<this.ionized&&!this.islarge||1<this.ionized},begincombatphase:function(){return this.newlock()},beginattack:function(){},toString:function(){if(phase==SELECT_PHASE||phase==CREATION_PHASE)return this.toString2();var b,e=8;b=squadron.indexOf(this);str=-1==b?"<div class='dead '>":this.isdocked?"<div class='docked'>":"<div>";str+="<div><div class='statskill'>"+
this.getskill()+"</div>";t=formatstring(getpilottexttranslation(this,this.faction));str+="<div class='name'>";""!=t&&(str+="<div class='tooltip outoverflow'><span>"+t+"</span></div>");str+="<div>"+translate(this.name)+"</div></div>";text=SHIP_translation[this.ship.name];"undefined"==typeof text&&(text=this.ship.name);str+="<div><div style='font-size:smaller'><code class='"+this.faction+"'></code>&nbsp;"+text+"</div></div>";e+=2*this.upgrades.length;this.hull+this.shield<=e?(str+="<div class='outoverflow stat'>",
str+="<div class='hull'>"+repeat("u ",this.hull)+"</div>",str+="<div class='shield'>"+repeat("u ",this.shield)+"</div></div>"):this.hull>e?(str+="<div class='outoverflow stat'>",str+="<div class='hull'>"+repeat("u ",e)+"</div></div>",this.hull<=2*e?(str+="<div class='outoverflow stat2'>",str+="<div class='hull'>"+repeat("u ",this.hull-e)+"</div>",this.shield+this.hull<=2*e?str+="<div class='shield'>"+repeat("u ",this.shield)+"</div></div>":(str+="<div class='shield'>"+repeat("u ",2*e-this.hull)+"</div></div>",
str+="<div class='outoverflow stat3'>",str+="<div class='shield'>"+repeat("u ",this.shield-2*e+this.hull)+"</div></div>")):(str+="<div class='outoverflow stat2'><div class='hull'>"+repeat("u ",e)+"</div></div>",str+="<div class='outoverflow stat3'><div class='hull'>"+repeat("u ",this.hull-2*e)+"</div>",str+="<div class='shield'>"+repeat("u ",this.shield)+"</div></div>")):(str+="<div class='outoverflow stat'><div class='hull'>"+repeat("u ",this.hull)+"</div>",str+="<div class='shield'>"+repeat("u ",
e-this.hull)+"</div></div>",str+="<div class='outoverflow stat2'><div class='shield'>"+repeat("u ",this.shield-e+this.hull)+"</div></div>");str+="<div><div>";-1<b&&(str+="<div class='usabletokens' style='width:100%'>"+this.getusabletokens()+"</div>");str+="</div></div>";var f=e="",g="";b="<td><button class='statevade' onclick='if (!squadron["+b+"].dead&&!squadron["+b+"].isdocked) squadron["+b+"].togglerange();'><span class='val'>"+this.getagility()+"</span><span class='symbols'>^</span></button></td>";
e=1==this.team?e+("<tr><td></td>"+b+"</tr>"):e+("<tr>"+b+"<td></td></tr>");for(b=0;b<this.upgrades.length;b++)f+=this.upgrades[b];for(b=0;b<this.criticals.length;b++)g+=this.criticals[b];return str+="<table class='details' style='width:100%'>"+e+f+g+"</table></div>"},canusefocus:function(){return 0<this.focus},canuseevade:function(){return 0<this.evade},canusetarget:function(b){return 0<this.targeting.length&&("undefined"==typeof b||-1<this.targeting.indexOf(b))},getusabletokens:function(){this.focuses=
1<this.focus?[this.focus]:[];this.evades=1<this.evade?[this.evade]:[];this.stresses=1<this.stress?[this.stress]:[];this.ionizedes=1<this.ionized?[this.ionized]:[];this.tractorbeames=1<this.tractorbeam?[this.tractorbeam]:[];this.targetedname=[];this.targetingname=[];for(var b=0;b<this.istargeted.length;b++)this.targetedname[b]=this.istargeted[b].name.replace(/\'/g,"&#39;");for(b=0;b<this.targeting.length;b++)this.targetingname[b]=this.targeting[b].name.replace(/\'/g,"&#39;");return Mustache.render(TEMPLATES.usabletokens,
this)},showskill:function(){var b=this.getskill();$("#unit"+this.id+" .statskill").html(b);$("#"+this.id+" .statskill").html(b)},showstats:function(){$("#unit"+this.id+" .statevade .val").html(this.getagility());if(phase==SELECT_PHASE||phase==CREATION_PHASE)$("#unit"+this.id+" .stathull .val").html(this.ship.hull),$("#unit"+this.id+" .statshield .val").html(this.ship.shield);else{this.skillbar.attr({text:repeat("u",this.getskill())});this.firebar.attr({text:repeat("u",this.weapons[0].getattack())});
this.evadebar.attr({text:repeat("u",this.getagility())});this.hullbar.attr({text:repeat("u",this.hull)});this.shieldbar.attr({text:repeat("u",this.shield+this.hull)});var b=8+2*this.upgrades.length;this.hull+this.shield<=b?($("#"+this.id+" .stat .hull").html(repeat("u ",this.hull)),$("#"+this.id+" .stat .shield").html(repeat("u ",this.shield))):this.hull>b?($("#"+this.id+" .stat .hull").html(repeat("u ",b)),this.hull<=2*b?($("#"+this.id+" .stat2 .hull").html(repeat("u ",this.hull-b)),this.shield+
this.hull<=2*b?$("#"+this.id+" .stat2 .shield").html(repeat("u ",this.shield)):($("#"+this.id+" .stat2 .shield").html(repeat("u ",2*b-this.hull)),$("#"+this.id+" .stat3 .shield").html(repeat("u ",this.shield-2*b+this.hull)))):($("#"+this.id+" .stat2 .hull").html(repeat("u ",b)),$("#"+this.id+" .stat3 .hull").html(repeat("u ",this.hull-2*b)),$("#"+this.id+" .stat3 .shield").html(repeat("u ",this.shield)))):($("#"+this.id+" .stat .hull").html(repeat("u ",this.hull)),$("#"+this.id+" .stat .shield").html(repeat("u ",
b-this.hull)),$("#"+this.id+" .stat2 .shield").html(repeat("u ",this.shield-b+this.hull)))}},showpanel:function(){var b=VIEWPORT.m.clone(),e=this.g.getBBox(),f=$("#svgout").width(),g=$("#svgout").height(),h=0,l=0;g>f?l=(g-f)/2:h=(f-g)/2;f=Math.min(f/900,g/900);h+=(b.x(e.x,e.y)+e.width/2)*f;e=l+b.y(e.x,e.y)*f;b=b.split().scalex;$(".phasepanel").css({left:h+b*(this.islarge?40:20),top:e}).show()},timeformaneuver:function(){return this==activeunit&&-1<this.maneuver&&!this.hasmoved&&this.getskill()==skillturn&&
phase==ACTIVATION_PHASE&&subphase==ACTIVATION_PHASE},showoverflow:function(){this.dead||($("#"+this.id).html(""+this),$("#"+this.id+" .outoverflow").each(function(b){"auto"!=$(this).css("top")&&$(this).css("top",$(this).parent().offset().top+"px")}))},show:function(){phase==CREATION_PHASE?$("#unit"+this.id).html(this.toString2()):"undefined"!=typeof this.g&&(this.g.transform(this.m),this.g.appendTo(VIEWPORT),this.geffect.transform(this.m),this.geffect.appendTo(VIEWPORT),this.showoutline(),this.flameno++,
this.showstats(),this.showinfo(),activeunit==this&&(this.showpanel(),this.showdial(),this.showmaneuver(),phase==ACTIVATION_PHASE&&this.showactivation(),ENGAGED||phase!=COMBAT_PHASE||(!this.canfire()||this.areactionspending()||INREPLAY?$("#attackdial").empty():this.showattack(this.activeweapons,this.activeenemies)),this.showoverflow()))},updatetohit:function(b,e){var f=this.weapons[e],g=f.getenemiesinrange();if(b)for(h in g)g[h].tohitstats[this.id]={unit:this,weapon:e};else for(var h in g)delete g[h].tohitstats[this.id];
for(h in g){var l=g[h];NOLOG=!0;var m=1,q=0,v=0,w=l.focus,x=l.evade,y,z;for(z in l.tohitstats){var B=l.tohitstats[z],f=B.weapon;if("undefined"!=typeof B.unit){var E=B.unit.evaluatetohit(B.weapon,l),m=m*(1-E.tohit/100),q=q+E.meanhit,v=v+E.meancritical;0<l.focus&&l.focus--;0<l.evade&&l.evade--;for(y=[];"function"==typeof B.unit.weapons[f].followupattack&&-1==y.indexOf(f);)y.push(f),f=B.unit.weapons[f].followupattack(),E=B.unit.evaluatetohit(f,l),m*=1-E.tohit/100,q+=E.meanhit,v+=E.meancritical,0<l.focus&&
l.focus--,0<l.evade&&l.evade--}}l.tohitstats.tohit=m;l.tohitstats.meanhit=q;l.tohitstats.meancrit=v;l.evade=x;l.focus=w;NOLOG=!1}},displaytohit:function(b){b=this.weapons[b].getenemiesinrange();for(var e in b){var f=b[e],g=1-f.tohitstats.tohit,h=f.tohitstats.meanhit,l=f.tohitstats.meancrit;if(0==h)f.gproba.attr({display:"none"});else{var m=-f.m.split().rotate;f.gproba.transform("r "+m+" 0 0").attr({display:"block"});f.tohit.attr({text:Math.floor(100*g)+"%"});f.meanhit.attr({text:Math.floor(100*h)/
100});f.meancrit.attr({text:Math.floor(100*l)/100})}f.show()}},showhitsector:function(b,e){this.select();"undefined"==typeof e&&(e=0);var f=this.weapons[e];if(b){var g=f.getlowrange(),h=f.gethighrange();if(f.isTurret()||this.isTurret(f))this.showrange(b,g,h);else{var l;if(1==g){for(l=g;l<=h;l++)this.sectors.push(s.path(this.getPrimarySectorString(l,this.m)).attr({fill:this.color,stroke:this.color,opacity:.1,pointerEvents:"none"}).appendTo(VIEWPORT));if("undefined"!=typeof f.auxiliary)for(f=f.auxiliary,
l=g;l<=h;l++)this.sectors.push(s.path(f.call(this,l,this.m)).attr({fill:this.color,stroke:this.color,opacity:.1,pointerEvents:"none"}).appendTo(VIEWPORT))}else{for(l=g;l<=h;l++)this.sectors.push(s.path(this.getPrimarySubSectorString(g-1,l,this.m)).attr({fill:this.color,stroke:this.color,opacity:.1,pointerEvents:"none"}).appendTo(VIEWPORT));if("undefined"!=typeof f.subauxiliary)for(f=f.subauxiliary,l=g;l<=h;l++)this.sectors.push(s.path(f.call(this,g-1,l,this.m.clone())).attr({fill:this.color,stroke:this.color,
opacity:.1,pointerEvents:"none"}).appendTo(VIEWPORT))}}}else{for(l=0;l<this.sectors.length;l++)this.sectors[l].remove();for(l=0;l<this.ranges.length;l++)this.ranges[l].remove();this.ranges=[];this.sectors=[]}this.updatetohit(b,e);this.displaytohit(e)},showrange:function(b,e,f){this.select();if(b)if(1==e)for(b=e;b<=f;b++)this.ranges.push(s.path(this.getRangeString(b,this.m)).attr({fill:this.color,stroke:this.color,opacity:.1,pointerEvents:"none"}).appendTo(VIEWPORT));else for(b=e;b<=f;b++)this.ranges.push(s.path(this.getSubRangeString(e-
1,b,this.m)).attr({fill:this.color,stroke:this.color,opacity:.1,pointerEvents:"none"}).appendTo(VIEWPORT));else{for(b=0;b<this.ranges.length;b++)this.ranges[b].remove();this.ranges=[]}},togglehitsector:function(b){this.showhitsector(0<this.sectors.length+this.ranges.length?!1:!0,b)},togglerange:function(){this.showrange(0<this.ranges.length?!1:!0,1,3)},isPointInside:function(b,e){for(var f=0;f<e.length;f++)if(Snap.path.isPointInside(b,e[f].x,e[f].y))return!0;return!1},isinsector:function(b,e,f,g,
h,l){f=f.getOutlineString(f.m);b=1<e?g.call(this,e-1,e,b):h.call(this,e,b);return null!=b&&(0<Snap.path.intersection(f.s,b).length||this.isPointInside(b,f.p))},isinfiringarc:function(b){return 3>=this.getsector(b)},isinprimaryfiringarc:function(b){return 3>=this.getprimarysector(b)},getsector:function(b,e){return this.weapons[0].getsector(b)},getprimarysector:function(b,e){var f;"undefined"==typeof e&&(e=this.m);var g=this.getoutlinerange(e,b).d;for(f=g;f<=g+1&&3>=f;f++)if(this.isinsector(e,f,b,this.getPrimarySubSectorString,
...
{name:"Captured TIE",unique:!0,type:MOD,ship:"TIE Fighter",faction:REBEL,points:1,done:!0,init:function(b){var e=this,f=!1,g=function(){var b=0,f;for(f in squadron)squadron[f].team==this.team&&b++;1==b&&e.desactivate()};b.wrap_after("declareattack",this,function(b,e,g){g&&(f=!0);return g});b.wrap_after("endsetupphase",this,g);Unit.prototype.wrap_before("dies",this,g);b.wrap_after("isenemy",this,function(b,g){var h;h=(h=e.isactive?g&&!(!f&&this.getskill()>b.getskill()):g)&&1!=TEAMS[this.team].units.length;
this.log("Still alive: [%1]",TEAMS[this.team].units.length);return h})}},{name:"Inspiring Recruit",type:CREW,points:1,done:!0,init:function(b){var e=this;Unit.prototype.wrap_after("removestresstoken",this,function(){this.isally(b)&&2>=this.getrange(b)&&0<this.stress&&(this.log("-1 stress token [%0]",e.name),this.removestresstoken.vanilla.call(this))})}},{name:"Baze Malbus",type:CREW,points:3,unique:!0,done:!0,faction:REBEL,init:function(b){var e=this;b.addattack(function(b,e){return this.weapons[0].isactive&&
0==b+e},this,[b.weapons[0]],function(){this.noattack=round},function(){this.log("+1 attack [%0]",e.name);return this.selectnearbyenemy(3,function(b,e){return e!=targetunit})})}},{name:"Bodhi Rook",type:CREW,points:1,unique:!0,faction:REBEL,done:!0,init:function(b){b.wrap_after("gettargetableunits",this,function(b,f){var e=[],h;for(h in squadron)squadron[h].isally(this)&&(e=e.concat(Unit.prototype.gettargetableunits.vanilla.call(e,3)));return e})}},{name:"Adaptive Ailerons",type:TITLE,points:0,ship:"TIE Striker",
done:!0,init:function(b){var e=this;b.adaptive=-1;"undefined"==typeof b.facultativeailerons&&(b.facultativeailerons=!1);b.wrap_after("premove",this,function(){var b=["F1","BR1","BL1"],e=this.moves[0];this.facultativeailerons||(this.moves=[]);this.moves=this.moves.concat([this.getpathmatrix(e,b[0]),this.getpathmatrix(e,b[1]),this.getpathmatrix(e,b[2])])});b.wrap_before("beginactivation",this,function(){for(var b=this.maneuver,g=this.getdial(),h=[],l=[],m=0;m<g.length;m++)g[m].move.match(/F1|BL1|BR1/)&&
(h.push(this.getpathmatrix(this.m,g[m].move)),l.push(m));this.adaptive<round&&(this.adaptive=round,this.donoaction([{org:e,type:"TITLE",name:e.name,action:function(f){this.wrap_after("candoendmaneuveraction",this,function(){return!1}).unwrapper("cleanupmaneuver");this.wrap_after("getdial",this,function(b){for(var e=[],f=0;f<b.length;f++)e[f]={move:b[f].move,difficulty:"WHITE"};return e}).unwrapper("endmaneuver");this.wrap_before("cleanupmaneuver",e,function(){this.maneuver=b;this.cleanupmaneuver.unwrap(e);
this.endnoaction(f,"TITLE");this.hasmoved=!1;this.newlock().done(function(){this.newlock().done(nextactivation);nextactivation()}.bind(this))});this.resolveactionmove(h,function(b,e){this.maneuver=l[e];this.resolvemaneuver()}.bind(this),!1,!0)}.bind(this)}],"",this.facultativeailerons))})}},{name:"Swarm Leader",unique:!0,points:3,type:ELITE,done:!0,init:function(b){var e=this;b.wrap_after("preattackroll",this,function(b,g){var f=this.selectnearbyally(3,function(b,e){return e.canuseevade()&&e.isinfiringarc(g)?
!0:!1}),l=0;0<f.length&&(l++,f[0].removeevadetoken());1<f.length&&(l++,f[1].removeevadetoken());this.log("+%1 attack die [%0]",l,e.name);this.wrap_after("getattackstrength",this,function(b,e,f){return f+l}).unwrapper("attackroll")})}},{name:"Lightweight Frame",type:MOD,points:2,agilitymax:3,ship:"TIE",done:!0,init:function(b){var e=this;b.wrap_before("defenseroll",this,function(b,g){getattackdice()>getdefensedice()&&(this.log("+1 defense roll [%0]",e.name),this.wrap_after("getagility",e,function(b){return b+
1}).unwrapper("defenseroll"))})}},{name:"'Light Scyk' Interceptor",type:TITLE,points:-2,ship:"M3-A Interceptor",lostupgrades:[MOD],done:!0,init:function(b){this.deal=function(b,e){return $.Deferred().resolve({crit:b,face:FACEUP})};var e=[];b.installed=!0;b.wrap_after("getdial",this,function(b){if(0==e.length)for(var f=0;f<b.length;f++){var h=b[f].move,l=b[f].difficulty;h.match(/BL\d|BR\d/)&&(l="GREEN");e[f]={move:h,difficulty:l}}return e})}},{name:"Hotshot Co-Pilot",type:CREW,points:4,done:!0,init:function(b){var e=
this,f=function(){if(this.canusefocus()){this.log("- %0 %FOCUS% [%1]",this.focus,e.name);for(var b=0;b<this.focus;b++)this.removefocustoken()}};b.wrap_before("resolveattack",this,function(b,h){this.weapons[b].isprimary&&h.wrap_before("endmodifydefensestep",e,f)});b.wrap_before("isattackedby",this,function(b,h){h.wrap_before("endmodifyattackstep",e,f)})}},{name:"Trick Shot",type:ELITE,points:0,done:!0,init:function(b){var e=this;b.wrap_after("getattackstrength",this,function(b,g,h){0<this.getobstructiondef(g)&&
(this.log("obstructed attack => +1 die [%0]",e.name),h+=1);return h})}},{name:"Bistan",type:CREW,points:2,unique:!0,done:!0,faction:REBEL,init:function(b){b.wrap_after("modifyattackroll",this,function(b,f,g,h){2>=this.getrange(targetunit)&&(h=h+FCH_CRIT-FCH_HIT);return h});b.adddicemodifier(ATTACK_M,MOD_M,ATTACK_M,this,{req:function(e,f){return 2>=b.getrange(targetunit)}.bind(this),aiactivate:function(b,f){return!0},f:function(b,f){0<FCH_hit(b)&&(this.unit.log("%HIT% -> %CRIT% [%0]",this.name),b=
b+FCH_CRIT-FCH_HIT);return b}.bind(this),str:"hit"})}},{name:"Expertise",type:ELITE,rating:2,points:4,done:!0,init:function(b){b.wrap_after("modifyattackroll",this,function(b,f,g,h){0==this.stress&&FCH_focus(h)&&(h+=(FCH_HIT-FCH_FOCUS)*FCH_focus(h));return h});b.adddicemodifier(ATTACK_M,MOD_M,ATTACK_M,this,{req:function(e,f){return 0==b.stress}.bind(this),aiactivate:function(b,f){return 0<FCH_focus(b)},f:function(b,f){0<FCH_focus(b)&&(this.unit.log("%FOCUS% -> %HIT% [%0]",this.name),b+=FCH_focus(b)*
(FCH_HIT-FCH_FOCUS));return b}.bind(this),str:"focus"})}},{name:"BoShek",type:CREW,points:2}];var allunits=[];function Team(b){this.team=b;this.initiative=this.isia=this.isdead=!1;this.units=[];this.allhits=this.allcrits=this.allevade=this.allred=this.allgreen=0}
