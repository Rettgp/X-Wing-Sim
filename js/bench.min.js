...
{name:"Captured TIE",unique:!0,type:MOD,ship:"TIE Fighter",faction:REBEL,points:1,done:!0,init:function(b){var e=this,f=!1,g=function(){var b=0,f;for(f in squadron)squadron[f].team==this.team&&b++;1==b&&e.desactivate()};b.wrap_after("declareattack",this,function(b,e,g){g&&(f=!0);return g});b.wrap_after("endsetupphase",this,g);Unit.prototype.wrap_before("dies",this,g);b.wrap_after("canbetargeted",this,function(b,g){var h;this.log("%0 being attacked by %1",this.name,b.name);e.isactive?(h=g&&!(!f&&this.getskill()>
b.getskill()),this.log("Can attack? %0",h)):h=g;return h})}},{name:"Inspiring Recruit",type:CREW,points:1,done:!0,init:function(b){var e=this;Unit.prototype.wrap_after("removestresstoken",this,function(){this.isally(b)&&2>=this.getrange(b)&&0<this.stress&&(this.log("-1 stress token [%0]",e.name),this.removestresstoken.vanilla.call(this))})}},{name:"Baze Malbus",type:CREW,points:3,unique:!0,done:!0,faction:REBEL,init:function(b){var e=this;b.addattack(function(b,e){return this.weapons[0].isactive&&
