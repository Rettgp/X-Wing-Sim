...
f){if(0<FE_focus(e)||0<FE_blank(e,f))b.removefocustoken(),this.log("Cancel blank and focus defense results"),e-=FE_FOCUS*FE_focus(e),f-=FE_blank(e,f);return{m:e,n:f}},str:"focus"})}},{name:"'Double Edge'",faction:EMPIRE,pilotid:235,unique:!0,done:!0,unit:"TIE Aggressor",skill:4,upgrades:[ELITE,TURRET,MISSILE,MISSILE],points:19,doubleattack:-1,init:function(){this.doubleattack=-1;this.addattack(function(b,e){return 0==b+e&&!this.activeweapon.isprimary&&this.doubleattack<round},this,this.weapons,function(){this.doubleattack=
round},null,"endcombatphase")}},{name:"Onyx Squadron Escort",faction:EMPIRE,pilotid:236,unique:!1,done:!0,unit:"TIE Aggressor",skill:5,upgrades:[TURRET,MISSILE,MISSILE],points:19},{name:"Sienar Specialist",faction:EMPIRE,pilotid:237,unique:!1,done:!0,unit:"TIE Aggressor",skill:2,upgrades:[TURRET,MISSILE,MISSILE],points:17}];var UPGRADE_TYPES={Elite:"ept",Torpedo:TORPEDO,Astromech:"amd",Turret:"turret",Missile:"missile",Crew:"crew",Cannon:"cannon",Bomb:"bomb",Title:"title",Mod:"mod",System:"system",Illicit:"illicit",Salvaged:"salvaged",Tech:"tech"};function AUXILIARY(b,e){return this.getPrimarySectorString(b,e.clone().rotate(this.arcrotation,0,0))}function SUBAUXILIARY(b,e,f){return this.getPrimarySubSectorString(b,e,f.clone().rotate(this.arcrotation,0,0))}
