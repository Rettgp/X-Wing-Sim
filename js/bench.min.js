...
resetevade:function(){return 0},resettractorbeam:function(){return 0},endround:function(){for(var b=0;b<this.upgrades.length;b++)this.upgrades[b].endround();this.focus=this.resetfocus();this.evade=this.resetevade();this.hasfired=0;console.log("Has fired 0");this.maxfired=1;this.tractorbeam=this.resettractorbeam();this.oldoverlap=this.ocollision.overlap;this.ocollision.overlap=-1;this.ocollision.template=[];this.ocollision.mine=[];this.collision=!1;this.touching=[];this.showinfo()},playfiresnd:function(){var b=
targetunit.g.getBBox(),e=transformPoint(this.m,{x:0,y:-(this.islarge?40:20)}),f=s.path("M "+e.x+" "+e.y+" L "+(b.x+b.w/2)+" "+(b.y+b.h/2)).appendTo(VIEWPORT).attr({stroke:this.color,strokeWidth:2}),g=setInterval(function(){f.remove();clearInterval(g)},200);this.movelog("f-"+targetunit.id+"-"+this.activeweapon);"undefined"!=typeof this.weapons[this.activeweapon]&&"undefined"!=typeof this.weapons[this.activeweapon].firesnd?SOUNDS[this.weapons[this.activeweapon].firesnd].play():SOUNDS[this.ship.firesnd].play()},
endattack:function(b,e,f){for(i=0;i<DICES.length;i++)$("."+DICES[i]+"dice").remove();this.show()},endbeingattacked:function(b,e,f){},showpositions:function(b){var e,f=[];for(e=0;e<b.length;e++)f[e]=this.getOutline(b[e].m).attr({title:b[e].move,opacity:.4,fill:halftone(b[e].color),display:"block","class":"possible"}).appendTo(VIEWPORT),function(e){f[e].hover(function(){f[e].attr({stroke:b[e].color,strokeWidth:4})}.bind(this),function(){f[e].attr({strokeWidth:0})}.bind(this))}.call(this,e)},showmeanposition:function(){this.getdial();
...
"DEPLOY")}.bind(this))},endcombatphase:function(){$(".fireline").remove()},endphase:function(){},beginsetupphase:function(){return this.newlock()},endsetupphase:function(){},beginplanningphase:function(){this.actionsdone=[];return this.newlock()},beginactivationphase:function(){return this.newlock()},timetoshowmaneuver:function(){return-1<this.maneuver&&phase<=ACTIVATION_PHASE},getmaneuver:function(){return this.hasionizationeffect()?{move:"F1",difficulty:"WHITE"}:this.getdial()[this.maneuver]},showmaneuver:function(){if(this.timetoshowmaneuver()){var b=
this.getmaneuver(),e=C["undefined"!=typeof this.forceddifficulty?this.forceddifficulty:b.difficulty];activeunit!=this&&(e=halftone(e));this.dialspeed.attr({text:P[b.move].speed,fill:e});this.dialdirection.attr({text:P[b.move].key,fill:e})}},clearmaneuver:function(){this.dialspeed.attr({text:""});this.dialdirection.attr({text:""})},beginactivation:function(){this.showmaneuver();this.show()},endactivationphase:function(){},hasionizationeffect:function(){return 0<this.ionized&&!this.islarge||1<this.ionized},
begincombatphase:function(){return this.newlock()},beginattack:function(){},toString:function(){var b,e;this.shipname=SHIP_translation[this.ship.name];"undefined"==typeof SHIP_translation[this.ship.name]&&(this.shipname=this.ship.name);this.translatedname=translate(this.name);if(phase==SELECT_PHASE)return e=PILOTS[this.pilotid].dict,1==PILOTS[this.pilotid].ambiguous&&"undefined"!=typeof PILOTS[this.pilotid].edition&&(e+="-"+PILOTS[this.pilotid].edition.toLowerCase().replace(" ","")),this.imgname=
e,this.isunique=1==PILOTS[this.pilotid].unique?!1:!0,this.fire=this.weapons[0].getattack(),this.diallist=dial2JSON(this.getdial()),Mustache.render(TEMPLATES["unit-creation"],this);b=formatstring(getpilottexttranslation(this,this.faction));this.id=squadron.indexOf(this);this.tooltip=""!=b?[b]:[];b=8+2*this.upgrades.length;this.shieldpts3=this.hullpts3=this.shieldpts2=this.hullpts2="";this.hull+this.shield<=b?(this.hullpts=repeat("u ",this.hull),this.shieldpts=repeat("u ",this.shield)):this.hull>b?
(this.hullpts=repeat("u ",this.hull),this.shieldpts="",this.hull<=2*b?(this.hullpts2=repeat("u ",this.hull-b),this.shield+this.hull<=2*b?this.shieldpts2=repeat("u ",this.shield):(this.shieldpts2=repeat("u ",2*b-this.hull),this.shieldpts3=repeat("u ",this.shield-2*b))):(this.hullpts2=repeat("u ",b),this.hullpts3=repeat("u ",this.hull-2*b),this.shieldpts3=repeat("u ",this.shield))):(this.hullpts=repeat("u ",this.hull),this.shieldpts=repeat("u ",b-this.hull),this.shieldpts2=repeat("u ",this.shield-b+
this.hull));this.isinleft=1==this.team;this.conds=[];for(e in this.conditions)this.conds.push(this.conditions[e]);return Mustache.render(TEMPLATES["unit-combat"],this)},canusefocus:function(){return 0<this.focus},canuseevade:function(){return 0<this.evade},canusetarget:function(b){return 0<this.targeting.length&&("undefined"==typeof b||-1<this.targeting.indexOf(b))},getusabletokens:function(){this.focuses=1<this.focus?[this.focus]:[];this.evades=1<this.evade?[this.evade]:[];this.stresses=1<this.stress?
...
this,function(){console.log("This name: "+this.name);console.log("This hasfired: "+this.hasfired);console.log("Target name: "+e.unit.name);0==this.hasfired&&e.remove()})}},"A Debt To Pay":{assign:function(b){var e=this;b.adebttopay=e;b.adddicemodifier(Unit.ATTACK_M,Unit.MOD_M,Unit.ATTACK_M,this,{req:function(b,e){return"undefined"!=typeof targetunit.ascoretosettle?targetunit.ascoretosettle.isactive:!1},f:function(b,g){this.log("1 %FOCUS% -> 1 %CRIT% [%0]",e.name);return b=b-Unit.FCH_FOCUS+Unit.FCH_CRIT}.bind(b),
str:"elite"})}},"Fanatical Devotion":{assign:function(b){var e=this;b.wrap_before("isattackedby",this,function(){this.wrap_after("canusefocus",e,function(){return!1}).unwrapper("endbeingattacked")});b.wrap_before("endround",this,function(){e.remove()});b.wrap_after("declareattack",this,function(b,g,h){h&&this.wrap_after("removefocustoken",e,function(){Unit.prototype.wrap_after("cancelcritical",e,function(b,e,f){return{ch:f.ch+Unit.FCH_HIT,e:f.e}}).unwrap("endbeingattacked")}).unwrap("endattack");
return h}).unwrap("endattack")}}};//@ sourceMappingURL=bench.js.map
