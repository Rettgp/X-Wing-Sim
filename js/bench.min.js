...
function displayattacktokens2(b,e){console.log("Display attack tokens 2");"function"!=typeof e?e=b.lastaf:b.lastaf=e;$("#atokens").empty();var f=b.getresultmodifiers(b.ar,b.ad,ATTACK_M,ATTACK_M);0<f.length?($("#atokens").append(f),$("#atokens").append($("<button>").addClass("m-done").click(function(){$("#atokens").empty();e()}.bind(b)))):e()}
