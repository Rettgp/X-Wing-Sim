...
return this.activationdial})}},{name:"Intensity(Ready)",type:ELITE,points:0,invisible:!0},{name:"Intensity(Exhausted)",type:ELITE,points:0,invisible:!0},{name:"Intensity",type:ELITE,points:2,done:!0,faceup:!0,"switch":function(){this.name=(this.faceup=!this.faceup)?"Intensity(Ready)":"Intensity(Exhausted)"},init:function(b){var e=this;b.wrap_after("updateactivationdial",this,function(b){console.log("updateactivedial wrap after");e.isactive&&e.faceup&&(this.isactiondone("ROLL")||this.isactiondone("BOOST"))&&
(this.addactivationdial(function(){return e.faceup&&(this.isactiondone("ROLL")||this.isactiondone("BOOST"))}.bind(this),function(){this.addfocustoken();e["switch"]();this.show()}.bind(this),A.FOCUS.key,$("<div>").attr({"class":"symbols",title:e.name})),this.addactivationdial(function(){return e.faceup&&(this.isactiondone("ROLL")||this.isactiondone("BOOST"))}.bind(this),function(){this.addevadetoken();e["switch"]();this.show()}.bind(this),A.EVADE.key,$("<div>").attr({"class":"symbols",title:e.name})));
return this.activationdial});b.wrap_before("endcombatphase",this,function(){e.isactive&&!e.faceup&&(this.canuseevade()?(this.removeevadetoken(),e["switch"](),this.show(),this.log("1 %EVADE% -> [%0]",e.name)):this.canusefocus()&&(this.removefocustoken(),e["switch"](),this.show(),this.log("1 %FOCUS% -> [%0]",e.name)))})}},{name:"BB-8",unique:!0,done:!0,type:ASTROMECH,points:2,init:function(b){var e=this;e.bb=-1;b.wrap_after("updateactivationdial",this,function(b){e.isactive&&e.bb!=round&&!this.hasionizationeffect()&&
this.addactivationdial(function(){return!this.hasmoved&&-1<this.maneuver&&"GREEN"==this.getmaneuver().difficulty&&this.candoroll()&&!this.hasionizationeffect()}.bind(this),function(){e.bb=round;this.doaction([this.newaction(this.resolveroll,"ROLL")],e.name+" free roll for green maneuver.")}.bind(this),A[ASTROMECH.toUpperCase()].key,$("<div>").attr({"class":"symbols",title:e.name}));return this.activationdial})}},{name:"Integrated Astromech",points:0,type:MOD,ship:"X-Wing",done:!0,init:function(b){var e=
this;b.wrap_after("deal",this,function(b,g,h){var f=-1,m;for(m in this.upgrades)if(b=this.upgrades[m],b.type==ASTROMECH&&1==b.isactive){f=m;break}if(-1==f||!e.isactive)return h;var q=$.Deferred();h.then(function(b){1==this.shield+this.hull||b.face==FACEUP&&b.crit.lethal&&2>=this.shield+this.hull?(this.upgrades[f].desactivate(),this.log("%0 is inactive, damage discarded [%1]",this.upgrades[f].name,e.name),e.desactivate(),q.resolve({crit:b.crit,face:DISCARD})):q.resolve(b)}.bind(this));return q.promise()})}},
{name:"Weapons Guidance",points:2,type:TECH,done:!0,init:function(b){var e=this;b.adddicemodifier(ATTACK_M,MOD_M,ATTACK_M,this,{req:function(b,g){return e.isactive&&this.canusefocus()}.bind(b),aiactivate:function(b,e){return 0<FCH_blank(b,e)},f:function(b,g){var f=FCH_blank(b,g);this.removefocustoken();displayattacktokens(this);0<f&&(this.log("1 blank -> 1 %HIT% [%0]",e.name),b+=FCH_HIT);return b}.bind(b),str:"blank"})}},{name:"R5-K6",init:function(b){var e=this;b.wrap_after("removetarget",this,function(b){this.defenseroll(1).done(function(f){0<
